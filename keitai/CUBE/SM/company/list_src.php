...
<table width="700" border="0" align="center">
  <tr>
    <td width="50"><img src="/members/img/shop_ic.jpg" alt="news" width="50" height="50" border="0" /></td>
...
/*　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　*/
/*↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓*/
$comcatedata=$comobj->GetCateList($_GET["company_id"],$lim,$setnum,$orderby);
for($comrow=0;$comcatedata[$comrow];$comrow++){ 
$comcate=new Ary_Viewer($comcatedata[$comrow]);
?>';?></textarea>
            </td>
          </tr>
        </table>
        ...
        <table width="600" border="0" align="center" id="tb_title" style="display:none">
          <tr>
            <td width="500">
              <textarea name="titletag"  readonly="readonly"  id="titletag" style="width:600px;height:50px;"><?php echo '<?php $companycate->Moji("cate_name"); ?>';?></textarea>
            </td>
          </tr>
        </table>
        <table width="600" border="0" align="center">
        ...
        <table width="600" border="0" align="center" id="tb_comm" style="display:none">
          <tr>
            <td width="500">
              <textarea name="commtag"  readonly="readonly"  id="commtag" style="width:600px;height:50px;"><?php echo '<?php $companycate->Moji("cate_comm"); ?>';?></textarea>
            </td>
          </tr>
        </table>
        <table width="600" border="0" align="center">
        ...
        <table width="600" border="0" align="center" id="tb_image" style="display:none">
          <tr>
            <td width="500">
              <textarea name="imagetag"  readonly="readonly"  id="imagetag" style="width:600px;height:50px;"><?php echo '<?php $companycate->Image("cate_image"); ?>';?></textarea>
            </td>
          </tr>
        </table>        
        <table width="600" border="0" align="center" id="tb_f_image" style="display:none">
          <tr>
            <td width="500">
              <textarea name="f_imagetag"  readonly="readonly"  id="f_imagetag" style="width:600px;height:50px;"><?php echo '<?php $companycate->Image("cate_foot_image"); ?>';?></textarea>
            </td>
          </tr>
        </table>
        <table width="600" border="0" align="center">
