    ...
    <tr>
        ...
        <td valign="top">
            <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#DCDCFF">
                <tr>
                    <td bgcolor="#DCDCFF"><strong>既読メッセージ一覧</strong></td>
                </tr>
                <tr>
            ...
            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><a href="?PID=up_topics&sled_id=<?php echo $sledlist[$topi]["sled_id"];?>"></a></div>
                                </td>
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><a href="?PID=del_topics&sled_id=<?php echo $sledlist[$topi]["sled_id"] ?>"></a></div>
                                </td>
                            </tr>
																												<?php
																												}
                         ...
                         <table width="100%"  border="0" align="center" cellpadding="2" cellspacing="1">
                             ...
                             <tr>
                                 <td>送信者　<?php
																																...
																																echo $mdata["member_name"];
																																?>　<?php echo str_replace("-",".",$messagelist[$i]["senddate"]);?> <?php echo str_replace("-",".",$messagelist[$i]["sendtime"]);?></td>
                             </tr>
                             <tr>
                                 <td bgcolor="#FFFFFF">
                                     <table width="100%"  border="0" align="center" cellpadding="3" cellspacing="3">
                                         ...
                                         <tr>
                                             <td colspan="2">
                                                 <div align="right"><a href="?PID=message_res&message_id=<?php echo $meslist[$j]["message_id"];?>"></a> <a href="index.php?PID=del_log&sled_id=<?php echo $sleddata[$topi]["sled_id"]?>&log_id=<?php echo $logdata[$topi][$rows]["log_id"];?>"></a><a href="?PID=del_topics&sled_id=<?php echo $sledlist[$topi]["sled_id"] ?>"></a></div>
                                             </td>
                                         </tr>
                                     </table>
                                 </td>
