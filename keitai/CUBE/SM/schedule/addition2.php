						...
						<td>
								<table width="625"  border="0" align="left" cellpadding="3" cellspacing="1">
										<form action="" method="post" name="sche_form" id="sche_form">
												...
												<tr>
														<td align="left" valign="middle"><a href="?PID=sche_add&rdate=<?php echo $_REQUEST["rdate"]; ?>&mem_id=<?php echo $_REQUEST["mem_id"]; ?>">通常予定</a>　|　翌日まで続く予定　|　<a href="?PID=sche_add3&rdate=<?php echo $_REQUEST["rdate"]; ?>&mem_id=<?php echo $_REQUEST["mem_id"]; ?>">バナー予定</a></td>
												</tr>
												<tr>
