...
echo "function Groupchange(fname,obj) {\n";
$newary1="";
$newary2="";

$GSList=$Gobj->GetAllSelList("");
$grows2=0;
$newary1.="var addary1[0]=new Array(";
$newary2.="var addary2[0]=new Array(";
...
while($GAList[$grows-1]["group_id"]!=NULL) {
	...
	$grows2=0;
	$newary1.="	var addary1[".$grows."]=new Array(";
	$newary2.="	var addary2[".$grows."]=new Array(";
	while($GSList[$grows2]["member_id"]!=NULL) {
		if($grows2!=0){
			$newary1.=",";
			$newary2.=",";		
			...
			<td align="left" valign="top">
				...
				<table width="700"  border="0" align="center" cellpadding="2" cellspacing="2">
					<form action="" method="post" name="sche_form" id="sche_form">
						...
						<tr>
							<th align="right" valign="top" background="/members/img/filemenu_bg.gif">出欠の確認</th>
							<td>
						    ...
						    <td>
						    	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                	<tr>
                                		...
                                		<td>&nbsp;</td>
                                		<th align="left">
                                			<select name="menu1" onChange="Groupchange(this.form,this)">
