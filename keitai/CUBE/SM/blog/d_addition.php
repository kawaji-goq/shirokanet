...
?>
  ...
  <tr>
    <th align="left">日付</th>
    <td align="left"><?php echo $ryear."-".$rmonth."-".$rday;?></td>
  </tr>
          <tr>
            <th width="100" align="left"><strong>タイトル<font color="#FF0000">(※必須)</font></strong></th>
            <td width="400" align="left">
             <?php echo $_POST["new_data_title"];?></td>
          </tr>
        <?php if($blogsetting["image_chk"]==1) {?> <tr>
            ...
            <td align="left" valign="top">
              <?php if($blogdata["image"]!=NULL){
							...
							?>
              <img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$blogdata["image"];?>" alt="image" width="<?php echo $pdata[0];?>px"/>
              <?php }?>
</td>
          </tr><?php }?>
        </table>
        <table width="510" border="0" align="center">
          <tr>
            ...
            <td align="left" valign="top"> <?php echo nl2br($_POST["new_data_comm"]);?> </td>
          </tr>
        </table>
				<table width="510" border="0" align="center">
          <tr>
          ...
          <tr>
            ...
            <td align="left" valign="top">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onclick="location.replace('?PID=blog_dadd&amp;cate_id=<?php echo $_REQUEST["cate_id"];?>')" />
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onclick="location.replace('?PID=blog_list&amp;cate_id=<?php echo $_REQUEST["cate_id"];?>')" />
            </td>
          </tr>
        </table>
		<?php
...
// -->
		...
		?>
          <tr>
            <th rowspan="1" align="left" valign="top">日付
            <input name="dft_dat" type="hidden" id="dft_dat" value="<?php echo $RDATE;?>"></th>
            <td align="left"><select name="ryear" id="ryear" onChange="check3()">
			<option value="">--</option>
			<?php
			for($yi=-1;$yi<2;$yi++) {
				?>
...
日
<input name="day_view" type="checkbox" id="day_view" value="1" onClick="day_chk()">
<label for="day_view">日付を表示しない</label></td>
  ...
  <tr>
  		...
  		<td align="left">
  				<select name="cate_id" id="cate_id">
  						<?php
							...
							?><option value="<?php echo $catedata[$i]["cate_id"];?>"<?php if($catedata[$i]["cate_id"]==$_GET["cate_id"]) {echo " selected";}?>><?php echo $catedata[$i]["cate_name"];?></option>
							<?php
							}
							?>
  						</select>
          ...
          <tr>
            <th width="100" align="left" valign="top"><strong>タイトル<font color="#FF0000">(※必須)</font></strong></th>
            <td width="400" align="left">
              <textarea name="new_data_title" cols="50" rows="4" id="new_data_title"></textarea>
            </td>
          </tr>
         <?php if($blogsetting["image_chk"]==1) {?>
         <tr>
							<th align="left" valign="top"><strong>内容</strong></th>
         		<td align="left" valign="top">
									<textarea name="new_data_comm" cols="50" rows="20" id="new_data_comm"></textarea>
							</td>
         		</tr>
         <tr>
           <th align="left" valign="top">イメージ画像1</th>
           <td align="left" valign="top">
        ...
        <div id="type_text" style="display:block;">
				<table width="510" border="0" align="center">
          <tr>
            <th width="100" align="left" valign="top"><strong>テキスト1</strong></th>
            <td align="left" valign="top">
              <textarea name="text1" cols="50" rows="20" id="text1"></textarea>
            </td>
          </tr>
        </table>
				<table width="510" border="0" align="center">
	...
	?>
			...
			?>
						<?php if($blogsetting["image_chk"]==1) {?>
						<tr>
								<th width="100" align="left" valign="top">イメージ画像2</th>
								<td align="left" valign="top">
				...
				<table width="510" border="0" align="center">
						<tr>
								<th width="100" align="left" valign="top"><strong>テキスト2</strong></th>
								<td align="left" valign="top">
										<textarea name="text2" cols="50" rows="20" id="text2"></textarea>
								</td>
						</tr>
				</table>
				<table width="510" border="0" align="center">
	...
	?>
			...
			?>
						<?php if($blogsetting["image_chk"]==1) {?>
						<tr>
								<th width="100" align="left" valign="top">イメージ画像3</th>
								<td align="left" valign="top">
				...
				<table width="510" border="0" align="center">
						<tr>
								<th width="100" align="left" valign="top"><strong>テキスト3</strong></th>
								<td align="left" valign="top">
										<textarea name="text3" cols="50" rows="20" id="text3"></textarea>
								</td>
						</tr>
				</table>
        </div>
          ...
          <tr>
            ...
            <td align="left" valign="top">
              ...
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onclick="location.replace('?PID=blog_list&cate_id=<?php echo $_GET["cate_id"];?>')" />
            </td>
          </tr>
        </table>		<script>
		//day_chk();
