   ...
   <?php
		 ...
		 ?><tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info1cdata["cate_image"];?>?<?php echo time();?>" alt="image" />
              <?php }?>
</td>
          </tr><?php
		  }
		 ...
		 ?>   <tr>
          		...
          		<td align="left" valign="top" bgcolor="#FFFFFF">
          				<?php if($info1cdata["image2"]!=NULL){;?>
									<img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info1cdata["image2"];?>?<?php echo time();?>" alt="image" />
									<?php }?>
</td>
          		</tr>
<?php
		...
		<table width="700" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
		 ...
		 ?>  
           <tr>
             ...
             <td align="left" valign="top" bgcolor="#FFFFFF">
               <?php if($info1cdata["cate_image"]!=NULL){;?>
               <img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info1cdata["cate_image"];?>?<?php echo time();?>" alt="image" /><br />
               <label>
		 ...
		 ?>            <tr>
             ...
             <td align="left" valign="top" bgcolor="#FFFFFF">
               <?php if($info1cdata["image2"]!=NULL){;?>
               <img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info1cdata["image2"];?>?<?php echo time();?>" alt="image" /><br />
               <label>
		 ...
		 ?>
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <br>
              <input name="html_chk" type="checkbox" id="html_chk" value="1"<?php if($info1cdata["html_chk"]==1) {?> checked="checked" <?php }?>/>
