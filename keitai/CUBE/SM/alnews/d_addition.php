...
?>
  ...
  <tr>
    <th width="150" align="left" bgcolor="#ECECEC">日付</th>
    <td align="left" bgcolor="#FFFFFF"><?php echo $ryear."-".$rmonth."-".$rday;?></td>
        ...
        <?php if($newssetting["image_chk"]==1) {?> <tr>
            <th width="150" align="left" valign="top" bgcolor="#ECECEC">イメージ画像</th>
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <?php if($newsdata["image"]!=NULL){
							...
							?>
              <img src="<?php echo $newsdata["image"];?>" alt="image" width="<?php echo $pdata[0];?>px"/>
              <?php }?>
</td>
          </tr><?php }?>
        </table><?php if($newssetting["comm_chk"]==1) {?><?php
		if($_REQUEST["new_view_type"]==0) {
		?>
		<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <th width="150" align="left" valign="top" bgcolor="#ECECEC"><strong>内容</strong></th>
            <td width="435" align="left" valign="top" bgcolor="#FFFFFF"> <?php echo $_POST["new_data_comm"];?> </td>
          </tr>
        </table>
		<?php
		}
		...
		?><table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" >
          ...
          <tr>
            ...
            <td width="435" align="left" valign="top" bgcolor="#FFFFFF">
              <?php echo $_POST["new_link"];?>            </td>
          </tr>
          <tr>
            <th height="24" align="left" valign="top" bgcolor="#ECECEC">ウィンドウ</th>
            <td align="left" valign="top" bgcolor="#FFFFFF">
			<?php
			if($_REQUEST["new_linktarget"]=="_self") {
				echo "ページを移動する";
			}
			else{
				echo "新しいウィンドウを開く";
	   ...
	   ?>
		<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onclick="location.replace('?PID=alnews_add&amp;cate_id=<?php echo $_REQUEST["cate_id"];?>')" />
...
<label for="day_view">日付を表示しない</label></td>
          ...
          <tr>
            <th width="150" align="left" valign="top" bgcolor="#ECECEC"><strong>タイトル</strong>
            				<strong>
        ...
        <div id="type_text" style="display:block;">
          ...
          <tr>
            <th width="150" align="left" valign="top" bgcolor="#ECECEC">リンク先</th>
            <td width="440" align="left" valign="top" bgcolor="#FFFFFF">
...
?>        <table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onclick="location.replace('?PID=alnews&cate_id=<?php echo $_GET["cate_id"];?>')" />
            </td>
          </tr>
        </table>		<script>
		day_chk();
