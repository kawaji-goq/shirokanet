...
function delchk(name,id) {
	...
	if(res) {
		location.href="?PID=alcontents_category&pmode=delete&delid="+id;
	}
...
?>
        <tr>
          <td align="left" valign="top" bgcolor="#FFFFFF"> <a href="index.php?PID=alcontents_details&cate_id=<?php echo $contents1catedata[$contents1row]["cate_id"] ?>">
    				...
    				<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
								<tr>
										...
										<th colspan="2" align="left" bgcolor="#ECECEC">
												<div align="center">
														<input type="button" name="Submit" value="新規追加" onclick="location.href='?PID=alcontents_add'" />
												</div>
										</th>
								</tr>
								<?php
...
?>
								<tr>
										...
										<td width="42" align="left" valign="top" bgcolor="#FFFFFF">
												<input type="button" name="Submit" value="修正" onclick="location.replace('?PID=alcontents_up&amp;cate_id=<?php echo $contents1catedata[$contents1row]["cate_id"];?>')" />
										</td>
										<td width="42" align="left" valign="top" bgcolor="#FFFFFF">
