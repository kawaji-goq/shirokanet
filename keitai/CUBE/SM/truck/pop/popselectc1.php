...
if(substr_count($_SERVER['HTTP_REFERER'],"popselectc1")==0) {
                                ...
                                <TBODY>
                                    ...
                                    <TR>
                                        ...
                                        <TD width="258" bgColor="#fafbfc">
                                            <p><A href="?PID=popselectc1&rq=1">¡¦¥¢¥Ñ¡¼¥È¡¦¥Þ¥ó¥·¥ç¥ó</A>¡¡<A href="?PID=popselectc2&rq=1">¡¦¸Í·ú¤Æ</A>¡¡<A href="?PID=popselectc3">¡¦»ö¶ÈÍÑ</A></p>
                                        </TD>
            ...
            <TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
                <TR class="realestate_bgcolor2">
                    <th width="8%" rowspan="3">
                        <div align="center"><strong>³°´Ñ¼Ì¿¿</strong></div>
                    </th>
                    <th width="26%">
                        <div class="font12">
                            <div align="center"><strong><a href="?PID=popselectc1&cid=<?php echo $_SESSION["cid"];?>&sort=bukkenn_id<?php if($_SESSION["sort"]=="bukkenn_id") { echo " desc";}?>">Êª·ïÈÖ¹æ
                                <?php if($_SESSION["sort"]=="bukkenn_id") { echo "¢§";}elseif($_SESSION["sort"]=="bukkenn_id desc") { echo "¢¥";}?>
                            </a></strong></div>
                        </div>
                    </th>
                    <th width="15%" rowspan="3" class="font12">
                        <div align="center"><strong><span class="st"><a href="?PID=popselectc1&cid=<?php echo $_SESSION["cid"];?>&amp;sort=kakaku<?php if($_SESSION["sort"]=="kakaku") { echo " desc";}?>"><?php echo $bsetdata["kakaku_name"] ?></a></span><br />
                            <?php echo $bsetdata["kanrihi_name"] ?></strong></div>
                    </th>
                    <th width="10%" rowspan="3" align="center" class="font12">
                        <div align="center"><strong><span class="st"><a href="?PID=popselectc1&cid=<?php echo $_SESSION["cid"];?>&amp;sort=madori<?php if($_SESSION["sort"]=="madori,mnum") { echo " desc";}?>,mnum<?php if($_SESSION["sort"]=="madori,mnum") { echo " desc";}?>"><?php echo $bsetdata["madori_name"] ?></a><br />
                        </span><?php echo $bsetdata["senyumenseki_name"] ?></strong></div>
                    </th>
                    <th colspan="2" rowspan="2" align="center" class="font12">
                        <div align="center"><strong><?php echo $bsetdata["ensen_name"] ?></strong></div>
                    </th>
                ...
                <TR class="realestate_bgcolor2">
                    <th width="26%" rowspan="2">
                        ...
                        <div align="center" class="st">
                            <div align="center"><strong><font color="#000000">½êºßÃÏ<a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"></a></font></strong></div>
                        </div>
                    </th>
                </TR>
                <TR class="realestate_bgcolor2">
                    <th width="11%" align="center" class="font12">
                        <div align="center"><strong><?php echo $bsetdata["reikin_name"] ?><br />
                            <?php echo $bsetdata["shikikin_name"] ?></strong></div>
                    </th>
                    <th width="9%" class="font12">
                        
                        <p align="center"><strong><?php echo $bsetdata["syumoku_name"] ?><br />
	...
	?>
                <TR class="realestate_bgcolor3"<?php if(SelChk($re1data[$re1rows]["id"])==1){ echo ' bgcolor="#FFECEC"';}else { echo ' bgcolor="#FFFFFF"';}?>>
                    <TD width="8%" rowspan="3" valign="top" class="font12" >
                        <div align="center"><a href="?PID=popselectc1_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>">
                            <?php
