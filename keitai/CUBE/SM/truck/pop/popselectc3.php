                                ...
                                <TBODY>
                                    ...
                                    <TR>
                                        ...
                                        <TD width="258" bgColor="#fafbfc">
                                            <p><A href="?PID=popselectc1&rp=1">¡¦¥¢¥Ñ¡¼¥È¡¦¥Þ¥ó¥·¥ç¥ó</A>¡¡<A href="?PID=popselectc2&rp=1">¡¦¸Í·ú¤Æ</A>¡¡<A href="?PID=popselectc3&rp=1">¡¦»ö¶ÈÍÑ</A></p>
                                        </TD>
                                        <TD width="80" bgColor="#fafbfc"><IMG height="27" src="http://fudousan.itcube.ne.jp/asp/img_f/ver2/bd_type_link3.jpg" width="87"></TD>
                                        <TD width="258" bgColor="#fafbfc"><A href="?PID=popselectb1&rp=1">¡¦¸Í·ú¤Æ¡¦¥Þ¥ó¥·¥ç¥ó</A>¡¡<A href="?PID=popselectb3&rp=1">¡¦»ö¶ÈÍÑÊª·ï</A>¡¡<A href="?PID=popselectb2&rp=1">¡¦ÅÚÃÏ</A></TD>
        ...
        <td align="left">
            <TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
                <TR class="realestate_bgcolor2">
                    ...
                    <th width="26%">
                        <div class="font12">
                            <div align="center"><strong><a href="?PID=popselectc3&cid=<?php echo $_SESSION["cid"];?>&sort=bukkenn_id<?php if($_SESSION["sort"]=="bukkenn_id") { echo " desc";}?>">Êª·ïÈÖ¹æ
                                <?php if($_SESSION["sort"]=="bukkenn_id") { echo "¢§";}elseif($_SESSION["sort"]=="bukkenn_id desc") { echo "¢¥";}?>
                                </a></strong></div>
                        </div>
                    </th>
                    <th width="16%" rowspan="2">
                        <div align="center"><strong><a href="?PID=popselectc3&cid=<?php echo $_SESSION["cid"];?>&sort=kakaku<?php if($_SESSION["sort"]=="kakaku") { echo " desc";}?>"><?php echo $bsetdata["kakaku_name"] ?>
                    ...
                    <th width="11%" rowspan="2">
                        <div align="center"><strong><a href="?PID=popselectc3&cid=<?php echo $_SESSION["cid"];?>&sort=senyumenseki<?php if($_SESSION["sort"]=="senyumenseki") { echo " desc";}?>"><?php echo $bsetdata["senyumenseki_name"] ?>
                                        <?php if($_SESSION["sort"]=="senyumenseki") { echo "¢§";}elseif($_SESSION["sort"]=="senyumenseki desc") { echo "¢¥";}?>
                        </a></strong></div>
                    </th>
                    <th colspan="2" class="font12">
                        <div align="center"><?php echo $bsetdata["ensen_name"] ?></div>
                    </th>
                    <th width="5%" rowspan="2"><strong>¸ø³«</strong></th>
...
?>
                    ...
                    <TD rowspan="2" nowrap class="font12" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
                        <div align="center">
                            <?php if($re1data[$re1rows]["senyumenseki"]!=NULL) {echo $re1data[$re1rows]["senyumenseki"]."m<sup>2</sup>";}?>
                        </div>
                    </TD>
                ...
                <TR class="realestate_bgcolor3"<?php if(SelChk($re1data[$re1rows]["id"])==1){ echo ' bgcolor="#FFECEC"';}else { echo ' bgcolor="#FFFFFF"';}?>>
                    <TD valign="top" class="font12" <?php if(SelChk($re1data[$re1rows]["id"])==1){ echo ' bgcolor="#FFECEC"';}else { echo ' bgcolor="#FFFFFF"';}?>>
