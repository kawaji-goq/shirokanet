												...
												<TD align="center" valign="top">
														<table cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="bukken_mei_view" type="checkbox" id="bukken_mei_view" value="1"<?php if($bsetdata["bukken_id_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="jyusyo_view" type="checkbox" id="jyusyo_view" value="1"<?php if($bsetdata["jyusyo_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="ensen_admin" type="checkbox" id="ensen_admin" value="1"<?php if($bsetdata["ensen_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="ensen_view" type="checkbox" id="ensen_view" value="1"<?php if($bsetdata["ensen_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="kouzou_admin" type="checkbox" id="kouzou_admin" value="1"<?php if($bsetdata["kouzou_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="kouzou_view" type="checkbox" id="kouzou_view" value="1"<?php if($bsetdata["kouzou_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="chiku_nen_admin" type="checkbox" id="chiku_nen_admin" value="1"<?php if($bsetdata["chiku_nen_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="chiku_nen_view" type="checkbox" id="chiku_nen_view" value="1"<?php if($bsetdata["chiku_nen_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
												...
												<TD align="center" valign="top">
														<table cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="senyumenseki_view" type="checkbox" id="senyumenseki_view" value="1"<?php if($bsetdata["senyumenseki_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="senyumenseki_admin" type="checkbox" id="senyumenseki_admin" value="1"<?php if($bsetdata["senyumenseki_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
