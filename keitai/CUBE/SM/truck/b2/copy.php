	...
	if($mimagefile2["filepath"]!=NULL||$data["delimage"]==1){
		...
		$ftp->Connect($_SESSION["DomainData"]["id"],$_SESSION["DomainData"]["pass"]);
			...
			if($mimagefile2["filepath"]!=NULL) {
				...
				$ftp->UpData("tmp/".$bname."_data/".$maxid."/","pop1".$mimagefile2["name"],$_SERVER['DOCUMENT_ROOT']."/tmp/".$bname."_data/".$maxid."/pop1".$mimagefile2["name"],"b");
				$fary[]="madorizu2";
                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p><font color="#000000">売買土地物件</font> </p>
                              </td>
                          </tr>
                      </table>
                  </td>
