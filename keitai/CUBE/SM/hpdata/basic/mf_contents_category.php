...
for($i=0;$_REQUEST["cate_id"][$i]!=NULL;$i++) {
	$dbobj->Query("update info1_cate set cate_name = '".$_REQUEST["cate_name"][$i]."',turn=".$_REQUEST["turn"][$i].",view_chk=".$_REQUEST["view_chk"][$i].",url='".$_REQUEST["temp_id"][$i]."' where cate_id=".$_REQUEST["cate_id"][$i]);
}
                  ...
                  <tr>
    				...
    				<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
								<tr>
										...
										<th width="294" align="left" bgcolor="#ECECEC"><strong>コンテンツ名</strong></th><?php
										if($basic2==1){?>
										<th width="79" align="left" bgcolor="#ECECEC">テンプレート</th><?php }?>
										<th width="91" align="left" bgcolor="#ECECEC">公開設定</th>
...
?>
								<tr>
										...
										if($basic2==1){?>
										<td align="left" valign="top" bgcolor="#FFFFFF">
										    <select name="temp_id[<?php echo $contentsrow; ?>]">
														<option value="t_all"<?php if($contentscatedata[$contentsrow]["url"]=="t_all"){ echo "selected";}?>>全面編集</option>
														<option value ="t_basics1"<?php if($contentscatedata[$contentsrow]["url"]=="t_basics1"){ echo " selected";}?>>基本(レイアウト1)</option>
										        </select>
										    </td>
														<?php
														}
