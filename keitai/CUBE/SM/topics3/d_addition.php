	...
	function AdditionData($data) {
		...
		if($data["day_view"]!=1) {
  		...
  		$field[]="cate_id";
			...
			$tdata[]="'".$data["text2"]."'";
			$field[]="text3";
			$tdata[]="'".$data["new_data_comm3"]."'";
			$field[]="text4";
			$tdata[]="'".$data["new_data_comm4"]."'";
			$field[]="text5";
			$tdata[]="'".$data["new_data_comm5"]."'";
			$field[]="text6";
			$tdata[]="'".$data["new_data_comm6"]."'";
		...
		if($imagefile["filepath"]!=NULL) {
			...
			if($image_file6["filepath"]!=NULL) {
				...
				$ftp->MkDir("tmp",$bname."_data");
				$ftp->MkDir("tmp/".$bname."_data",$maxid);
				$ftp->UpData("tmp/".$bname."_data/".$maxid."/",$image_file6["name"],$_SERVER['DOCUMENT_ROOT']."/tmp/".$_SESSION["DomainData"]["dbname"]."/".$bname."_data/".$image_file6["name"],"b");
			}
			else if($setdata["detailsimg_defalt"]!=NULL){
				$field[]="image6";
				$tdata[]="'".$setdata["detailsimg_defalt"]."'";
...
if(str_replace("www.","",$_SERVER['HTTP_HOST'])=="e-altus.com"){
$ad_blog=new Admin_Blog3($dbobj);
}
                        ...
                        <td colspan="2">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="98%" class="title"><strong>トピックの登録</strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
...
//-->
                                            ...
                                            <tr>
                                                <td width="100%">
                                                    <table width="511" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td><strong><span class="yearmonth"><?php 
																																																												if($topicsdata["ryear"]!=NULL) {
																																																												echo $topicsdata["ryear"];?>年<?php
																																																												}
																																																												if($topicsdata["rmonth"]!=NULL) {
																																																												echo $topicsdata["rmonth"];?>月 <?php
																																																												}
																																																												?></span></strong></td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td height="13" background="img/topics/TopicsLine.jpg"><span class="date"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                        </tr>
			...
			?>
                                                ...
                                                <td class="title">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="3%">■</td>
                                                            <td width="97%">
                                                                <input name="new_data_title" type="text" id="new_data_title" value="" size="50" style="width:98%;">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td valign="top" class="text"><strong>本文1
                                                    		<input name="cate_id" type="hidden" id="cate_id" value="1">
                                                </strong></td>
                                            </tr>
                                            <tr>
                                                <td valign="top" class="text">
                                                    <textarea name="new_data_comm" cols="50" rows="20" id="new_data_comm" style="width:98%;"></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" class="text">
		...
		?>
            ...
            <td align="left"><input name="day_txt" type="text" id="day_txt" size="40" value="<?php echo $blogdata["day_txt"];?>"></td>
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top" bgcolor="#FFFFFF"><strong>画像登録1</strong></td>
                                                        </tr>
                                                        <tr>
				 ...
				 ?>
                                            ...
                                            <tr>
                                            		<td><span class="text"><strong>本文2
																														
																								</strong></span></td>
                                         		</tr>
                                            <tr>
                                            		<td><textarea name="new_data_comm3" cols="50" rows="20" id="new_data_comm3" style="width:98%;"></textarea></td>
                                         		</tr>
                                            <tr>
		...
		?>
            ...
            <td align="left"><input name="day_txt" type="text" id="day_txt" size="40" value="<?php echo $blogdata["day_txt"];?>"></td>
                                            				...
                                            				<tr>
                                            						<td align="left" valign="top" bgcolor="#FFFFFF"><strong>画像登録2</strong></td>
                                            						</tr>
                                            				<tr>
				 ...
				 ?>
                                            ...
                                            <tr>
                                            		<td><span class="text"><strong>本文3</strong></span></td>
                                         		</tr>
                                            <tr>
                                            		<td><textarea name="new_data_comm4" cols="50" rows="20" id="new_data_comm4" style="width:98%;"></textarea></td>
                                         		</tr>
                                            <tr>
                                            		<td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1">
                                            				<?php
		?>
            ...
            <td align="left"><input name="day_txt" type="text" id="day_txt" size="40" value="<?php echo $blogdata["day_txt"];?>"></td>
                                            				...
                                            				<tr>
                                            						<td align="left" valign="top" bgcolor="#FFFFFF"><strong>画像登録3</strong></td>
                                            						</tr>
                                            				<tr>
				 ...
				 ?>
                                            ...
                                            <tr>
                                            		<td><span class="text"><strong>本文4</strong></span></td>
                                         		</tr>
                                            <tr>
                                            		<td><textarea name="new_data_comm5" cols="50" rows="20" id="new_data_comm5" style="width:98%;"></textarea></td>
                                         		</tr>
                                            <tr>
                                            		<td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1">
                                            				<?php
		?>
            ...
            <td align="left"><input name="day_txt" type="text" id="day_txt" size="40" value="<?php echo $blogdata["day_txt"];?>"></td>
                                            				...
                                            				<tr>
                                            						<td align="left" valign="top" bgcolor="#FFFFFF"><strong>画像登録4</strong></td>
                                            						</tr>
                                            				<tr>
				 ...
				 ?>
                                            ...
                                            <tr>
                                            		<td><span class="text"><strong>本文5</strong></span></td>
                                         		</tr>
                                            <tr>
                                            		<td><textarea name="new_data_comm6" cols="50" rows="20" id="new_data_comm6" style="width:98%;"></textarea></td>
                                         		</tr>
                                            <tr>
                                            		<td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1">
                                            				<?php
		?>
            ...
            <td align="left"><input name="day_txt" type="text" id="day_txt" size="40" value="<?php echo $blogdata["day_txt"];?>"></td>
                                            				...
                                            				<tr>
                                            						<td align="left" valign="top" bgcolor="#FFFFFF"><strong>画像登録5</strong></td>
                                            						</tr>
                                            				<tr>
...
function on_load() {
    ...
    var oFCKeditor3 = new FCKeditor( 'new_data_comm3' );
    ...
    var oFCKeditor4 = new FCKeditor( 'new_data_comm4' );
    ...
    var oFCKeditor5 = new FCKeditor( 'new_data_comm5' );
    ...
    var oFCKeditor6 = new FCKeditor( 'new_data_comm6' );
...
/*
    ...
    var oFCKeditor2 = new FCKeditor( 'text2' );
    
    oFCKeditor2.BasePath = '/fckeditor/';
    oFCKeditor2.Width = '400';
    oFCKeditor2.Height = '400';
    oFCKeditor2.ToolbarSet = 'Mymenu';
    ...
    oFCKeditor3.BasePath = '/fckeditor/';
    oFCKeditor3.Width = '400';
    oFCKeditor3.Height = '400';
    oFCKeditor3.ToolbarSet = 'Mymenu';
