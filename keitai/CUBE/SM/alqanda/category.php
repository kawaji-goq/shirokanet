...
function delchk(name,id) {
	...
	if(res) {
		location.href="?PID=al_qa&pmode=delete&delid="+id+"&cid=<?php echo $_REQUEST["cid"];?>";
	}
												...
												<form id="form1" name="form1" method="post" action="">
																<table width="690" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
																				<tr>
																								...
																								<th width="410" align="left" bgcolor="#ECECEC"><strong>ｶﾃｺﾞﾘ名</strong></th>
																								<th width="89" align="left" bgcolor="#ECECEC">公開</th>
																								<th colspan="2" align="left" bgcolor="#ECECEC">
																												<div align="center">
																																<input type="button" name="Submit" value="新規追加" onclick="location.href='?PID=al_qa_add&cid=<?php echo $_REQUEST["cid"];?>'" />
																												</div>
																								</th>
																				</tr>
																				<?php
...
/*　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　*/
/*↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓*/
$qandacatedata=$ad_qanda->GetCateList($_GET["cid"],$lim,$setnum,$orderby);
...
?>
																				<tr>
																								...
																								<td width="410" align="left" valign="top" bgcolor="#FFFFFF">
																												<?php $qandacate->Moji("cate_name"); ?>
																								...
																								<td width="42" align="left" valign="top" bgcolor="#FFFFFF">
																												<input type="button" name="Submit" value="修正" onclick="location.replace('?PID=al_qa_up&cid=<?php echo $_REQUEST["cid"];?>&cate_id=<?php echo $qandacatedata[$qandarow]["cate_id"];?>')" />
																								</td>
																								<td width="42" align="left" valign="top" bgcolor="#FFFFFF">
