								...
								<table width="692" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
										...
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo1"];?>" />
														<?php }
																		?>
												</td>
										</tr>
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo2"];?>" />
														<?php }
																		?>
												</td>
										</tr>
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo3"];?>" />
														<?php }
																		?>
												</td>
										</tr>
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo4"];?>" />
														<?php }
																		?>
												</td>
										</tr>
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo5"];?>" />
														<?php }	?>
												</td>
										</tr>
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["madorizu1"];?>" />
														<?php }
																		?>
												</td>
										</tr>
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"> 
														...
														<img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["madorizu2"];?>" />
														<?php }
																		?>
												</td>
										</tr>
