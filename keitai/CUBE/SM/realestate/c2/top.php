...
if($_GET["adc2sort"]!=NULL) {
	$_SESSION["adc2sort"]=$_GET["adc2sort"];
}
/*
else if($_SESSION["adc2sort"]==NULL){
	$_SESSION["adc2sort"]="kakaku";
}
*/
if($_GET["cid"]!=NULL) {
...
if(substr_count($_SERVER['HTTP_REFERER'],"re_c2")==0) {
	$_SESSION["madori"]="";
	$_SESSION["lowcost"]="";
	$_SESSION["hicost"]="";
	$_SESSION["keyword"]="";
...
$re1obj->type=2;
$re1data=$re1obj->GetReList(1,$_SESSION["adc2sort"]);
...
function goreplace(bid) {
	location.href="index.php?PID=re_c2_rep&bid="+bid;
}

function godelete(bid) {
	location.href="index.php?PID=re_c2_del&bid="+bid;
}
...
function gocopy(bid) {
	location.href="index.php?PID=re_c2_copy&bid="+bid;
}
...
<TABLE width="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
							...
							<tr>
									...
									<td>
											<table width="100%"  border="0" cellspacing="0" cellpadding="5">
													<tr>
															<td class="font10"> <span class="font14"><strong>賃貸戸建て物件　管理</strong> </span> </td>
													</tr>
											</table>
									</td>
							</tr>
	...
	<TR>
	    <TD><div class="helper">
              ...
              <tr>
                  <td bgcolor="#FFFFFF">賃貸戸建て物件に表示する項目を設定するには<a href="?PID=re_c2_set">こちらをクリック</a>してください。
		            <br>
      データの入力されていない項目をお客様用の物件詳細ページで表示しない場合は<a href="?PID=re_osetting">こちらをクリック</a>してください。<br>
      <font color="#FF0000">※この設定は全ての種別で共通になっております。</font></font></td>
              </tr>
          </table>
		    </div>
	    </TD>
		...
		<TD><br>
				<form name="form1" method="post" action="">
					<TABLE width="100%"  border="0" cellspacing="0" cellpadding="5">
                      ...
                      <TR bgcolor="#CCCCFF">
                        <TD bgcolor="#DDDDFF">
                          <input type="button" name="Submit" value="新規物件登録" onClick="location.href='index.php?PID=re_c2_add'"></TD>
                        <TD bgcolor="#DDDDFF">
                      ...
                      <TR>
                        ...
                        <TD><div align="right"><strong>表示件数</strong>
                                <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                                  <option value="?PID=re_c2&lim=10&page=1"<?php if($_SESSION["lim"]==10||$_SESSION["lim"]==NULL) { echo " selected";}?>>10件</option>
                                  <option value="?PID=re_c2&lim=20&page=1"<?php if($_SESSION["lim"]==20) { echo " selected";}?>>20件</option>
                                  <option value="?PID=re_c2&lim=30&page=1"<?php if($_SESSION["lim"]==30) { echo " selected";}?>>30件</option>
                                  <option value="?PID=re_c2&lim=40&page=1"<?php if($_SESSION["lim"]==40) { echo " selected";}?>>40件</option>
                                  <option value="?PID=re_c2&lim=50&page=1"<?php if($_SESSION["lim"]==50) { echo " selected";}?>>50件</option>
                                  <option value="?PID=re_c2&lim=100&page=1"<?php if($_SESSION["lim"]==100) { echo " selected";}?>>100件</option>
                                </select>
                        </div></TD>
                      </TR>
                </TABLE>
					<TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
									<TR class="realestate_bgcolor2">
											<th width="3%" rowspan="3" nowrap><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&adc2sort=osusume<?php if($_SESSION["adc2sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
													スメ</strong></a></th>
											<th width="7%" rowspan="3" valign="middle">
													<div align="center"><?php echo $bsetdata["photo_name"] ?></div>
											</th>
											<th width="25%">
													<div class="font12">
															<div align="center"><strong><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&adc2sort=bukkenn_id<?php if($_SESSION["adc2sort"]=="bukkenn_id") { echo " desc";}?>">物件番号</a><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&adc2sort=bukkenn_id<?php if($_SESSION["adc2sort"]=="bukkenn_id") { echo " desc";}?>">
																	<?php if($_SESSION["adc2sort"]=="bukkenn_id") { echo "▼";}elseif($_SESSION["adc2sort"]=="bukkenn_id desc") { echo "▲";}?>
															</a></strong></div>
													</div>
											</th>
											<th width="11%" rowspan="3" class="font12">
													<div align="center"><span class="st"><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&amp;adc2sort=kakaku<?php if($_SESSION["adc2sort"]=="kakaku") { echo " desc";}?>"><?php echo $bsetdata["kakaku_name"] ?></a></span><br />
																	<?php echo $bsetdata["kanrihi_name"] ?></div>
											</th>
											<th width="10%" rowspan="3" align="center" class="font12"><span class="st"><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&amp;adc2sort=madori<?php if($_SESSION["adc2sort"]=="madori,mnum") { echo " desc";}?>,mnum<?php if($_SESSION["adc2sort"]=="madori,mnum") { echo " desc";}?>"><?php echo $bsetdata["madori_name"] ?></a><br />
											...
											<th width="3%" rowspan="3" align="center" class="font12">
               <div align="center">POP</div>
											...
											<th width="6%" rowspan="3"><div align="center" class="font12"><strong><font color="#000000">選択削除</font></strong></div></th>
									</TR>
									<TR class="realestate_bgcolor2">
											<th width="25%" rowspan="2">
													<div align="center"><strong><font color="#000000">物件名</font></strong></div>
											
													<div align="center"><strong><font color="#000000">					<div align="center" class="st"><a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["adc2sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&adc2sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&adc2sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"><?php echo $bsetdata["jyusyo_name"] ?></a></div></font></strong></div>
											</th>
									</TR>
									<TR class="realestate_bgcolor2">
											<th width="8%" align="center" class="font12"><?php echo $bsetdata["reikin_name"] ?><br />
															<?php echo $bsetdata["shikikin_name"] ?></th>
											<th width="15%" class="font12">
													<div align="center">
									...
									<?php
													...
													?>
									<TR <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
											<TD width="3%" rowspan="3" valign="middle" class="font12"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
											...
											<TD width="7%" rowspan="3" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
													<div align="center"><a href="?PID=re_c2_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>">
													    <?php
...
?>
             </a><a href="?PID=re_c2_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>"></a></div>
											</TD>
											<TD valign="top" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
													<div class="font12"> 
															<div align="center"><?php echo $re1data[$re1rows]["bukkenn_id"];?> 　 </div>
													</div>
											</TD>
											<td rowspan="3" align="left" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
													<div align="center">
											...
											<td rowspan="3" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
											...
											<td colspan="2" rowspan="2" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
               ...
               <div align="center">
                   <input type="button" name="Submit" value="設定" onClick="location.href='?PID=re_osetting'">
											...
											<TD width="4%" rowspan="2" valign="middle" bgcolor="#FFECEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
													    <table border="0" align="center" cellpadding="0" cellspacing="3"<?php if($tenpodata["c2lastupid"]==$re1data[$re1rows]["id"]) {?> style="background-color:#666666;"<?php }?>>
                     <tr>
                         <td>
                             <input type="button" name="Submit" value="修正" onClick="goreplace('<?php echo $re1data[$re1rows]["id"];?>')">
											...
											<TD width="4%" rowspan="3" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
											...
											<TD width="4%" rowspan="3" valign="middle" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><div align="center"><span class="font12">
													<input type="button" name="Submit" value="削除" onClick="godelete('<?php echo $re1data[$re1rows]["id"];?>')">
													</span></div>
											</TD>
											<TD width="6%" rowspan="3" valign="middle" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><div align="center"><span class="font12">
													<input name="del[<?php echo $re1rows;?>]" type="checkbox" id="del[<?php echo $re1rows;?>]" value="1" />
											</span></div></TD>
									</TR>
									<TR>
											<TD rowspan="2" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
									...
									<TR>
											<td align="center" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
													<div align="center">
											...
											<td align="center"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
													<div align="center"><?php echo $re1data[$re1rows]["syumoku"]; ?><br />
																	<?php echo $re1data[$re1rows]["kouzou"]; ?></div>
											</td>
											<td align="center" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
											    <div align="center">
											        <input type="button" name="Submit" value="POP" onclick="window.open('http://siteadmin.itcube.ne.jp/sm/realestate/c2/print<?php echo $tenpodata["poptype"];?>.php?bid=<?php echo $re1data[$re1rows]["id"];?>&did=<?php echo urlencode($_SESSION["DomainData"]["dbname"]);?>&domain=<?php echo $_SESSION["DomainData"]["domain_name"];if($_SESSION["DomainData"]["dbtype"]=="mysql") { echo "&dtype=mysql";}?>')" />
								              </div>
											</td>
											<TD width="4%" valign="middle" bgcolor="#FFECEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
