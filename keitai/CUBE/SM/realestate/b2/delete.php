														...
														<table width="100%"  border="0" cellspacing="0" cellpadding="5">
																<tr>
																		<td bgcolor="#FFFFFF" class="font10">
																				<p><font color="#000000">土地物件 </font> </p>
																		</td>
																</tr>
														</table>
												</td>
								...
								<table width="692" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
										...
										<tr>
												<td bgcolor="#FFFFFF" class="font12">  <?php echo $re1data["todouhuken"];?> <?php echo $re1data["jyusyo1"];?> <br />
																		<?php echo $re1data["jyusyo2"];?> <?php echo $re1data["jyusyo3"];?> 
											  </td>
										</tr>
										<tr>
												<td width="150" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14">価格</div>
												</td>
										...
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12">														<?php echo $re1data["hikiwatashi"];?>
