...
<TABLE width="700"  border="0" align="left" cellpadding="0" cellspacing="0" class="realestate_bgcolor1">
                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p><font color="#000000">売買土地物件登録</font> </p>
                              </td>
                          </tr>
                      </table>
                  </td>
		...
		<TR class="realestate_bgcolor2">
		    <TD valign="top"><div class="helper">売買土地物件に表示する項目を設定するには<a href="?PID=re_b2_set">こちらをクリック</a>してください。
		            <br>
      ...
      <font color="#FF0000">※この設定は全ての種別で共通になっております。</font></div></TD>
		...
		<TR class="realestate_bgcolor2">
				<TD valign="top">
					...
					?>
                            <tr>
                              <td width="150" valign="top" bgcolor="#EBEBEB" class="font14"><div align="right"><?php echo $bsetdata["bukken_id_name"] ?>
                                      <!--物件番号 -->
                              </div></td>
					...
					?>
                            <tr>
                              <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                                <div align="right"><?php echo $bsetdata["syumoku_name"] ?><font color="#FF0000">（※必須）</font></div></td>
					...
					?>
                            <tr>
                              <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                                <div align="right" class="font14"><?php echo $bsetdata["bukken_mei_name"] ?>
                                    <!--物件名称 -->
                              </div></td>
                              <td bgcolor="#FFFFFF" class="font12">
      ...
      番地を公開</label>
					...
					?>
                            <tr>
                              <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                                <div align="right" class="font14"><?php echo $bsetdata["kakaku_name"] ?></div></td>
                              <td bgcolor="#FFFFFF" class="font12">
            ...
            <td bgcolor="#FFFFFF" class="font12">  
              ...
              分</td>
					...
					?>
                            ...
                            <tr>
                              <td bgcolor="#FFFFFF" class="font12"><input name="chuugakouku" type="text" id="chuugakouku" size="12" />
                                中学校</td>
                            </tr>
                            <?php 
					}
...
?>
					...
					?>
                            <tr>
                              <td valign="top" bgcolor="#EBEBEB" class="font14"><div align="right"><?php echo $bsetdata["syakuchikikan_chidai_name"] ?>
                                      <!--借地期間・地代 -->
                              </div></td>
                              <td bgcolor="#FFFFFF" class="font12">
					...
					?>
                            <tr>
                              <td valign="top" bgcolor="#EBEBEB" class="font14"><div align="right"><?php echo $bsetdata["zappi_name"] ?>
                                      <!--その他一時金 -->
                              </div></td>
                              <td bgcolor="#FFFFFF" class="font12">
					...
					?>
                            <tr>
                              <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                                <div align="right" class="font14"><?php echo $bsetdata["genkyou_name"] ?>
                                    <!--現況 -->
                              </div></td>
                              <td bgcolor="#FFFFFF" class="font12">
...
※全角30文字以内 </div></td>
					...
					?>
                            <tr>
                              <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                                <div align="right" class="font14"><?php echo $bsetdata["torihikitaiyou_name"] ?>
                                    <!--取引態様 -->
                              </div></td>
                              <td bgcolor="#FFFFFF" class="font12">
