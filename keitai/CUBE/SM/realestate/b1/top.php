...
if($_GET["adb1sort"]!=NULL) {
	$_SESSION["adb1sort"]=$_GET["adb1sort"];
}
...
if(substr_count($_SERVER['HTTP_REFERER'],"re_b1")!=0) {
	$_SESSION["madori"]="";
	$_SESSION["lowcost"]="";
	$_SESSION["hicost"]="";
	$_SESSION["keyword"]="";
...
$re1obj->type=4;
$re1data=$re1obj->GetReList(2,$_SESSION["adb1sort"]);
...
function goreplace(bid) {
	location.href="index.php?PID=re_b1_rep&bid="+bid;
}
function gocopy(bid) {
	location.href="index.php?PID=re_b1_copy&bid="+bid;
}
							...
							<tr>
									...
									<td>
											<table width="100%"  border="0" cellspacing="0" cellpadding="5">
													<tr>
															<td class="font10"><strong>売買マンション・戸建て 管理</strong> </td>
													</tr>
											</table>
									</td>
							</tr>
  ...
  <TR>
      <TD><div class="helper">
          <table width="100%" border="0" cellpadding="3" cellspacing="1" id="helper">
              ...
              <tr>
                  <td bgcolor="#FFFFFF">
                      売買マンション・戸建てに表示する項目を設定するには<a href="?PID=re_b1_set">こちらをクリック</a>してください。 <br>
          ...
          <TR> 
            <TD>
            		<TABLE width="100%"  border="0" cellspacing="0" cellpadding="5">
                      ...
                      <TR bgcolor="#CCCCFF">
                        <TD bgcolor="#DDDDFF">
                          <input type="button" name="Submit" value="新規物件登録" onClick="location.href='index.php?PID=re_b1_add'"></TD>
                        <TD bgcolor="#DDDDFF">
...
&nbsp;</strong></TD>
                        <TD><div align="right"><strong>表示件数</strong>
                          <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                            <option value="?PID=re_b1&lim=10&page=1"<?php if($_SESSION["lim"]==10||$_SESSION["lim"]==NULL) { echo " selected";}?>>10件</option>
                            <option value="?PID=re_b1&lim=20&page=1"<?php if($_SESSION["lim"]==20) { echo " selected";}?>>20件</option>
                            <option value="?PID=re_b1&lim=30&page=1"<?php if($_SESSION["lim"]==30) { echo " selected";}?>>30件</option>
                            <option value="?PID=re_b1&lim=40&page=1"<?php if($_SESSION["lim"]==40) { echo " selected";}?>>40件</option>
                            <option value="?PID=re_b1&lim=50&page=1"<?php if($_SESSION["lim"]==50) { echo " selected";}?>>50件</option>
                            <option value="?PID=re_b1&lim=100&page=1"<?php if($_SESSION["lim"]==100) { echo " selected";}?>>100件</option>
                          </select>
                        </div></TD>
                      </TR>
                    </TABLE>       		</TD> 
        ...
        <TABLE width="100%"  border="0" align="center" cellpadding="2" cellspacing="1" class="bukkentable"> 
          <TR class="realestate_bgcolor2">
          		<th width="3%" rowspan="2" align="center" valign="middle" nowrap>
          				<div align="center"><a href="?PID=re_b1&cid=<?php echo $_SESSION["cid"];?>&adb1sort=osusume<?php if($_SESSION["adb1sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
          						スメ </strong></a></div>
          		</th>
          		<th width="7%" rowspan="2" align="center" valign="middle" class="font12"><?php echo $bsetdata["photo_name"] ?></th>
          		<th width="19%">
          				<div align="center"><strong><a href="?PID=re_b1&cid=<?php echo $_SESSION["cid"];?>&adb1sort=bukkenn_id<?php if($_SESSION["adb1sort"]=="bukkenn_id") { echo " desc";}?>">物件番号</a>
          						<?php if($_SESSION["adb1sort"]=="bukkenn_id") { echo "▼";}elseif($_SESSION["adb1sort"]=="bukkenn_id desc") { echo "▲";}?>
          						</strong></div>
          		</th>
          		<th width="13%" rowspan="2">
									<div align="center"><strong><a href="?PID=re_b1&cid=<?php echo $_SESSION["cid"];?>&adb1sort=kakaku<?php if($_SESSION["adb1sort"]=="kakaku") { echo " desc";}?>">価格<?php if($_SESSION["adb1sort"]=="kakaku") { echo "▼";}elseif($_SESSION["adb1sort"]=="kakaku desc") { echo "▲";}?></a></strong></div>
          		</th>
          		<th width="11%" rowspan="2">
									<div align="center"><strong><a href="?PID=re_b1&cid=<?php echo $_SESSION["cid"];?>&adb1sort=madori<?php if($_SESSION["adb1sort"]=="madori,mnum") { echo " desc";}?>,mnum<?php if($_SESSION["adb1sort"]=="madori,mnum") { echo " desc";}?>">間取り<?php if($_SESSION["adb1sort"]=="madori,mnum") { echo "▼";}elseif($_SESSION["adb1sort"]=="madori desc,mnum desc") { echo "▲";}?></a></strong><br>
          		...
          		<th width="5%" rowspan="2">公開</th>
          		<th width="3%" rowspan="2"> 
              		<div align="center" class="font14">
              				<div align="center"><strong>削除</strong></div>
              		</div>
          		</th>
          		<th width="7%" rowspan="2"><div align="center" class="font14">
          				<div align="center"><strong>選択削除</strong></div>
          				</div></th>
   		  	</TR>
          <TR class="realestate_bgcolor2">
          		<th> 
              <div class="font14"> 
                	<div align="center"><strong><font color="#000000"><?php echo $bsetdata["bukken_mei_name"] ?><br>
																<div align="center"><strong><font color="#000000">					<div align="center" class="st"><a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["adb1sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&adb1sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&adb1sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"><?php echo $bsetdata["jyusyo_name"] ?></a></div></font></strong></div>											</font></strong></div>
              </div> 
            </th> 
            	<th width="11%" align="center" class="font12"><?php echo $bsetdata["youtochiiki_name"] ?></th>
          ...
          <TR class="realestate_bgcolor3">
          		...
          		<td width="7%" rowspan="2" align="center" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>> 
          				<div align="center"><a href="?PID=re_b1_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>">
          				    <?php
...
?>
              </a><a href="?PID=re_b1_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>"></a></div>
          		</td>
          		...
          		<TD width="11%" rowspan="2" nowrap class="font12"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
          		...
          		<TD align="center" valign="middle" bgcolor="#FFECEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
          				<div align="center">
          				    <table border="0" align="center" cellpadding="0" cellspacing="3"<?php if($tenpodata["b1lastupid"]==$re1data[$re1rows]["id"]) {?> style="background-color:#666666;"<?php }?>>
                      <tr>
                          <td>
          		...
          		<TD width="3%" rowspan="2" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>> 
              
              		<div align="center">
              				<input type="button" name="Submit" value="削除" onclick="godelete('<?php echo $re1data[$re1rows]["id"];?>')" />
              				</div>            </TD>
          		<TD width="7%" rowspan="2" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><div align="center"><span class="font14"><span class="font12">
          ...
          <TR class="realestate_bgcolor3">
            	...
            	<TD<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
            			
            					<div align="center">
            					    <input type="button" name="Submit" value="POP" onclick="window.open('http://siteadmin.itcube.ne.jp/sm/realestate/b1/print<?php echo $tenpodata["poptype"];?>.php?bid=<?php echo $re1data[$re1rows]["id"];?>&did=<?php echo urlencode($_SESSION["DomainData"]["dbname"]);?>&domain=<?php echo $_SESSION["DomainData"]["domain_name"];if($_SESSION["DomainData"]["dbtype"]=="mysql") { echo "&dtype=mysql";}?>')" />
        					    </div>
            	</TD>
            	<TD align="center" valign="middle" bgcolor="#FFECEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
        ...
        <table width="740"  border="0" align="center" cellpadding="0" cellspacing="0" class="font12">
						<tr>
								<td>&nbsp;</td>
						</tr>
						<tr>
