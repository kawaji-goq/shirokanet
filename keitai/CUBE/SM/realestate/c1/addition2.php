...
<form action="" method="post" enctype="multipart/form-data" name="bukken_form">
                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p><font color="#000000">賃貸アパート・</font><font color="#000000">マンション物件登録 </font> </p>
                              </td>
                          </tr>
                      </table>
                  </td>
  ...
  <TR class="realestate_bgcolor2">
	...
	if(str_replace("www.","",$_SERVER['HTTP_HOST'])!="nest-h.com"){
		?>
  <TR class="realestate_bgcolor2">
      <TD valign="top"><div class="helper">
          <table width="100%" border="0" cellspacing="1" cellpadding="3">
              ...
              <tr>
                  <td bgcolor="#FFFFFF">賃貸アパート・マンションに表示する項目を設定するには<a href="?PID=re_c1_set">こちらをクリック</a>してください。 <br>
                          ...
                          <tr>
                              ...
                              <td class="font12">
                                  <select name="syumoku" id="syumoku">
                                      <option<?php if($re1data["syumoku"]=="アパート"){echo " selected";}?>>アパート</option>
  ...
  <TR class="realestate_bgcolor2">
      <TD valign="top">
       ...
       <?php 
            ...
            <td class="font12">地上
              			<input name="chijoukaisou" type="text" class="noime" id="chijoukaisou" size="6" />
              			階<br />
																	地下
              			<input name="chikakaisou" type="text" class="noime" id="chikakaisou" size="6" />
階<br /> 
              所在
              <input name="kaisou" type="text" class="noime" id="kaisou" size="6" />
階 </td> 
          </tr> 
       <?php 
					}
            ...
            <td class="font12"> <span>  
                ...
                <input name="shinchiku" type="checkbox" id="shinchiku" value="1" /> <?php 
					}
				...
				if($bsetdata["senyumenseki_admin"]==1) {
					?><tr>
										  ...
										  <div align="right" class="font14"><?php echo $bsetdata["senyumenseki_name"] ?></div>										  </td>
												<td class="font12"> 
														<input name="senyumenseki" type="text" class="noime" id="senyumenseki" value="<?php echo $re1data["senyumenseki"];?>" size="6" />m<sup>2</sup> </td>
										</tr>	<?php 
					}
					...
					?><tr>
										...
										<tr>
										  ...
										  <div align="right" class="font14">バルコニー面積 </div>										  </td>
												<td class="font12"> 
<input name="barukoni_menseki" type="text" class="noime" id="barukoni_menseki" value="<?php echo $re1data["barukoni_menseki"];?>" size="6" />m<sup>2</sup> </td>
										</tr>
<?php 
					}
...
<input name="shikikin" type="text" class="noime" id="shikikin" value="<?php echo $re1data["shikikin"];?>" size="6" />ヶ月 </span>
<span class="realestate_bgcolor3">
		<input name="sikikintani" type="text" class="noime" id="sikikintani" value="<?php echo $re1data["sikikintani"];?>" size="6" />万円</span></td>
										</tr>
					<?php 
					}
					...
					?>					<tr>
										  ...
										  <div align="right" class="font14">
												...
												<td class="font12">  <span class="realestate_bgcolor3">
	<input name="reikin" type="text" class="noime" id="reikin" value="<?php echo $re1data["reikin"];?>" size="6" onChange="calprice('reikin_tani')" />ヶ月
	<input name="reikin_tani" type="text" class="noime" id="reikin_tani" value="<?php echo $re1data["reikin_tani"];?>" size="6" onClick="calprice('reikin_tani')" />万円 </span> </td>
										</tr>
<?php 
					}
...
<?php 
					...
					?>										<tr>
												...
												<td class="font12">
														<input name="syuzenhi_tsumitate" type="text" class="noime" id="syuzenhi_tsumitate" value="<?php echo $re1data["syuzenhi_tsumitate"];?>" size="20">
...
<?php 
					...
					?><tr>
												...
												<td class="font12"><span class="realestate_bgcolor3"> 
														<input name="hosyoukin_kikan" type="text" class="noime" id="hosyoukin_kikan" value="<?php echo $re1data["hosyoukin_kikan"];?>" size="6" onChange="calprice('hosyoukin_kakaku')" />
ヶ月
<input name="hosyoukin_kakaku" type="text" class="noime" id="hosyoukin_kakaku" value="<?php echo $re1data["hosyoukin_kakaku"];?>" size="6" onClick="calprice('hosyoukin_kakaku')" />万円 </span></td>
</tr>
<?php 
					}
...
<input name="chusya_ryoukin" type="text" class="noime" id="chusya_ryoukin" value="<?php echo $re1data["chusya_ryoukin"];?>" size="10" />円</td> 
          </tr><?php 
					}
?>
                      </table>
  ...
  <TR class="realestate_bgcolor2">
      <TD valign="top">
          <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
              <tr>
                  <th bgcolor="#ECECEC">
                      <div align="left"><?php if(str_replace("www.","",$_SERVER['HTTP_HOST'])=="hayashi-housing.co.jp"){ echo "左の画像"; }else {echo  $bsetdata["photo_name"] ;}?></div>
                  </th>
              </tr>
              <tr>
                  <td bgcolor="#FFFFFF">
