                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p>賃貸事業用物件<font color="#000000">複製登録 </font></p>
                              </td>
                          </tr>
                      </table>
                  </td>
		...
		<TR class="realestate_bgcolor2">
				<TD valign="top">
						<form action="" method="post" enctype="multipart/form-data" name="bukken_form">
						    <table width="696" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
              <?php 
              ...
              <tr>
                  <td width="150" rowspan="2" valign="top" bgcolor="#EBEBEB" class="font14">
                      <div align="right" class="font14">
                          <!--物件所在地  -->
                          <?php echo $bsetdata["jyusyo_name"] ?></div>
                  </td>
...
番地有効</label>
              ...
              <tr>
                  <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                      <div align="right" class="font14">
                          <!--賃料 -->
                          <?php echo $bsetdata["kakaku_name"] ?></div>
                  </td>
                  <td bgcolor="#FFFFFF" class="font12">
              ...
              <?php 
					...
					?>
              <input type="hidden" name="ensen" id="ensen" value="<?php echo $re1data["ensen"];?>">
              <input type="hidden" name="eki" id="eki" value="<?php echo $re1data["eki"];?>">
              <input type="hidden" name="ekiho" id="ekiho" value="<?php echo $re1data["ekiho"];?>">
              <?php 
										}
              ...
              <?php 
					...
					?>
              <input type="hidden" name="basu" id="basu" value="<?php echo $re1data["basu"];?>">
              <input type="hidden" name="basutei" id="basutei" value="<?php echo $re1data["basutei"];?>">
              <input type="hidden" name="basu_ho" id="basu_ho" value="<?php echo $re1data["basu_ho"];?>">
              <?php 
					}
              ...
              <?php 
					...
					?>
              <input type="hidden" name="syougakkouku" id="syougakkouku" value="<?php echo $re1data["syougakkouku"];?>">
              <?php 
										}
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo1"];?>" /><br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo2"];?>" /><br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo3"];?>" /> <br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo4"];?>" /><br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo5"];?>" /> <br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["madorizu1"];?>" /> <br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      ...
                      <img src="http://<?php echo $_SESSION["DomainData"]["domain_name"]."/tmp/bukken_data/".$re1data["id"]."/".$re1data["madorizu2"];?>" /><br />
              ...
              <tr>
                  ...
                  <td bgcolor="#FFFFFF" class="font12">
                      <input name="update_re" type="submit" id="update_re" value="登録する" />
