...
if($_REQUEST["pmode"]=="registandback") {
	$new_id=$ad_info3->AdditionData($_POST);
	$info3data=$ad_info3->GetDetailsData($new_id);
	$info3cdata=$ad_info3->GetDetailsCate($info3data["cate_id"]);
	?>
	<script type="text/javascript">
	location.replace('?PID=info3_details&cate_id=<?php echo $_GET["cate_id"];?>')
	</script>
	<?php
}
 ...
 <?php 
         	...
         	<tr>
         			...
         			<td align="left" valign="top" bgcolor="#FFFFFF">
         					<?php if($info3data["maker_logo"]!=NULL){;?>
									<img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info3data["maker_logo"];?>" alt="image" />
									<?php }?>
</td>
         			</tr>
         	<tr>
		 ...
		 ?>          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info3data["data_image"];?>" alt="image" />
              <?php }?>
</td>
          </tr>
		  <?php
		 ...
		 ?>           		<th align="left" valign="top" bgcolor="#ECECEC">イメージ画像2</th>
          		<td align="left" valign="top" bgcolor="#FFFFFF">
          				<?php if($info3data["data_image2"]!=NULL){;?>
									<img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info3data["data_image2"];?>" alt="image" />
									<?php }?>
</td>
          		</tr>
							       <?php 
		 ...
		 ?>    <tr>
          		...
          		<td align="left" valign="top" bgcolor="#FFFFFF">
          				<?php if($info3data["data_image3"]!=NULL){;?>
									<img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info3data["data_image3"];?>" alt="image" />
									<?php }?>
</td>
          		</tr><?php }?>
 <?php 
		 ...
		 ?>
          <tr>
            <th align="left" valign="top" bgcolor="#ECECEC">価格</th>
            <td align="left" valign="top" bgcolor="#FFFFFF">
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onClick="location.replace('?PID=info3_d_add&cate_id=<?php echo $_REQUEST["cate_id"];?>')">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onclick="location.replace('?PID=info3_details&cate_id=<?php echo $_GET["cate_id"];?>')" />
            </td>
          </tr>
        </table>
		<?php
		...
		<table width="600" border="0" align="center">
          <tr>
            ...
            <td align="left"><?php echo $info3cdata["cate_name"];?></td>
          </tr>
          <tr>
...
// -->
		 ...
		 ?>
          <tr>
            <th align="left" valign="top">価格</th>
            <td align="left" valign="top">
              <table width="100%" border="0">
                <tr>
                  <td width="35%" align="left" valign="top">
