...
if($_REQUEST["pmode"]=="regist") {
	$newid=$ad_info3->AdditionCate($_POST);
	$info3cdata=$ad_info3->GetDetailsCate($newid);
   ...
   <?php
		 ...
		 ?><tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <?php 
							if($info3cdata["cate_image"]!=NULL){
							$pdata=(getimagesize("http://".$_SESSION["DomainData"]["domain_name"].$info3cdata["cate_image"]));
							if($pdata[0]>400) {
								 $pdata[0]=400;
							}
														
							?>
              <img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info3cdata["cate_image"];?>" alt="image" width="<?php echo $pdata[0];?>px"/>
              <?php }?>
</td>
          </tr><?php
		  }
   ...
   <?php
		 ...
		 ?>          <tr>
          				...
          				<?php if($info3cdata["image2"]!=NULL){
							...
							if($pdata[0]>400) {
								 $pdata[0]=400;
									...
									?>
									<img src="<?php echo "http://".$_SESSION["DomainData"]["domain_name"].$info3cdata["image2"];?>" alt="image" width="<?php echo $pdata[0];?>px"/>
									<?php }?>
</td>
          		</tr>
							<?php
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onClick="location.replace('?PID=info3_add')">
