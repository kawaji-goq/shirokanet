                                            ...
                                            <tr>
                                                <td height="25"><?php 
																																															if($newbdata[$i]["banchichk"]){
																																																$jyusyo[$i]=mb_convert_kana($newbdata[$i]["jyusyo1"].$newbdata[$i]["jyusyo2"].$newbdata[$i]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i]=mb_convert_kana($newbdata[$i]["jyusyo1"].$newbdata[$i]["jyusyo2"],"K");
																																																}
                                                ...
                                                <td height="25">
                                                    <?php 
																																																if($newbdata[$i+1]["banchichk"]){
																																																				$jyusyo[$i+1]=mb_convert_kana($newbdata[$i+1]["jyusyo1"].$newbdata[$i+1]["jyusyo2"].$newbdata[$i+1]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i+1]=mb_convert_kana($newbdata[$i+1]["jyusyo1"].$newbdata[$i+1]["jyusyo2"],"K");
																																																}
                                                ...
                                                <td height="25">
                                                    <?php 
																																																if($newbdata[$i+2]["banchichk"]){
																																																				$jyusyo[$i+2]=mb_convert_kana($newbdata[$i+2]["jyusyo1"].$newbdata[$i+2]["jyusyo2"].$newbdata[$i+2]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i+2]=mb_convert_kana($newbdata[$i+2]["jyusyo1"].$newbdata[$i+2]["jyusyo2"],"K");
																																																}
                                                ...
                                                <td height="25">
                                                    <?php 
																																																if($newbdata[$i+3]["banchichk"]){
																																																				$jyusyo[$i+3]=mb_convert_kana($newbdata[$i+3]["jyusyo1"].$newbdata[$i+3]["jyusyo2"].$newbdata[$i+3]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i+3]=mb_convert_kana($newbdata[$i+3]["jyusyo1"].$newbdata[$i+3]["jyusyo2"],"K");
																																																}
