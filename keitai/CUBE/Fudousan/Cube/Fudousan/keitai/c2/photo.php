...
?>
<br>
<a href="/keitai/c2/list.php?madorinum=<?php echo $madorinum;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>&page=<?php echo $page;?>">戻る</a>
</body>
</html>
