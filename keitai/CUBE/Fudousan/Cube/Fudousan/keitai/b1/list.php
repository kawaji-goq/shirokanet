...
広さ：<a href="/keitai/b1/srch_madori.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php 
switch($madori) {
	case 1:
		echo "1R,K,DK,LDK";
		break;
...
価格：<a href="/keitai/b1/srch_cost.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php
...
地域：<a href="/keitai/b1/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>">
<?php
if($chiiki!=NULL) {
...
?>
</a><a href="/keitai/b1/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"></a><br>
...
while($re1data[$re1rows]["id"]!=NULL) {
	 kecho($re1data[$re1rows]["syumoku"]); ?><br>
	<a href="http://map.mobile.yahoo.co.jp/msearch?p=<?php echo urlencode(mb_convert_encoding($re1data[$re1rows]["jyusyo1"],"sjis","euc-jp").mb_convert_encoding($re1data[$re1rows]["jyusyo2"],"sjis","euc-jp").mb_convert_encoding($re1data[$re1rows]["jyusyo3"],"sjis","euc-jp"));?>&r=0&k="><?php 
...
?><br>
<?php 
if($re1data[$re1rows]["photo1"]!=NULL||$re1data[$re1rows]["photo2"]!=NULL||$re1data[$re1rows]["photo3"]!=NULL||$re1data[$re1rows]["photo4"]!=NULL||$re1data[$re1rows]["photo5"]!=NULL) {?><?php echo $Emoji["CAMERA"];;?> <a href="/keitai/b1/photo.php?bid=<?php echo $re1data[$re1rows]["id"];?>&madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>&page=<?php echo $page;?>">外観写真</a><br>
<?php 
}
?>
<?php 
if($re1data[$re1rows]["madorizu1"]!=NULL||file_exists($re1data[$re1rows]["madorizu2"])) {
?><?php echo $Emoji["MEMO"];;?> <a href="/keitai/b1/madoriimage.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>&madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>&page=<?php echo $page;?>">間取り図</a><br><?php 
}
?>
<hr>
<?php
...
地域：<a href="/keitai/b1/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php
