...
<div ><a href="topics.php"><img src="img/topics/1_1.jpg" width="25%" border="0" /></a><a href="topics_month.php"><img src="img/topics/1_2.jpg" width="25%" border="0" /></a><a href="topics_year.php"><img src="img/topics/1_3.jpg" width="25%" border="0" /></a><img src="img/topics/1_4.jpg" width="25%" /></div>




  <div align="center" style="margin:2% 0 1% 0;">
    <p><?php if($topicsbfdata["blog_id"]!=NULL){?><a href="/iphone2/topics_detail.php?blog_id=<?php echo $topicsbfdata["blog_id"];?>"><?php }?>&lt;&lt;  前<?php if($topicsbfdata["blog_id"]!=NULL){?></a><?php }?>　<a href="/iphone2/topics.php">一覧</a>　<?php if($topicsnxdata["blog_id"]!=NULL){?><a href="/iphone2/topics_detail.php?blog_id=<?php echo $topicsnxdata["blog_id"];?>"><?php }?>次 &gt;&gt;<?php if($topicsnxdata["blog_id"]!=NULL){?></a><?php }?></p>
  </div>
