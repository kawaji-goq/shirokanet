...
広さ：<a href="/keitai/c2/srch_madori.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php 
switch($madori) {
	case 1:
		echo "1R,K,DK,LDK";
		break;
...
価格：<a href="/keitai/c2/srch_cost.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php
...
地域：<a href="/keitai/c2/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php
if($chiiki!=NULL) {
...
?>
</a><a href="/keitai/c2/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"></a><br>
