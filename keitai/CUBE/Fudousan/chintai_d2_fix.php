                            ...
                            <table width="98%" border="0" cellpadding="10" cellspacing="1" bgcolor="#CCCCEE" class="bukkentable">
                                <tbody>
                                    ...
                                    <tr bgcolor="#ffffff">
                                        ...
                                        <td valign="top"><a href="http://www.mapfan.com/keywordsrch.cgiSRCHKIND=SRCH_ADR&amp;PARAM=%B4%E4%B9%F1%BB%D4%CB%E3%CE%A4%C9%DB%C4%AE5-%A3%B1%A1%DD%A3%B1%A3%B4" target="_blank"></a>
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><a href="#" onclick="window.open('./mapout_fix.php?name=<?php echo urlencode(mb_convert_encoding($re1data["bukken_mei"],"utf8","euc-jp"));?>&amp;address=<?php echo urlencode(mb_convert_encoding($re1data["todouhuken"].$re1data["jyusyo1"].$re1data["jyusyo2"],"utf8","euc-jp"));if($re1data["banchichk"]==1) {echo urlencode(mb_convert_encoding($re1data["jyusyo3"],"utf8","euc-jp"));}?>','maps','width=640,height=540')"><img src="/img_f/google_map.gif" width="174" height="20" border="0" /></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF" class="font12"><?php echo str_replace("小学校","",$re1data["syougakkouku"]);?></td>
                                    </tr>
                                    <?php
																}
																}
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF" class="font12"> <?php echo str_replace("中学校","",$re1data["chuugakouku"]);?></td>
                                    </tr>
                                    <?php
															}
																}
                                    ...
                                    <tr bgcolor="#ffffff">
                                        <th width="100" nowrap="nowrap" bgcolor="#ECECFF">
                                            <div align="left"><span class="st"><?php echo $bsetdata["madori_name"]?></span></div>
                                        </th>
                                    ...
                                    <?php
														...
														if($bukkensetdata["nodata_view"]==1||$re1data["chusya_ryoukin"]!=NULL) {
														?>
                                    <tr bgcolor="#ffffff">
                                        <th bgcolor="#ECECFF">
                                ...
                                <table width="98%" border="0" align="right" cellpadding="10" cellspacing="1" bgcolor="#CCCCEE" class="bukkentable">
                                    <tbody>
                                        ...
                                        <?php
														...
														if($bsetdata["reikin_view"]==1) {
															if($bukkensetdata["nodata_view"]==1||$re1data["reikin"]!=NULL) {
														?>
                                        <?php
																}
																}
                                        ...
                                        <?php
														...
														if($bsetdata["kyouekihi_view"]==1) {
														if($bukkensetdata["nodata_view"]==1||$re1data["kyouekihi_tsumitate"]!=NULL) {
														?>
                                        <?php
															}
																}
                                        ...
                                        <tr bgcolor="#ffffff">
                                            ...
                                            <td align="left" valign="top">
                                                <div align="left">
                                                    ...
                                                    <img src="/img/icon/park_car.jpg" alt="駐車場" width="38" height="38" />
                                                    <?php }?>
                    ...
                    <tr>
                        <td colspan="2" valign="top">
                            <?php
										...
										?>
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCEE">
                                <tbody>
                                    <tr bgcolor="#eec2bb">
