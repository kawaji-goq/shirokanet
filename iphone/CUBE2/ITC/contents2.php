...
class Site_Contents2 extends Ab_NormalPageType{
	function Site_Contents2($dbobj) {
		$this->dbobj=$dbobj;
		$this->bname="contents2";
	}
	
	function GetSelCateList($cate_id) {
		$list=$this->dbobj->GetList("select * from contents2_cate where parents_id = ".$cate_id);
		return $list;
	}
}

class Admin_Contents2 extends Ab_AdminBasicType{
	function Admin_Contents2($dbobj) {
		$this->dbobj=$dbobj;
		$this->bname="contents2";
	}
	function GetSelCateList($cate_id) {
	...
	function CopyData($id) {
		...
		$contents2subdatalist=$this->GetSubDataList($id);
		$origindata["data_id"]=$maxid;
		for($contents2subrow=0;$contents2subdatalist[$contents2subrow];$contents2subrow++){ 
			$origindata["sub_title"][$contents2subrow]=$contents2subdatalist[$contents2subrow]["data_name"];
			$origindata["sub_comm"][$contents2subrow]=$contents2subdatalist[$contents2subrow]["data_comm"];
			$origindata["sub_num"][$contents2subrow]=$contents2subdatalist[$contents2subrow]["data_id"];
		}
