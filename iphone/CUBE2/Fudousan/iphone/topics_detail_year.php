...
<div ><a href="topics.php"><img src="img/topics/3_1.jpg" width="25%" border="0" /></a><a href="topics_month.php"><img src="img/topics/3_2.jpg" width="25%" border="0" /></a><img src="img/topics/3_3.jpg" width="25%" border="0" /><img src="img/topics/3_4.jpg" width="25%" /></div>




  <div align="center" style="margin:2% 0 1% 0;">
    <p><?php if($topicsbfdata["blog_id"]!=NULL){?><a href="/iphone2/topics_detail_year.php?blog_id=<?php echo $topicsbfdata["blog_id"];?>"><?php }?>&lt;&lt;  前<?php if($topicsbfdata["blog_id"]!=NULL){?></a><?php }?>　<a href="/iphone2/topics_year_list.php?year=<?php echo $topicsdata["ryear"];?>&month=<?php echo $topicsdata["rmonth"];?>">一覧</a>　<?php if($topicsnxdata["blog_id"]!=NULL){?><a href="/iphone2/topics_detail_year.php?blog_id=<?php echo $topicsnxdata["blog_id"];?>"><?php }?>次 &gt;&gt;<?php if($topicsnxdata["blog_id"]!=NULL){?></a><?php }?></p>
  </div>
...
<div >
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="topics">
  <tr>
    <td>
      <h2 style="padding-left:10px;"><?php echo $topicsdata["title"];?></h2>
      <p class="copy" style="padding-left:10px;"><?php echo $topicsdata["ryear"];?>年<?php echo $topicsdata["rmonth"];?>月</p>
	  <p class="s" style="padding-left:10px;"><?php echo $topicsdata["comm"];?></p>
	  <p class="s" style="padding-left:10px;"><img src="<?php echo $topicsdata["image"];?>?<?php echo time();?>" alt="<?php echo strip_tags($topicsdata["title"]);?>" style="max-width:95%" /></p>
	</td>
  </tr>
</table>
  <div align="center" style="margin:2% 0 1% 0;">
