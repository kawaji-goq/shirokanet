...
<link rel="apple-touch-icon" href="http://cubes.jp/iphone/icon/icon.PNG">
...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="Reco" style="cursor:hand;">
	<tr>
		<td class="Reco_top"><strong>¤ª¤¹¤¹¤áÊª·ï</strong></td>
	</tr>
	<tr>
	  <td class="Reco_bottom"><table border="0" align="center" cellpadding="0" cellspacing="0" class="Reco" style="cursor:hand;">
        <?php
for($bi=0;$osusumedata[$bi]["id"]!=NULL && $bi < 8;$bi++)
{
?>
        <tr onClick="location.href='<?php if($osusumedata[$bi]["bunrui"]==1) {?>/iphone/chintai_d<?php echo syubetsuchk($osusumedata[$bi]["bunrui"],$osusumedata[$bi]["syumoku"]); ?>.php<?php echo "?bid=".$osusumedata[$bi]["id"]; ?><?php }else if($osusumedata[$bi]["bunrui"]==2){?>/iphone/baibai_d.php<?php echo "?bid=".$osusumedata[$bi]["id"]; }?>'" class="Reco" style="cursor:hand;">
          <td rowspan="4" align="center" class="Reco_middle_left" onClick="location='<?php if($osusumedata[$bi]["bunrui"]==1) {?>/iphone/chintai_d<?php echo syubetsuchk($osusumedata[$bi]["bunrui"],$osusumedata[$bi]["syumoku"]); ?>.php<?php echo "?bid=".$osusumedata[$bi]["id"]; ?><?php }else if($osusumedata[$bi]["bunrui"]==2){?>/iphone/baibai_d.php<?php echo "?bid=".$osusumedata[$bi]["id"]; }?>'" class="Reco" style="cursor:hand;"><?php
