...
?>
<title><?php echo $tenpodata["pagetitle"];?>/ÈÎÇäÊª·ï</title>
...
?>
	...
	<tr>
		<td class="Narrowing_middle_left">²Á³Ê</td>
		...
		<td colspan="5">
			<table border="0" cellpadding="0" cellspacing="0" align="center" class="Narrowing_submit">
				<tr>
					...
					<td align="center" class="Narrowing_bottom_right"><input type="submit" name="seach_bukken" id="seach_bukken"  value="¡¡¸¡º÷¡¡" class="link_red"/></td>
				</tr>
			</table>
		</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px;">
	<tr>
		<td height="30" bgcolor="#FFFFFF" style="padding-left:5px;"><font color="#FF6600">¡ü¸Í·ú¤Æ¡¦¥Þ¥ó¥·¥ç¥óÊª·ï°ìÍ÷  </font></td>
	</tr>
</table>
...
?>
						<br><br><input type="button" class="baibai_link" value="¾ÜºÙ">
					</td>
...
<?php
	...
	{
		echo "<strong><font color=#FF52C8>".number_format($re1data[$re1rows]["kakaku"],0)."Ëü±ß</font></strong>";
	}
	else
	{
		echo "-";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px;">
	<tr>
		<td height="30" bgcolor="#FFFFFF" style="padding-left:5px;"><font color="#FF6600">¡üÅÚÃÏÊª·ï°ìÍ÷ </font></td>
	</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" align="center" class="bukkenlist" style="margin-top:10px;">
	<tr>
