...
<div >
<a href="topics.php"><img src="img/topics/2_1.jpg" width="25%" border="0" /></a><img src="img/topics/2_2.jpg" width="25%" border="0" /><a href="topics_year.php"><img src="img/topics/2_3.jpg" width="25%" border="0" /></a><img src="img/topics/1_4.jpg" width="25%" /></div>

<?php
for($mi=0;$monthlist[$mi]["rmonth"]!=NULL;$mi++) {
?>
<div >
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="topics" onclick="location='/iphone2/topics_month_list.php?year=<?php echo $_GET["year"];?>&amp;month=<?php echo $monthlist[$mi]["rmonth"];?>'">
  <tr>
    <td>
      <h2 style="font-size:14px; padding-left:10px;">
<?php echo $_GET["year"] ?>年<?php echo $monthlist[$mi]["rmonth"] ?>月 (<?php
