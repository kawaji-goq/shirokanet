...
?>
<title>アイティーキューブ不動産/トピックス一覧</title>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="topics">
	...
	<tr>
		<td colspan="2" align="center" class="topics_body_img">
			<img src="<?php echo $topicsdata["../iphone_buck_up/image"];?>?<?php echo time();?>" alt="<?php echo strip_tags($topicsdata["title"]);?>" style="max-width:95%" />
		</td>
	</tr>
</table>
