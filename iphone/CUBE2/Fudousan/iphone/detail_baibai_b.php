...
<img src="<?php echo "/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo1"]; ?>" border="0" width="90%" /></a>
<?php
}
?>
	</td>
...
<img src="<?php echo "/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo2"]; ?>" border="0" width="90%" /></a>
<?php
}
...
<img src="<?php echo "/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo3"]; ?>" border="0" style="max-width:150px" width="90%" /></a>
<?php
}
...
<img src="<?php echo "/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo4"]; ?>" border="0" width="90%" /></a>
<?php
}
...
<img src="<?php echo "/tmp/bukken_data/".$re1data["id"]."/".$re1data["photo5"]; ?>" border="0" width="90%" /></a>
<?php
}
?>
	</td>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" id="table-01">
  <tr>
    <td width="30%" align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["menseki_name"] ?></td>
    <td width="70%" align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["menseki"]."m<sup>2</sup>　（約".number_format($re1data["menseki"]*0.3025,2)."坪）" ?></td>
  </tr>
<?php
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["shidoumenseki_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["shidoumenseki"]."m<sup>2</sup>" ?></td>
  </tr>
<?php
	}
}
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["kakaku_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1">
<?php
	if($re1data["kakaku"]!=NULL)
	{
		echo "<span class=font31>".number_format($re1data["kakaku"],0)."万円</span>";
	}
	else
	{
		echo "-";
...
?>	</td>
  ...
  <tr>
	...
	<?php if($re1data["ekiho"]!=NULL) {echo "・徒歩".$re1data["ekiho"]."分";} ?>	</td>
  </tr>
<?php
...
?>
<tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["youtochiiki_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["youtochiiki"]; ?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["chimoku_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["chimoku"];?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["kenpei_ritsu_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php if($re1data["kenpei_ritsu"]!=NULL) {echo $re1data["kenpei_ritsu"]."%";} ?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["youseki_ritsu_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php if($re1data["youseki_ritsu"]!=NULL) {echo $re1data["youseki_ritsu"]."%";} ?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["tochi_kenri_name"]; ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["tochi_kenri"];?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["toshikeikaku_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["toshikeikaku"];?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["chisei_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["chisei"]; ?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["kokudohou_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $re1data["kokudohou"]; ?></td>
  </tr>
<?php
	}
}
...
?>
  <tr>
    <td align="left" valign="top" <?php $x++; if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1"><?php echo $bsetdata["setsudou_name"] ?></td>
    <td align="left" valign="top" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; }  ?> class="s style1">
		<table cellspacing="0" cellpadding="0" <?php if($x % 2 == 0){ echo "bgcolor=\"#F0F9FD\""; } ?> style="border:0px none; border-collapse:inherit;">
<?php
	if($re1data["setsudou_joukyou"]!=NULL)
	{
?>
			<tr style="border-width:0px;">
				<td nowrap="nowrap" style="border-width:0px;">状況</td>
...
<?php
	...
	if(trim($setsudou1)!=NULL&&trim($setsudou1)!="m"&&trim($setsudou1)!="00.0m")
	{
?>
			<tr style="border-width:0px;">
				<td nowrap="nowrap" style="border-width:0px;">接道1:</td>
				<td style="border-width:0px;"> <?php echo $re1data["setsudou1"];?> </td>
			</tr>
<?php
	}
$setsudou2=str_replace(" ","",$re1data["setsudou2"]);
$setsudou2=str_replace("　","",$setsudou2);
if(trim($setsudou2)!=NULL&&trim($setsudou2)!="m"&&trim($setsudou2)!="00.0m")
{
?>
			<tr style="border-width:0px;">
				<td nowrap="nowrap" style="border-width:0px;">接道2:</td>
				<td style="border-width:0px;"> <?php echo $re1data["setsudou2"];?> </td>
			</tr>
<?php
}
$setsudou3=str_replace(" ","",$re1data["setsudou3"]);
$setsudou3=str_replace("　","",$setsudou3);
if(trim($setsudou3)!=NULL&&trim($setsudou3)!="m"&&trim($setsudou3)!="00.0m")
{
?>
			<tr style="border-width:0px;">
				<td nowrap="nowrap" style="border-width:0px;">接道3:</td>
				<td style="border-width:0px;"> <?php echo $re1data["setsudou3"];?> </td>
			</tr>
<?php
}
?>
