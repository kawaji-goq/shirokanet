...
?>
<?php echo $bsetdata["senyumenseki_name"] ?><br>
<?php
if($bsetdata["menseki_name"]==1)
{ 
	if($bukkensetdata["nodata_view"]==1||$re1data["menseki"]!=NULL)
	{
		echo $bsetdata["menseki_name"]."<br>";
	}
}		
?>
<?php
if($bsetdata["shidoumenseki_view"]==1)
{
	...
	{
		echo $bsetdata["shidoumenseki_name"];
	}
}		
?>	</td>
...
{ 
	if($bukkensetdata["nodata_view"]==1||$re1data["menseki"]!=NULL)
	{
		if($re1data["menseki"]!=NULL)
		{
			echo $re1data["menseki"]."m<sup>2</sup>　（約".number_format($re1data["menseki"]*0.3025,2)."坪）"."<br>";
		}
	}
}		
?>
...
if($bsetdata["shidoumenseki_view"]==1)
{
	if($bukkensetdata["nodata_view"]==1||$re1data["shidoumenseki"]!=NULL)
	{
		if($re1data["shidoumenseki"]!=NULL)
		{
			echo $re1data["shidoumenseki"]."m<sup>2</sup>";
		}
	}
}		
?>	</td>
