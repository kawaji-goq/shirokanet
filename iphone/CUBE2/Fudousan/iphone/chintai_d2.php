...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="Searchtype" style="margin-top:10px;">
	<tr>
		<td colspan="3" class="Searchtype_top">
			<img src="../iphone_buck_up/img/BukkenSearchCategoryHeader.jpg" width="100%" border="0">
		</td>
	</tr>
	<tr>
		<td colspan="3" class="Searchtype_head">
			<img src="../iphone_buck_up/img/rent.jpg" width="100%" border="0">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3" class="Searchtype_head">
			<img src="../iphone_buck_up/img/buy.jpg" width="100%" border="0">
		</td>
	</tr>
	<tr>
...
<form id="form1" name="form1" method="post" action="">
	<tr>
		<td colspan="5" class="Narrowing_top">
			<img src="../iphone_buck_up/img/BukkenSearchHeader.jpg" width="100%" border="0">
		</td>
	</tr>
	<tr>
...
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["photo1"])."?".time();; ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["photo1"]; ?>" border="0" style="max-width:150px" />
</a>
<?php
}
...
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["photo2"])."?".time();; ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["photo2"]; ?>" border="0" style="max-width:150px" />
</a>
<?php
}
...
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["photo3"])."?".time();; ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["photo3"]; ?>" border="0" style="max-width:150px" />
</a>
<?php
}
...
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["photo4"])."?".time();; ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["photo4"]; ?>" border="0" style="max-width:150px" />
</a>
<?php
}
...
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["photo5"])."?".time();; ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["photo5"]; ?>" border="0" style="max-width:150px" />
</a>
<?php
}
?>
...
{
?>
			<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/img/noimage_300_300.gif"; ?>" border="0" style="max-width:150px" />
<?php
}
if($re1data["madorizu1"]!=NULL)
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["madorizu1"])."?".time(); ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["madorizu1"]."?".time(); ?>" border="0" style="max-width:150px" /></a>
<?php
}
if($re1data["madorizu2"]!=NULL)
{
?>
<a href="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".str_replace("300","",$re1data["madorizu2"])."?".time(); ?>" rel="lightbox">
<img src="<?php echo "file:///G|/顧客別/か行/GOQ/不動産/tmp/bukken_data".$re1data["id"]."/".$re1data["madorizu2"]."?".time(); ?>" border="0" style="max-width:150px" /></a>
<?php
}
?>
		</td>
...
{
	if($bukkensetdata["nodata_view"]==1||$re1data["hosyoukin_kakaku"]!=NULL)
	{
?>
	<tr>
		<td class="bukkendata_middle_left">
