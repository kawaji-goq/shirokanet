...
?>
<div >
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="topics" onClick="location='/iphone2/topics_detail_year.php?blog_id=<?php echo $newblogdata[$bi]["blog_id"]; ?>'" style="cursor:hand;">
  <tr>
    <td>
