                                        ...
                                        <td valign="top"><a href="http://www.mapfan.com/keywordsrch.cgiSRCHKIND=SRCH_ADR&amp;PARAM=%B4%E4%B9%F1%BB%D4%CB%E3%CE%A4%C9%DB%C4%AE5-%A3%B1%A1%DD%A3%B1%A3%B4" target="_blank"></a>
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><a href="#" onclick="window.open('./mapout.php?name=<?php echo urlencode(mb_convert_encoding($re1data["bukken_mei"],"utf8","euc-jp"));?>&amp;address=<?php echo urlencode(mb_convert_encoding($re1data["jyusyo1"].$re1data["jyusyo2"],"utf8","euc-jp"));if($re1data["banchichk"]==1) {echo urlencode(mb_convert_encoding($re1data["jyusyo3"],"utf8","euc-jp"));}?>','maps','width=640,height=540')"><img src="/img_f/google_map.gif" width="174" height="20" border="0" /></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        </td>
