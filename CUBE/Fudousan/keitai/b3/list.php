...
if($_GET['article_turn']!=NULL) {
	$_REQUEST['article_turn']=$_GET['article_turn'];
}
...
$_REQUEST["lim"]=5;
$re1obj->type=6;
$re1data=$re1obj->GetReList(2,$_REQUEST["sort"]);
$maxpage=ceil(($re1obj->numrows)/$_REQUEST["lim"]);
?>
...
価格：<a href="/keitai/b3/srch_cost.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php
...
地域：<a href="/keitai/b3/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"><?php
if($chiiki!=NULL) {
...
?>
</a><a href="/keitai/b3/srch_chiki.php?madori=<?php echo $madori;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>"></a><br>
