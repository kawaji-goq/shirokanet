...
?>Ê^<br>
<?php
//echo $_SERVER['DOCUMENT_ROOT']."tmp/bukken_data/".$re1data["id"]."/".$re1data["photo1"]; 
...
?>
<br>
<a href="/keitai/c1/list.php?madorinum=<?php echo $madorinum;?>&madoritype=<?php echo $madoritype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>&page=<?php echo $page;?>">–ß‚é</a>
</body>
</html>
