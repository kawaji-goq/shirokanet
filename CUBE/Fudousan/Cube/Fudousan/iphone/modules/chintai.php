...
?>
<title><?php echo $tenpodata["pagetitle"];?>/ÄÂÂßÊª·ï</title>
...
{
?>
			<table border="0" cellpadding="0" cellspacing="0" align="center" class="bukkenlist_on" onClick="location='/iphone/chintai_d.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>'">
				<tr>
...
?>
						<br><br><input type="button" class="chintai_link" value="¾ÜºÙ">
					</td>
...
{
?>
				<a href="?cid=<?php echo $_SESSION["cid"];?>&amp;page=<?php echo $_SESSION["page"]-1;?>">¡ã Á°</a>
<?php
}
?>
			</div>
...
?>
		...
		<td nowrap="nowrap">
			<div align="left">
				...
				<a href="?cid=<?php echo $_SESSION["cid"];?>&amp;page=<?php echo $_SESSION["page"]+1;?>">¼¡ ¡ä</a>
				<?php } ?>
			</div>
	  </td>
	</tr>
...
{
?>
			<table border="0" cellpadding="0" cellspacing="0" align="center" class="bukkenlist_on" <?php if($re1rows==0){?>style="margin-top:5px;"<?php }?> onClick="location='/iphone/chintai_d2.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>'">
				<tr>
					<td rowspan="7" width="40%" class="bukkenlist_img"<?php if($re1rows==0){?> style="-webkit-border-top-left-radius: 3px;"<?php } ?>>
<?php
	if(@file_exists("../tmp/bukken_data/".$re1data[$re1rows]["id"]."/".$re1data[$re1rows]["photo1"])&&$re1data[$re1rows]["photo1"]!=NULL)
...
{
?>
				<a href="?cid=<?php echo $_SESSION["cid"];?>&amp;page=<?php echo $_SESSION["page"]-1;?>">¡ã Á°¤Î10·ï</a>
<?php
}
?>
			</div>
...
?>
		...
		<td width="100" nowrap="nowrap">
			<div align="left">
				<?php if($maxpage!=$_SESSION["page"]&&$maxpage>1) {?>
				<a href="?cid=<?php echo $_SESSION["cid"];?>&amp;page=<?php echo $_SESSION["page"]+1;?>">¼¡¤Î10·ï ¡ä</a>
				<?php } ?>
			</div>
		</td>
	</tr>
...
{
?>
			<table border="0" cellpadding="0" cellspacing="0" align="center" class="bukkenlist_on" <?php if($re1rows==0){?>style="margin-top:5px;"<?php }?> onClick="location='/iphone/chintai_d3.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>'">
				<tr>
					<td rowspan="7" width="40%" class="bukkenlist_img"<?php if($re1rows==0){?> style="-webkit-border-top-left-radius: 3px;"<?php } ?>>
<?php
	if(@file_exists("../tmp/bukken_data/".$re1data[$re1rows]["id"]."/".$re1data[$re1rows]["photo1"])&&$re1data[$re1rows]["photo1"]!=NULL)
