...
?><br>
<a href="/keitai/b1/list.php?madorizunum=<?php echo $madorizunum;?>&madorizutype=<?php echo $madorizutype;?>&lowcost=<?php echo $lowcost;?>&hicost=<?php echo $hicost;?>&chiiki=<?php echo $chiiki;?>&page=<?php echo $page;?>">戻る</a>
</body>
</html>
