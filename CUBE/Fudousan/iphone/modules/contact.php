...
function Normal($pdata,$tenpodata) {
    ...
    $ctxt= "以下の内容でお問い合わせを送信しました。\n".
            ...
            $tenpodata["name"]." \n".
            $tenpodata["jyusyo"]."\n".
            " TEL ".str_replace(" 　物件に対するお問い合わせにはお答えできませんのでご了承ください。","",$tenpodata["denwa"])."　FAX ".$tenpodata["fax"]."\n".
            " E-mail ".str_replace(" 物件に対するお問い合わせにはお答えできませんのでご了承ください。","",$tenpodata["email"])."\n".
            " H.P ".$tenpodata["url"]."\n".
            "---------------------------------------\n".
...
//	mb_send_mail(str_replace(" 当サイトに掲載されている物件はサンプルです。　物件に対するお問い合わせにはお答えできませんのでご了承ください。","",$tenpodata["email"]),$msbj,$mtxt,"From:".$_POST["email"]."\n");
            ...
            $csbj=mb_convert_kana($csbj,"KV");
    $ctxt=mb_convert_kana($text,"KV");
    $msbj=mb_convert_kana($msbj,"KV");
    $mtxt=mb_convert_kana($text,"KV");
