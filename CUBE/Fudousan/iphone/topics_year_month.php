...
?>
<div >
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="topics" onclick="location='/iphone2/topics_year_list.php?year=<?php echo $_GET["year"];?>&amp;month=<?php echo $monthlist[$mi]["rmonth"];?>'">
  <tr>
    <td>
