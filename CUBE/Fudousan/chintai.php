...
<?php
}?><title><?php echo $tenpodata["pagetitle"];?> / ʪ���ڤ��</title>
		  ...
		  <td align="left" valign="top">
            ...
            <tr>
                ...
                <td width="286" bgcolor="#FAFBFC">
                    <p><a href="chintai.php?cid=1">�����ѡ��ȡ��ޥ󥷥��</a>��<a href="chintai.php?cid=2">���ͷ���</a>��<a href="chintai.php?cid=3">��������</a></p>
                </td>
                <td width="86" bgcolor="#FAFBFC"><img src="img/bukken/BukkenSearchCategoryBuy.jpg" width="86" height="25" /></td>
                <td width="294" bgcolor="#FAFBFC"><a href="baibai.php?cid=4">���ͷ��ơ��ޥ󥷥��</a>��<a href="baibai.php?cid=6">��������ʪ��</a>��<a href="baibai.php?cid=5">������</a></td>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <select id="madori" name="madori">
                                                          <option value="1"<?php if($_SESSION["madori"]==1){echo " selected";}?>>1��,��,�ģ�,�̣ģ�</option>
                                                          <option value="2"<?php if($_SESSION["madori"]==2){echo " selected";}?>>2��,�ģ�,�̣ģ�</option>
                                                          <option value="3"<?php if($_SESSION["madori"]==3){echo " selected";}?>>3�ģ�,�̣ģ�</option>
                                                          <option value="4"<?php if($_SESSION["madori"]==4){echo " selected";}?>>4�ģ˰ʾ�</option>
                                                          <option value="0"<?php if($_SESSION["madori"]==0){echo " selected";}?>>����̵��</option>
                                                      </select>
                                                  </td>
												...
												?>
                                                          <option value=""<?php if($_SESSION["chiiki"]==""){echo " selected";}?>>����̵��</option>
                                                      </select>
                                                  </td>
            ...
            <table width="768"  border="0" align="center" cellpadding="0" cellspacing="0" class="font12">
                ...
                <tr>
                    <td width="184" height="30" bgcolor="#FFFFFF"><font color="#FF6600">�����ѡ��ȡ��ޥ󥷥��ʪ����� </font></td>
                            ...
                            <tr>
                                <td width="100" nowrap="nowrap">
                                    <div align="right">
                                        ...
                                        <a href="?cid=<?php echo $_SESSION["cid"];?>&amp;page=<?php echo $_SESSION["page"]-1;?>">&lt;&lt;������10�� </a>
                                        <?php }?>
                                    </div>
                                </td>
                                <td>
...
?>
                    ...
                    <td rowspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><span class="st">
                        ...
                        <?php if($re1data[$re1rows]["senyumenseki"]!=NULL) {echo $re1data[$re1rows]["senyumenseki"]."m<sup>2</sup><br />����".number_format($re1data[$re1rows]["senyumenseki"]*0.3025,2)."�ڡ�";}else{ echo "-";}?>
                    </td>
                    ...
                    <td colspan="3" bgcolor="#FFFFFF" class="font12">
                        <div align="center"><?php if($re1data[$re1rows]["eki"]!=NULL) {echo $re1data[$re1rows]["eki"]."��";} ?>
                            <?php if($re1data[$re1rows]["ensen"]!=NULL) {echo "(".$re1data[$re1rows]["ensen"].")";} ?>
                            <?php if($re1data[$re1rows]["ekiho"]!=NULL) {echo "������".$re1data[$re1rows]["ekiho"]."ʬ";} ?>
                        </div>
                    </td>
                    <td rowspan="2" align="center" bgcolor="#FFFFFF">
                        <div align="center">
                            <div align="center"><a href="chintai_d.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>" >�ܺ�</a></div>
                ...
                <tr>
                        ...
                        <div align="center">
                            <table width="75%" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <div align="right">
                                            <?php if($re1data[$re1rows]["kakaku"]!=NULL) {echo "<span class=\"list_price\">".numberformat($re1data[$re1rows]["kakaku"])."</span><span class=\"list_price_tani\">����</span>"; }else {echo "-";}?><br />
                                            <?php 
																				if($re1data[$re1rows]["kanrihi"]!=NULL) {
																				?>
                                            <?php echo numberformat($re1data[$re1rows]["kanrihi"]); ?>��
                                            <?php 
																								}
																								else {
																								echo "-";
                    ...
                    <td align="center" bgcolor="#FFFFFF" class="font12">
                        <?php if($re1data[$re1rows]["reikin"]!=NULL){echo $re1data[$re1rows]["reikin"]."���� ";} ?>
                        <?php 
																																		if($re1data[$re1rows]["reikin_tani"]!=NULL){
																																		echo $re1data[$re1rows]["reikin_tani"]."����";
																																		}
																																		?>
                        <br />
                        <?php 
																																		if($re1data[$re1rows]["shikikin"]!=NULL){
																																			echo $re1data[$re1rows]["shikikin"]."���� ";
																																			}
																																			 ?>
                        <?php 
																																		if($re1data[$re1rows]["sikikintani"]!=NULL){
																																			echo $re1data[$re1rows]["sikikintani"]."����";
																																		}?>
                    </td>
                    <td align="center" bgcolor="#FFFFFF" class="font12">
                    ...
                    <td align="center" bgcolor="#FFFFFF" class="font12">
                                                <?php 
																																								if($re1data[$re1rows]["chiku_nen"]!=NULL){ 
																																									echo $re1data[$re1rows]["chiku_nen"]."ǯ";
																																								}
																																									if($re1data[$re1rows]["chiku_tsuki"]!=NULL){ 
																																									echo $re1data[$re1rows]["chiku_tsuki"]."��";
																																								} ?> 
                    </td>
                </tr>
                <?php 
...
<table width="818" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td align="left" valign="top">
            ...
            <table width="768"  border="0" align="center" cellpadding="0" cellspacing="0" class="font12">
                <tr>
                    <td width="184" height="30" bgcolor="#FFFFFF"><font color="#FF6600">���ͷ���ʪ����� </font></td>
                    <td width="400" bgcolor="#FFFFFF">
                        <div align="center"></div>
                    </td>
                    <td width="184" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
                    ...
                    <td rowspan="2" align="center" bgcolor="#FFFFFF">
                        <div align="center">
                            <div align="center"><a href="chintai_d2.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>" >�ܺ�</a></div>
                            <a href="chintai_d.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>" ></a></div>
                        <a href="baibai_d.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>"></a></td>
                </tr>
                <tr>
                        ...
                        <div align="center">
                            <table width="75%" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <div align="right">
                                            <?php if($re1data[$re1rows]["kakaku"]!=NULL) {echo "<span class=\"list_price\">".$re1data[$re1rows]["kakaku"]."</span><span class=\"list_price_tani\">����</span>"; }else {echo "-";}?>
                                            <br />
                                            <?php 
																				if($re1data[$re1rows]["kanrihi"]!=NULL) {
																				?>
                                            <?php echo number_format($re1data[$re1rows]["kanrihi"]); ?>��
                                            <?php 
																								}
																								else {
																								echo "-";
...
<table width="818" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td align="left" valign="top">
            ...
            <table width="768"  border="0" align="center" cellpadding="0" cellspacing="0" class="font12">
                <tr>
                    <td width="184" height="30" bgcolor="#FFFFFF"><font color="#FF6600">��������ʪ����� </font></td>
                    <td width="400" bgcolor="#FFFFFF">
                        <div align="center"></div>
                    </td>
                    <td width="184" bgcolor="#FFFFFF">&nbsp;</td>
...
?>
                    ...
                    <td rowspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="st"><span class="st">
                        <?php if($re1data[$re1rows]["senyumenseki"]!=NULL) {echo $re1data[$re1rows]["senyumenseki"]."m<sup>2</sup><br />����".number_format($re1data[$re1rows]["senyumenseki"]*0.3025,2)."�ڡ�";}else{ echo "-";}?></span>
                    </td>
                    <td width="23%" align="left" bgcolor="#FFFFFF" class="font12"><?php echo $re1data[$re1rows]["jyusyo1"].$re1data[$re1rows]["jyusyo2"];if($re1data[$re1rows]["banchichk"]==1) {echo $re1data[$re1rows]["jyusyo3"];} ?></td>
                    <td colspan="3" bgcolor="#FFFFFF" class="font12">
                        <div align="center"><?php if($re1data[$re1rows]["eki"]!=NULL) {echo $re1data[$re1rows]["eki"]."��";} ?>
                    ...
                    <td rowspan="2" align="center" bgcolor="#FFFFFF">
                        <div align="center">
                            <div align="center"><a href="chintai_d3.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>">�ܺ�</a></div>
                            <a href="chintai_d.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>" ></a></div>
                        <a href="baibai_d.php?bid=<?php echo $re1data[$re1rows]["id"]; ?>"></a></td>
                </tr>
                <tr>
