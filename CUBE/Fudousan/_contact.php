...
<meta http-equiv="Content-Type" content="text/html; charset=euc-jp" />
<meta name="keywords" content="<?php echo $tenpodata["keyword"];?>">
<meta name="description" content="<?php echo $tenpodata["description"];?> ">
<style>
td {
	font-size:12px;
}
...
<table width="818" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td width="25" rowspan="2" background="http://cubes.jp/img/template/TemplateLeft.jpg">
            <div align="left"></div>
        </td>
        ...
        <td width="69"><img src="http://cubes.jp/img/template/HeaderLinkToMobile.jpg" width="69" height="71"></td>
        <td width="75"><img src="http://siteadmin.itcube.ne.jp/qrcode/index.php?qrdata=http://<?php echo $_SERVER['HTTP_HOST']; ?>" width="75" height="71"></td>
        <td width="4"><img src="http://cubes.jp/img/template/2_r1_c17.jpg" width="4" height="71"></td>
        <td width="25" background="http://cubes.jp/img/template/TemplateRight.jpg">
            <div align="right"></div>
        </td>
    </tr>
    <tr>
        <td colspan="4">
            <table width="768" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="110"><a href="/contact.php"><img src="http://cubes.jp/img/template/HeaderMenuContact.jpg" width="110" height="34" border="0"></a></td>
                </tr>
            </table>
        </td>
