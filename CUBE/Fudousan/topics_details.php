...
$_REQUEST["blog_id"]=intval($_REQUEST["blog_id"]);
if($_GET["blog_id"]!=NULL) {
	$topicsdata=$dbobj->GetData("select * from blog_data where blog_id= ".pg_escape_string($_GET["blog_id"])." and view_chk = 1");
...
$topicsnxdata=$dbobj->GetData("select * from blog_data where blog_id > ".pg_escape_string($_GET["blog_id"])." and view_chk = 1  order by blog_id");
$topicsbfdata=$dbobj->GetData("select * from blog_data where blog_id < ".pg_escape_string($_GET["blog_id"])." and view_chk = 1  order by rdate desc, blog_id desc");
...
<?php
}?><title><?php echo $tenpodata["pagetitle"];?> / News ¥È¥Ô¥Ã¥¯¥¹ <?php echo $topicsdata["title"];?></title>
                                    ...
                                    <table width="511" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <table width="511" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td><span class="yearmonth"><?php echo $topicsdata["ryear"];?>Ç¯<?php echo $topicsdata["rmonth"];?>·î </span></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td colspan="2"><img src="img/topics/TopicsLine.jpg" width="507" height="13" /></td>
                                                        </tr>
                                                    <tr>
                                                        <td><span class="date"><?php echo str_replace("-","/",$topicsdata["rdate"]);?></span> ¡¡¡¡</td>
                                                        <td class="navi">
                                                            <div align="right"><?php if($topicsbfdata["blog_id"]!=NULL){?><a href="topics_details.php?blog_id=<?php echo $topicsbfdata["blog_id"];?>"><?php }?>&lt;&lt;  Á°<?php if($topicsbfdata["blog_id"]!=NULL){?></a><?php }?>¡¡<a href="topics.php">°ìÍ÷</a>¡¡<?php if($topicsnxdata["blog_id"]!=NULL){?><a href="topics_details.php?blog_id=<?php echo $topicsnxdata["blog_id"];?>"><?php }?>¼¡ &gt;&gt;<?php if($topicsnxdata["blog_id"]!=NULL){?></a><?php }?></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td height="300" valign="top" class="text"><span><?php echo $topicsdata["comm"];?>
                                                        <?php if($topicsdata["image"]!=NULL) {?>
                                                        <br />
                                                        <br /><div align="center">
                                                        <img src="<?php echo $topicsdata["image"];?>?<?php echo time();?>" alt="<?php echo strip_tags($topicsdata["title"]);?>" /></div><br />
                                                        <?php }?>
                                            </span><br />
                                            </td>
                                        </tr>
