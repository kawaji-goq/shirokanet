                                                ...
                                                <td height="25">
                                                    <?php 
																																															if($osusumedata[$i]["banchichk"]){
																																																$jyusyo[$i]=mb_convert_kana($osusumedata[$i]["jyusyo1"].$osusumedata[$i]["jyusyo2"].$osusumedata[$i]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i]=mb_convert_kana($osusumedata[$i]["jyusyo1"].$osusumedata[$i]["jyusyo2"],"K");
																																																}
                                                ...
                                                <td height="25">
                                                    <?php 
																																																if($osusumedata[$i+1]["banchichk"]){
																																																				$jyusyo[$i+1]=mb_convert_kana($osusumedata[$i+1]["jyusyo1"].$osusumedata[$i+1]["jyusyo2"].$osusumedata[$i+1]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i+1]=mb_convert_kana($osusumedata[$i+1]["jyusyo1"].$osusumedata[$i+1]["jyusyo2"],"K");
																																																}
                                                ...
                                                <td height="25">
                                                    <?php 
																																																if($osusumedata[$i+2]["banchichk"]){
																																																				$jyusyo[$i+2]=mb_convert_kana($osusumedata[$i+2]["jyusyo1"].$osusumedata[$i+2]["jyusyo2"].$osusumedata[$i+2]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i+2]=mb_convert_kana($osusumedata[$i+2]["jyusyo1"].$osusumedata[$i+2]["jyusyo2"],"K");
																																																}
                                                ...
                                                <td height="25">
                                                    <?php 
																																																if($osusumedata[$i+3]["banchichk"]){
																																																				$jyusyo[$i+3]=mb_convert_kana($osusumedata[$i+3]["jyusyo1"].$osusumedata[$i+3]["jyusyo2"].$osusumedata[$i+3]["jyusyo3"],"K");
																																																}
																																																else {
																																																				$jyusyo[$i+3]=mb_convert_kana($osusumedata[$i+3]["jyusyo1"].$osusumedata[$i+3]["jyusyo2"],"K");
																																																}
