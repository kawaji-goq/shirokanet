...
if($_POST["mode"]=="update") {
	...
	$insql="update direct_mail set ".
			"dm_target='".$_SESSION["dm"]["dm_target"]."',".
			...
			for($memi=0;$memlist[$memi]["id"]!=NULL;$memi++) {
				if($_SESSION["dm"]["dm_target"]==$memlist[$memi]["mail_type"]||$_SESSION["dm"]["dm_target"]=="pk") {
					...
					switch($memlist[$memi]["mail_type"]) {
					 ...
					 $insql="insert into mail_queue values(".$maxid2.",".$_POST["sendtime"].",'".$_SESSION["dm"]["raddress"]."','".$memlist[$memi]["email"]."','".$sbj."','".$txt.$coupon."','".$_SESSION["DomainData"]["dbname"]."',".$_REQUEST["dm_id"].")";
...
<table width="740" border="0" align="left" cellpadding="0" cellspacing="0"> 
											...
											<tr>
													...
													<td>
															<table width="100%"  border="0" cellspacing="0" cellpadding="5">
																	<tr>
																			<td class="font10"> <strong>メール配信変更</strong> </td>
																	</tr>
															</table>
													</td>
											</tr>
 ...
 <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><?php echo $hour;?>：<?php echo $minite;?>
            				<input name="sendtime" type="hidden" id="sendtime" value="<?php echo $_GET["sendtime"];?>">
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF">
              ...
              <input type="button" name="Submit" value="戻る" onclick="location.href='?PID=promo_dm_up&mode=step1&dm_id=<?php echo $_REQUEST["dm_id"];?>';" />
...
<form name="update_form" method="post" action="" onsubmit="datachk();"> 
          <tr>
            <td width="150" valign="top" bgcolor="#EBEBEB">対象メールアドレス</td>
            <td bgcolor="#FFFFFF">
