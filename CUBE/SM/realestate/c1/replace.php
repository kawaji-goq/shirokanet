                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p><font color="#000000">賃貸アパート・</font><font color="#000000">マンション物件修正 </font> </p>
                              </td>
                          </tr>
                      </table>
                  </td>
					...
					?>
										<tr>
												...
												<td width="562" bgcolor="#FFFFFF" class="font12">
														<input name="bukkenn_id" type="text" value="<?php echo $re1data["bukkenn_id"];?>">
												</td>
										</tr>
										<?php 
										}
	...
	<?php 
					...
					?><tr>
												<td width="150" align="right" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14">
																<div align="right"><?php echo $bsetdata["shikikin_name"] ?><!--敷金 --></div>
														</div>
												</td>
...
<?php 
					...
					?><tr>
												<td width="150" align="right" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14">
																<div align="right"><?php echo $bsetdata["reikin_name"] ?><!--礼金 --></div>
														</div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"> <span class="realestate_bgcolor3">
	...
	<?php 
					...
					?>										<tr>
												<td align="right" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["kanrihi_name"] ?><!--管理費 --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"><span class="realestate_bgcolor3">
...
<?php 
	...
	<?php 
					...
					?><tr>
												<td align="right" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["kyouekihi_name"] ?><!--共益費 --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"><span class="realestate_bgcolor3">
...
<?php 
	...
	<?php 
					...
					?><tr>
												<td align="right" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["syuzenhi_tsumitate_name"] ?><!--修繕積立金 --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
	...
	<?php 
					...
					?><tr>
												<td align="right" valign="top" bgcolor="#EBEBEB" class="font14"> 
														<div align="right"><?php echo $bsetdata["zappi_name"] ?><!--その他利用料 --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
					...
					?><tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["hosyoukin_name"] ?><!--保証金 --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"><span class="realestate_bgcolor3">
...
<?php 
	...
	<?php 
					...
					?>										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14"><?php echo $bsetdata["senyumenseki_name"] ?><!--面積 --> </div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
	...
	<?php 
					...
					?><tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14"><?php echo $bsetdata["madori_name"] ?><!--間取り --> </div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
	...
	<?php 
					...
					?><tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14"><?php echo $bsetdata["madori_syousai_name"] ?><!--間取り詳細 --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
					...
					?><tr>
												...
												<td bgcolor="#FFFFFF" class="font12">
														...
														<label for="setsubi_soto2">駐車場2台以上可</label>														<br />
