		...
		<tr>
				<td>
						<TABLE width="700"  border="0" align="left" cellpadding="5" cellspacing="0" class="realestate_bgcolor1">
								<TR class="realestate_bgcolor2">
										<TD colspan="2" valign="top" bgcolor="#ECECFF"><font color="#000000"><a href="?PID=re_c1_set">賃貸アパート・マンション</a>　<font color="#333333"><a href="?PID=re_c2_set">賃貸戸建て</a></font>　<font color="#333333"><a href="?PID=re_c3_set">賃貸事業用</a></font>　<strong><font color="#333333">売買マンション・戸建て</font></strong>　<a href="?PID=re_b2_set">売買土地</a>　<a href="?PID=re_b3_set">売買事業用</a></font></TD>
								</TR>
								<form action="" method="post" enctype="multipart/form-data" name="bukken_form">
										<TR class="realestate_bgcolor2">
												<TD align="center" valign="top">
														<table cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="syougakkouku_admin" type="checkbox" id="syougakkouku_admin" value="1"<?php if($bsetdata["syougakkouku_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="shinchiku_view" type="hidden" id="shinchiku_view" value="1">
																		  </div>
																		</td>
																</tr>
																<tr>
