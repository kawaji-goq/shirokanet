...
m </td>
       ...
       <?php 
					...
					?>			<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14"><?php echo $bsetdata["chiku_nen_name"] ?><!--築年月 --></div>												</td>
...
<?php 
					...
					?>											
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12"><span class="realestate_bgcolor3">
														<input name="kanrihi" type="text" class="noime" id="kanrihi" value="<?php echo $re1data["kenrikin"];?>" size="20" />
円 </span></td>
										</tr>
<?php 
					}
