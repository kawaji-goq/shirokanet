...
//set images
if($data["photo1"]!=NULL) {
	$pdf->Image("http://".$_REQUEST["domain"]."/tmp/bukken_data/".$data["id"]."/".$data["photo1"],10,25);
}

if($data["photo2"]!=NULL) {
	$pdf->Image("http://".$_REQUEST["domain"]."/tmp/bukken_data/".$data["id"]."/".$data["photo2"],10,110);
}
