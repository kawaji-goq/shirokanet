...
if($_REQUEST["update_re"]=="¹¹¿·¤¹¤ë"||$_REQUEST["update_re"]=="¹¹¿·¤·¤Æ°ìÍ÷¤ØÌá¤ë") {
	...
	$upsql=	"update bukken set ".
					...
					"syougakkouku='".$_REQUEST["syougakkouku"]."¾®³Ø¹»',".
					"chuugakouku='".$_REQUEST["chuugakouku"]."Ãæ³Ø¹»',".
...
//					"syouhizei_kubun='".$_REQUEST["syouhizei_kubun"]."',".
	...
	if($imagefile2["filepath"]!=NULL||$_REQUEST["delimage2"]==1){
		...
		if($_SERVER['HTTP_HOST']=="siteadmin.itcube.ne.jp"){
				...
				$ftp->UpData("tmp/".$bname."_data/".$_REQUEST["bid"]."/","pop1".$imagefile2["name"],$_SERVER['DOCUMENT_ROOT']."/tmp/".$bname."_data/".$_REQUEST["bid"]."/pop1".$imagefile2["name"],"b");
				}
...
<TABLE width="700"  border="0" align="left" cellpadding="0" cellspacing="0" class="realestate_bgcolor1">
		...
		<TR class="realestate_bgcolor2">
		    <TD valign="top"><div class="helper">ÇäÇãÅÚÃÏÊª·ï¤ËÉ½¼¨¤¹¤ë¹àÌÜ¤òÀßÄê¤¹¤ë¤Ë¤Ï<a href="?PID=re_b2_set">¤³¤Á¤é¤ò¥¯¥ê¥Ã¥¯</a>¤·¤Æ¤¯¤À¤µ¤¤¡£
		            <br>
...
<?php 
					...
					?><tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14"><!--ÄÂÎÁ --><?php echo $bsetdata["kakaku_name"] ?></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
m </td>
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF" class="font12">
                     ºÇ´ó±Ø¤«¤é¾è¼Ö<input name="kuruma" type="text" class="noime" id="kuruma" value="<?php echo $re1data["kuruma"];?>" size="6" />
                    Ê¬</td>
										</tr>
									<?php 
					}
	...
	<?php 
            ...
            <tr>
                <td bgcolor="#FFFFFF" class="font12">
                    <input name="syougakkouku" type="text" id="syougakkouku" value="<?php echo str_replace("¾®³Ø¹»","",$re1data["syougakkouku"]);?>" size="12" />
                    ¾®³Ø¹» </td>
            </tr>
            <?php 
					}
            ...
            <tr>
                <td bgcolor="#FFFFFF" class="font12">
                    <input name="chuugakouku" type="text" id="chuugakouku" value="<?php echo str_replace("Ãæ³Ø¹»","",$re1data["chuugakouku"]);?>" size="12" />
                    Ãæ³Ø¹»</td>
										</tr>
<?php 
					}
...
<?php 
					...
					?>										
											<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["kenrikin_name"] ?><!--¸¢Íø¶â --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
					...
					?><tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14"><?php echo $bsetdata["tsubotanka_name"] ?><!--ÄÚÃ±²Á --> </div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"> 
...
?>										<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["kenpei_ritsu_name"] ?><!--·úÊÃÎ¨ --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
?>										<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["youseki_ritsu_name"] ?><!--ÍÆÀÑÎ¨ --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["shidoumenseki_name"] ?><!--»äÆ»ÌÌÀÑ --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
?>										<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["toshikeikaku_name"] ?><!--ÅÔ»Ô·×²è --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
?>										<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["youtochiiki_name"] ?><!--ÍÑÅÓÃÏ°è --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["chimoku_name"] ?><!--ÃÏÌÜ --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
?>	
										<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["chisei_name"] ?><!--ÃÏÀª --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
					...
					?>          <tr> 
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["tochi_kenri_name"] ?><!--ÅÚÃÏ¸¢Íø --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
					...
					?>									
<tr>
										  <td valign="top" bgcolor="#EBEBEB" class="font14"><div align="right"><?php echo $bsetdata["syakuchikikan_chidai_name"] ?><!--¼ÚÃÏ´ü´Ö¡¦ÃÏÂå --></div></td>
										  <td bgcolor="#FFFFFF" class="font12">
...
<?php 
					...
					?>									
										<tr>
										  <td valign="top" bgcolor="#EBEBEB" class="font14"><div align="right"><?php echo $bsetdata["zappi_name"] ?><!--¤½¤ÎÂ¾°ì»þ¶â --></div></td>
										  <td bgcolor="#FFFFFF" class="font12">
					...
					?>				<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["setsudou_name"] ?><!--ÀÜÆ»¾õ¶· --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["kokudohou_name"] ?><!--¹ñÅÚË¡ --></div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
...
<?php 
					...
					?>           <tr> 
										...
										<tr>
												<td valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right">¾ò·ïÅù</div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"><span class="realestate_bgcolor3">
														<textarea name="jouken" cols="60" rows="6" class="ime-active" id="jouken"><?php echo $re1data["jouken"];?></textarea>
												</span></td>
										</tr>
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right">¸ø³«ÍÑÈ÷¹Í</div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"> <span class="realestate_bgcolor3">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right">Èó¸ø³«ÍÑÈ÷¹Í</div>
												</td>
												<td bgcolor="#FFFFFF" class="font12"> <span class="realestate_bgcolor3">
...
¢¨Á´³Ñ30Ê¸»ú°ÊÆâ </div>
					...
					?><tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14"><?php echo $bsetdata["torihikitaiyou_name"] ?><!--¼è°úÂÖÍÍ --></div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
