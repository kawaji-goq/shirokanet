                            ...
                            <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td bgcolor="#FFFFFF" class="font10">
                                        <p><font color="#000000">ÇäÇãÅÚÃÏÊª·ïÅÐÏ¿</font></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
?>
					...
					?>
                            <tr>
                              <td valign="top" class="font14">
                                <div align="right"><?php echo $bsetdata["menseki_name"] ?></div></td>
                              <td class="font12">
...
?>
                            <tr>
                              ...
                              <td class="font12">
                                <input name="kenpei_ritsu" type="text" id="kenpei_ritsu" class="noime" value="<?php echo $re1data["kenpei_ritsu"];?>" size="8" />
      ¡ó</td>
                            </tr>
                            <?php 
					}
					...
					?>
                            <tr>
                              <td align="right" valign="top" class="font14">
                                <div align="right"><?php echo $bsetdata["hosyoukin_name"] ?></div></td>
...
?>
                                    <tr>
                                        <td width="150" valign="middle" bgcolor="#FFFFFF" class="font14">
