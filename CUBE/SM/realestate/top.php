...
<TABLE width="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
								...
								<tr>
										...
										<td>
												<table width="100%"  border="0" cellspacing="0" cellpadding="5">
														<tr>
																<td class="font10"> <span class="font14">賃貸事業用物件　管理 </span> </td>
														</tr>
												</table>
										</td>
								</tr>
		...
		<TR>
		    <TD><div class="helper">賃貸事業用物件に表示する項目を設定するには<a href="?PID=re_c3_set">こちらをクリック</a>してください。
		            <br>
						...
						<form name="form1" method="post" action="">
										...
										<TR>
												<TD>
														<TABLE width="100%"  border="0" cellspacing="0" cellpadding="0">
																<TR>
																		<TD>
																				<input type="button" name="Submit" value="新規物件追加" onClick="location.href='index.php?PID=re_c3_add'">
																		</TD>
																		<TD>
																				<div align="right"><strong>表示件数</strong>
																								<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
																										<option value="?PID=re_c3&amp;lim=10&page=1"<?php if($_SESSION["lim"]=="10"){echo " selected";}?>>10件</option>
								...
								<TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
										<TR  class="realestate_bgcolor2">
												<th width="3%" rowspan="2" nowrap><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&sort=osusume<?php if($_SESSION["sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
												スメ </strong></a></th>
												<th width="8%" rowspan="2" align="center" valign="middle" class="font12"><?php echo $bsetdata["photo_name"] ?></th>
												<th width="20%">
														<div align="center"><strong><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&sort=bukkenn_id<?php if($_SESSION["sort"]=="bukkenn_id") { echo " desc";}?>">物件番号
																<?php if($_SESSION["sort"]=="bukkenn_id") { echo "▼";}elseif($_SESSION["sort"]=="bukkenn_id desc") { echo "▲";}?>
																</a>
																</strong></div>
												</th>
												<th width="16%" rowspan="2">
														<div align="center"><strong><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&sort=kakaku<?php if($_SESSION["sort"]=="kakaku") { echo " desc";}?>"><?php echo $bsetdata["kakaku_name"] ?><?php if($_SESSION["sort"]=="kakaku") { echo "▼";}elseif($_SESSION["sort"]=="kakaku desc") { echo "▲";}?></a></strong><br>
																<?php echo $bsetdata["kanrihi_name"] ?></div>
												</th>
												<th width="11%" rowspan="2">
														<div align="center"><strong><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&sort=senyumenseki<?php if($_SESSION["sort"]=="senyumenseki") { echo " desc";}?>"><?php echo $bsetdata["senyumenseki_name"] ?>
														<?php if($_SESSION["sort"]=="senyumenseki") { echo "▼";}elseif($_SESSION["sort"]=="senyumenseki desc") { echo "▲";}?></a></strong></div>
												</th>
	...
	<div align="center"><strong><font color="#000000">					<div align="center" class="st"><a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"><?php echo $bsetdata["jyusyo_name"] ?></a></div></font></strong></div>																									</div>
												</th>
...
if($re1data[$re1rows]["photo1"]!=NULL) {
	...
	echo "<img src='".$fdata["dirname"]."/o_".str_replace("300","",$fdata["basename"])."' border='0' width='70'>";
}
else {
?>
...
?>
															...
															<div align="center">
																	<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
																			<tr>
																					<td nowrap>
																							<div align="right">
																									<?php if($re1data[$re1rows]["kakaku"]!=NULL) {echo "<span class=\"list_price\">".$re1data[$re1rows]["kakaku"]."</span><span class=\"list_price_tani\">万円</span>"; }else {echo "-";}?><br />
																									<?php 
													...
													<td colspan="2" nowrap class="font12" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
															<div align="center"><?php echo $re1data[$re1rows]["eki"]; ?>
											...
											<TR  class="realestate_bgcolor3">
													...
													<td align="center" nowrap class="font12" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
																	...
																	<div align="center">
																	    <input type="button" name="Submit" value="POP" onclick="window.open('http://siteadmin.itcube.ne.jp/sm/realestate/c3/print<?php echo $tenpodata["poptype"];?>.php?bid=<?php echo $re1data[$re1rows]["id"];?>&did=<?php echo urlencode($_SESSION["DomainData"]["dbname"]);?>&domain=<?php echo $_SESSION["DomainData"]["domain_name"];?>')" />
																	    </div>
													</td>
													<TD <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
		  		...
		  		echo "　<a href=\"?PID=".$_REQUEST["PID"]."&cid=".$_SESSION["cid"]."&page=".$prows."\">".$prows."</a>　";
                          ...
                          <td width="100" nowrap="nowrap">
                              <div align="left">
								...
								<a href="?cid=<?php echo $_SESSION["cid"];?>&amp;sort=senyumenseki<?php if($_SESSION["sort"]=="senyumenseki") { echo " desc";}?>"></a>
								<input name="btm_update_osusume" type="submit" id="btm_update_osusume" value="物件情報を更新する">
