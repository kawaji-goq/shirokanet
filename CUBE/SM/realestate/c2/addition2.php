            ...
            <TD valign="top">
                <div class="helper">
                    <table width="100%" border="0" cellspacing="1" cellpadding="3">
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF">賃貸戸建て物件に表示する項目を設定するには<a href="?PID=re_c2_set">こちらをクリック</a>してください。 <br>
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF" class="font12">
                                        <select name="genkyou" id="genkyou">
                                            ...
                                            <option<?php if($re1data["genkyou"]=="賃貸中"){echo " selected";}?>>賃貸中</option><option<?php if($re1data["genkyou"]=="商談中") {echo  " selected";}?>>商談中</option>
                ...
                <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
					...
					?>
                                <tr>
                                    ...
                                    <td class="font12"> <span class="realestate_bgcolor3">
                                        <input name="reikin" type="text" class="noime" id="reikin" value="<?php echo $re1data["reikin"];?>" size="6" onChange="calprice('reikin_tani')" />
                                        ヶ月
                                        <input name="reikin_tani" type="text" class="noime" id="reikin_tani" value="<?php echo $re1data["reikin_tani"];?>" size="6" onClick="calprice('reikin_tani')" />
                                        万円 </span> </td>
                                </tr>
                                <?php 
					}
					...
					?>
                                <tr>
                                    ...
                                    <td class="font12"><span class="realestate_bgcolor3">
                                        ...
                                        ヶ月
                                        <input name="hosyoukin_kakaku" type="text" class="noime" id="hosyoukin_kakaku" value="<?php echo $re1data["hosyoukin_kakaku"];?>" size="6" onClick="calprice('hosyoukin_kakaku')" />
                                        万円 </span></td>
                                </tr>
                                <?php 
					}
