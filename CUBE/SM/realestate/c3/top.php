...
if($_GET["adc3sort"]!=NULL) {
	$_SESSION["adc3sort"]=$_GET["adc3sort"];
}
/*
else if($_SESSION["adc3sort"]==NULL){
	$_SESSION["adc3sort"]="kakaku";
}
*/
if($_GET["cid"]!=NULL) {
...
if(substr_count($_SERVER['HTTP_REFERER'],"re_c3")==0) {
	$_SESSION["madori"]="";
	$_SESSION["lowcost"]="";
	$_SESSION["hicost"]="";
	$_SESSION["keyword"]="";
...
$re1obj->type=3;
$re1data=$re1obj->GetReList(1,$_SESSION["adc3sort"]);
...
function goreplace(bid) {
	location.href="index.php?PID=re_c3_rep&bid="+bid;
}
function gocopy(bid) {
	location.href="index.php?PID=re_c3_copy&bid="+bid;
}

function godelete(bid) {
	location.href="index.php?PID=re_c3_del&bid="+bid;
}
...
<TABLE width="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
								...
								<tr>
										...
										<td>
												<table width="100%"  border="0" cellspacing="0" cellpadding="5">
														<tr>
																<td class="font10"> <span class="font14"> <strong>賃貸事業用物件　管理</strong> </span> </td>
														</tr>
												</table>
										</td>
								</tr>
	...
	if(str_replace("www.","",$_SERVER['HTTP_HOST'])!="nest-h.com"){
		?>
		<TR>
		    <TD><div class="helper"><table width="100%" border="0" cellpadding="3" cellspacing="1" id="helper">
              <tr>
                  <th bgcolor="#CCCCCC">
              ...
              <tr>
                  <td bgcolor="#FFFFFF">賃貸事業用物件に表示する項目を設定するには<a href="?PID=re_c3_set">こちらをクリック</a>してください。
		            <br>
										...
										<TR>
												<TD>
														<TABLE width="100%"  border="0" cellspacing="0" cellpadding="5">
                                                          ...
                                                          <TR bgcolor="#CCCCFF">
                                                            <TD bgcolor="#DDDDFF">
                                                              <input type="button" name="Submit" value="新規物件登録" onClick="location.href='index.php?PID=re_c3_add'"></TD>
                                                            <TD bgcolor="#DDDDFF">
...
&nbsp;</strong></TD>
                                                            <TD><div align="right"><strong>表示件数</strong>
                                                              <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                                                                <option value="?PID=re_c3&lim=10&page=1"<?php if($_SESSION["lim"]==10||$_SESSION["lim"]==NULL) { echo " selected";}?>>10件</option>
                                                                <option value="?PID=re_c3&lim=20&page=1"<?php if($_SESSION["lim"]==20) { echo " selected";}?>>20件</option>
                                                                <option value="?PID=re_c3&lim=30&page=1"<?php if($_SESSION["lim"]==30) { echo " selected";}?>>30件</option>
                                                                <option value="?PID=re_c3&lim=40&page=1"<?php if($_SESSION["lim"]==40) { echo " selected";}?>>40件</option>
                                                                <option value="?PID=re_c3&lim=50&page=1"<?php if($_SESSION["lim"]==50) { echo " selected";}?>>50件</option>
                                                                <option value="?PID=re_c3&lim=100&page=1"<?php if($_SESSION["lim"]==100) { echo " selected";}?>>100件</option>
                                                              </select>
                                                            </div></TD>
                                                          </TR>
                            </TABLE>										  </TD>
								...
								<TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
										<TR  class="realestate_bgcolor2">
												<th width="3%" rowspan="2" nowrap><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&adc3sort=osusume<?php if($_SESSION["adc3sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
												スメ </strong></a></th>
												<th width="7%" rowspan="2" align="center" valign="middle" class="font12"><?php echo $bsetdata["photo_name"] ?></th>
												<th width="18%">
														<div align="center"><strong><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&adc3sort=bukkenn_id<?php if($_SESSION["adc3sort"]=="bukkenn_id") { echo " desc";}?>">物件番号
																<?php if($_SESSION["adc3sort"]=="bukkenn_id") { echo "▼";}elseif($_SESSION["adc3sort"]=="bukkenn_id desc") { echo "▲";}?>
																</a>
																</strong></div>
												</th>
												<th width="14%" rowspan="2">
														<div align="center"><strong><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&adc3sort=kakaku<?php if($_SESSION["adc3sort"]=="kakaku") { echo " desc";}?>"><?php echo $bsetdata["kakaku_name"] ?><?php if($_SESSION["adc3sort"]=="kakaku") { echo "▼";}elseif($_SESSION["adc3sort"]=="kakaku desc") { echo "▲";}?></a></strong><br>
																<?php echo $bsetdata["kanrihi_name"] ?></div>
												</th>
												<th width="9%" rowspan="2">
														<div align="center"><strong><a href="?PID=re_c3&cid=<?php echo $_SESSION["cid"];?>&adc3sort=senyumenseki<?php if($_SESSION["adc3sort"]=="senyumenseki") { echo " desc";}?>"><?php echo $bsetdata["senyumenseki_name"] ?>
														<?php if($_SESSION["adc3sort"]=="senyumenseki") { echo "▼";}elseif($_SESSION["adc3sort"]=="senyumenseki desc") { echo "▲";}?></a></strong></div>
												</th>
												...
												<th width="3%" rowspan="2">
														<div align="center" class="font14"><strong><font color="#000000">削除 </font></strong></div>
												</th>
												<th width="6%" rowspan="2"><div align="center" class="font14"><strong><font color="#000000">選択削除 </font></strong></div></th>
										</TR>
										<TR  class="realestate_bgcolor2">
												<th>
														<div class="font14">
																<div align="center"><?php echo $bsetdata["bukken_mei_name"] ?><br>
	<div align="center"><strong><font color="#000000">					<div align="center" class="st"><a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["adc3sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&adc3sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&adc3sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"><?php echo $bsetdata["jyusyo_name"] ?></a></div></font></strong></div>																									</div>
												</th>
												<th width="11%" align="center" class="font12"><?php echo $bsetdata["reikin_name"] ?><br />
											...
											<TR  class="realestate_bgcolor3">
													<TD width="3%" rowspan="2" class="font14" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><span class="font12">
													...
													<td width="7%" rowspan="2" align="center" valign="middle" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>> 
															<div align="center"><a href="?PID=re_c3_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>">
															    <?php
...
?>
               </a><a href="?PID=re_c3_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>"></a></div>
													</td>
													...
													<TD bgcolor="#FFECEC" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
															<div align="center">
															    <table border="0" align="center" cellpadding="0" cellspacing="3"<?php if($tenpodata["c3lastupid"]==$re1data[$re1rows]["id"]) {?> style="background-color:#666666;"<?php }?>>
                       <tr>
                           <td>
                               <input type="button" name="Submit" value="修正" onClick="goreplace('<?php echo $re1data[$re1rows]["id"];?>')">
													...
													<TD rowspan="2" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
															<div align="center">
													...
													<TD rowspan="2" bgcolor="#ECFFEC" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
														<div align="center">
																<input type="button" name="Submit" value="削除" onclick="godelete('<?php echo $re1data[$re1rows]["id"];?>')" />
														</div>												</TD>
													<TD rowspan="2" bgcolor="#ECFFEC" <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><div align="center"><span class="font12">
		  		...
		  		echo "　<a href=\"?PID=".$_REQUEST["PID"]."&cid=".$_SESSION["cid"]."&page=".$prows."\">".$prows."</a>　";
                          ...
                          <td width="100" nowrap="nowrap">
                              <div align="left">
								...
								<a href="?cid=<?php echo $_SESSION["cid"];?>&amp;adc3sort=senyumenseki<?php if($_SESSION["adc3sort"]=="senyumenseki") { echo " desc";}?>"></a>
						</form>
				</TD>
		</TR>
</TABLE>
