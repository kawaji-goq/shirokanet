    				...
    				<table width="700" border="0" align="center">
								<tr>
										...
										<td width="412" align="left">
												<p><strong>　<?php echo $menudata[2]["data_name"]; ?>　&gt;&gt;　データ更新</strong></p>
										</td>
								</tr>
						</table>
    		</td>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="188" align="left" valign="top" bgcolor="#FFFFFF">
              <textarea name="data_name[<?php echo $datanum ?>]" wrap="off" id="data_name[<?php echo $datanum ?>]"><?php echo $nowdata[$datanum]["data_name"] ?></textarea>
              <input name="data_id[<?php echo $datanum ?>]" type="hidden" id="data_id[<?php echo $datanum ?>]"  value="<?php echo $nowdata[$datanum]["data_id"] ?>"/>
            </td>
            <td width="384" align="left" valign="top" bgcolor="#FFFFFF">
              <textarea name="data_comm[<?php echo $datanum ?>]" cols="50" rows="10" wrap="off" id="data_comm[<?php echo $datanum ?>]"><?php echo $nowdata[$datanum]["data_comm"] ?></textarea>
              <br />
            </td>
        ...
        <table width="700" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="200" align="left" valign="top" bgcolor="#FFFFFF">
              <textarea name="new_data_name" wrap="off" id="new_data_name"></textarea>
            </td>
            <td width="458" align="left" valign="top" bgcolor="#FFFFFF">
              <textarea name="new_data_comm" cols="50" rows="10" wrap="off" id="new_data_comm"></textarea>
