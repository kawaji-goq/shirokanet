  				...
  				<table width="700" border="0" align="center">
							<tr>
									...
									<td width="412" align="left">
											<p><strong>　<?php echo $menudata[1]["data_name"]; ?>　&gt;&gt;　データ更新</strong></p>
									</td>
...
<table width="510" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="400" align="left" bgcolor="#FFFFFF"> <?php echo nl2br($_POST["title"]);?></td>
  </tr>
...
<table width="510" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#FFFFFF"> <?php echo nl2br($_POST["comm"]);?> </td>
  </tr>
</table>
<?php
		}
...
<table width="510" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" >
  <tr>
    <th width="100" align="left" valign="top" bgcolor="#ECECEC">リンク先</th>
    <td align="left" valign="top" bgcolor="#FFFFFF"> <?php echo $_POST["link"];?> </td>
  </tr>
  <tr>
...
<label for="day_view">日付を表示しない</label></td>
  ...
  <tr>
  		...
  		<td align="left" bgcolor="#FFFFFF">
			...
			?>
          <tr>
            <th width="100" align="left" valign="top" bgcolor="#ECECEC"><strong>タイトル</strong></th>
...
<?php if($newssetting["image_chk"]==1) {?>
		 ...
		 <?php if($newssetting["comm_chk"]==1) {?>
		 		<table width="510" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
						<tr>
								<th width="100" align="left" bgcolor="#ECECEC">表示タイプ</th>
								<td align="left" bgcolor="#FFFFFF">
										<input name="view_type" type="radio" id="view_type1" value="0" <?php if($newsdata["view_type"]==0) { ?>checked="checked"<?php } ?> onclick="view_change(0)" />
										<label for="view_type1">テキスト</label>
										<input name="view_type" type="radio" value="1" id="view_type2" onclick="view_change(1)"<?php if($newsdata["view_type"]==1) { ?>checked="checked"<?php } ?> />
										<label for="view_type2">バナー</label>
								</td>
						</tr>
				</table>
      <div id="type_text" style="display:<?php if($newsdata["view_type"]==0) { ?>block<?php }else {echo "none";} ?>;">  <table width="510" border="0" align="center" cellpadding="3" cellspacing="1">
          <tr>
            <th width="100" align="left" valign="top" bgcolor="#ECECEC"><strong>内容</strong></th>
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <textarea name="comm" cols="40" rows="10" id="comm"><?php echo $newsdata["comm"];?></textarea>
            </td>
          </tr>
        </table></div>
        ...
        <table width="510" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              ...
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onclick="location.replace('?PID=news')" />
            </td>
          </tr>
        </table>
		<script>
