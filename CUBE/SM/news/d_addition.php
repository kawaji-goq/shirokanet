...
<label for="day_view">日付を表示しない</label></td>
          ...
          <tr>
            <th width="150" align="left" valign="top" bgcolor="#ECECEC"><strong>タイトル</strong></th>
            <td width="435" align="left" bgcolor="#FFFFFF">
        ...
        <?php if($newssetting["comm_chk"]==1) {?>
				<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
				 ...
				 ?>
						<tr>
								<th width="150" align="left" valign="top" bgcolor="#ECECEC">表示タイプ</th>
								<td width="435" align="left" valign="top" bgcolor="#FFFFFF">
										<input name="new_view_type" type="radio" id="view_type1" value="0" checked="checked" onclick="view_change(0)" />
										<label for="view_type1">テキスト</label>
										<input name="new_view_type" type="radio" value="1" id="view_type2" onclick="view_change(1)" />
										<label for="view_type2">リンク</label>
								</td>
						</tr>
				</table>
