                                  ...
                                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                          <td>
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                      <td width="46%" class="maintitle"><strong><span class="yearmonth"><?php echo $topicsdata["ryear"];?>年<?php echo $topicsdata["rmonth"];?>月 <?php echo $catedata["cate_name"]; ?></span></strong></td>
                                                      <td width="54%" class="maintitle">
                                      ...
                                      <?php
												...
												?>
                                      <tr>
                                          <td background="img/topics/TopicsLine.jpg" height="13"><span></span></td>
                                      </tr>
                                      <tr>
                                          <td>
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                          <td valign="top" class="text"><span><?php echo $newblogdata[$mi]["comm"];?>
                                              ...
                                              <br />
                                                      <?php }?>
																											<?php echo $newblogdata[$mi]["text3"];?>
                                                      <?php if($newblogdata[$mi]["image3"]!=NULL) {?>
                                                      <br />
                                                      <br />
                                                      <div align="center"> <img src="<?php echo $newblogdata[$mi]["image3"];?>?<?php echo time();?>" alt="<?php echo strip_tags($newblogdata[$mi]["title"]);?>" /></div>
                                              <br />
                                                      <?php }?><?php echo $newblogdata[$mi]["text4"];?>
                                                      <?php if($newblogdata[$mi]["image4"]!=NULL) {?>
                                                      <br />
                                                      <br />
                                                      <div align="center"> <img src="<?php echo $newblogdata[$mi]["image4"];?>?<?php echo time();?>" alt="<?php echo strip_tags($newblogdata[$mi]["title"]);?>" /></div><br /><?php }?>
																											<?php echo $newblogdata[$mi]["text5"];?>
                                                      <?php if($newblogdata[$mi]["image5"]!=NULL) {?>
                                                      <br />
                                                      <br />
                                                      <div align="center"> <img src="<?php echo $newblogdata[$mi]["image5"];?>?<?php echo time();?>" alt="<?php echo strip_tags($newblogdata[$mi]["title"]);?>" /></div>
                                              <br />
                                                      <?php }?><?php echo $newblogdata[$mi]["text6"];?>
                                                      <?php if($newblogdata[$mi]["image6"]!=NULL) {?>
                                                      <br />
                                                      <br />
                                                      <div align="center"> <img src="<?php echo $newblogdata[$mi]["image6"];?>?<?php echo time();?>" alt="<?php echo strip_tags($newblogdata[$mi]["title"]);?>" /></div>
                                              <br />
                                                      <?php }?>
                                              </span><br /><div></div>
                                          </td>
