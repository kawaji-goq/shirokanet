...
if($_REQUEST["delmessage"]=="このメッセージを更新する"){
	$sql="update message set title='".$_REQUEST["title"]."',message='".$_REQUEST["message"]."' where message_id = ".$_REQUEST["message_id"];
	$dbobj->Query($sql);
	$sql2="update message_readlogs set read_status=0 where message_id = ".$_REQUEST["message_id"];
	$dbobj->Query($sql2);
	$sql3="update message_logs set  title='".$_REQUEST["title"]."',comment= '".$_REQUEST["message"]."' where sled_id = ".$_REQUEST["message_id"]." and log_num=0";
	$dbobj->Query($sql3);
?>
                    ...
                    <td >
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FCFCFC">
                            <tr>
                                ...
                                <td width="96%" class="title">お知らせ編集</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td bgcolor="#DCDCFF">
                        <form name="form1" method="post" action="">
                            <table width="100%"  border="0" align="center" cellpadding="2" cellspacing="1">
                                ...
                                <tr>
                                    <td height="40" bgcolor="#EFF6FF">
                                        <table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#EFF6FF">
                                            <tr>
                                                <td><font color="#333333" class="sledtitle">
                                                    <input name="title" type="text" id="title" value="<?php echo $meslist[$j]["title"];?>" style="width:98%;">
                                                </font></td>
                                                <td>
                                                    <div align="right"></div>
                                                </td>
                                        ...
                                        <table width="100%"  border="0" align="center" cellpadding="3" cellspacing="3">
                                            <tr>
                                                <td colspan="2" class="comment">
                                                    <textarea name="message" rows="6"  style="width:98%;"><?php echo ($meslist[$j]["message"])?></textarea>
                                                &nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                ...
                                <tr>
                                    <td bgcolor="#FFFFFF">
                                        <input name="delmessage" type="submit" id="delmessage" value="このメッセージを更新する">
