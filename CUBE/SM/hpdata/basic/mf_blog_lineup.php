...
$newblogsql="select * from blog_data order by rdate desc, blog_id desc";
}
else if($_GET["year"]==NULL&&$_GET["month"]==NULL) {
$newblogsql="select * from blog_data where cate_id=".$_GET["cate_id"]." order by rdate desc, blog_id desc";
}
else if($_GET["year"]==NULL&&$_GET["cate_id"]==NULL) {
$newblogsql="select * from blog_data where rmonth=".$_GET["month"]." order by rdate desc, blog_id desc";
}else if($_GET["month"]==NULL&&$_GET["cate_id"]==NULL) {
$newblogsql="select * from blog_data where ryear=".$_GET["year"]." order by rdate desc, blog_id desc";
}
else if($_GET["month"]==NULL) {
$newblogsql="select * from blog_data where cate_id=".$_GET["cate_id"]." and ryear=".$_GET["year"]." order by rdate desc, blog_id desc";
}
else if($_GET["year"]==NULL) {
$newblogsql="select * from blog_data where rmonth=".$_GET["month"]." and  cate_id=".$_GET["cate_id"]." order by rdate desc, blog_id desc";
}
...
$newblogsql="select * from blog_data where rmonth=".$_GET["month"]." and ryear=".$_GET["year"]." and  cate_id=".$_GET["cate_id"]." order by rdate desc, blog_id desc";
        ...
        <tr>
          <td align="left" valign="top" background="/img/main/sideline.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td width="13%" align="left" valign="top"><table width="70" height="52" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><a href="?PID=hp_basic_blog_closeup&blog_id=<?php echo $newblogdata[$bi]["blog_id"]; ?>"><?php echo $news->Image("image2");?></a></td>
                    </tr>
                </table></td>
                <td width="85%" align="left" valign="top"><table width="97%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left" valign="top" class="text2"><a href="?PID=hp_basic_blog_closeup&blog_id=<?php echo $newblogdata[$bi]["blog_id"]; ?>"><?php echo $newblogdata[$bi]["title"]; ?></a></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top"><p class="text2"><span class="text"><?php echo mb_strimwidth(mb_convert_kana(strip_tags($newblogdata[$bi]["comm"],"KHSA")),0,180,"・・・","EUC-JP"); ?></span></p>
                      </td>
                    </tr>
                </table></td>
              </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td align="left" valign="top">&nbsp;</td>
                    <td align="left" valign="top"><span class="text2"><a href="?PID=basic_blog_reg&cate_id=<?php echo $_REQUEST["cate_id"];?>">新しい記事を書く</a></span></td>
                </tr>
                <tr>
                    <td width="2%" align="left" valign="top">&nbsp;</td>
                    <td align="left" valign="top">&nbsp;</td>
