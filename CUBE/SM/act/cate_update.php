	...
	<tr>
		...
		<tr>
			...
			<td align="center" valign="top">			
					...
					?><script language="javascript">
	window.location.replace("index.php?PID=ac_cate");
</script>
...
?>&nbsp;                    			</td>
				...
				?>
                    	...
                    	<tr>
                    		...
                    		<td colspan="6">
                    			<input name="cate_name" type="text" id="cate_name" value="<?php echo $fcdata["cate_name"] ?>" size="50">
                   			</td>
                   		</tr>
                    	</table>
					<table width="95%" border="0" cellspacing="0" cellpadding="0">
