      ...
      <form id="form1" name="form1" method="post" action="">
        <table width="700" border="0" align="center">
          <tr>
            ...
            <th width="150" align="left"><strong>タイトル</strong></th>
            <th width="149" align="left"><?php if($qandasetting["data_comm_chk"]==1) {?><strong>内容</strong><?php }?></th>
            <th width="100" align="left">公開</th>
...
?>
          <tr>
            ...
            <td width="150" align="left" valign="top">
             ...
             <?php if($qandasetting["cate_comm_chk"]==1) {?> <?php $qandaddata->Moji("data_comm"); ?><?php
			}
			?>
            </td>
