			...
			<td valign="top">
				<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0">
						<tr>
							...
							?>
												<form name="delform" method="post" action="">	<tr>
														<td height="40" bgcolor="#EFF6FF"><font color="#333333" class="sledtitle">
														    <input name="sled_name" type="text" id="sled_name" value="<?php echo $sleddata["sled_name"];?>" size="40" style="width:50%;">
														</font></td>
												</tr>
												<tr>
												...
												<tr>
														<td bgcolor="#FFFFFF">
																<table width="100%" border="0" cellspacing="3" cellpadding="3">
																		<tr>
																				<td>
																				    <textarea name="comment" rows="10" style="width:100%;"><?php echo $sleddata["master_comment"]?></textarea>
																			    </td>
																		</tr>
																</table>
																</td>
								...
								$bbsobj->up_Topics($_POST);
								
							?>	<tr>
														<td bgcolor="#FFFFFF"><script language="javascript">location.replace("?PID=bbs_sled&sled_id=<?php echo $_REQUEST["sled_id"];?>");</script>
