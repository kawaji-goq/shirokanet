  				...
  				<table width="700" border="0" align="center">
							<tr>
									...
									<td width="412" align="left">
											<p><strong>　リンク管理　&gt;&gt;　カテゴリ更新</strong></p>
									</td>
							</tr>
					</table>
  		</td>
...
?>
   ...
   <?php
		 if($linksetting["cate_image_chk"]==1) {
		 ?><?php
		  }
		  ?><?php
		...
		<table width="510" border="0" align="center">
          <tr>
            <th width="100" align="left"><strong>カテゴリ名</strong></th>
            <td width="400" align="left">
              <textarea name="cate_name" cols="50" id="cate_name"><?php echo $linkcdata["cate_name"];?></textarea>
            </td>
          </tr>
           <?php
		 if($linksetting["cate_image_chk"]==1) {
		 ...
		 ?>
          <tr>
            <th width="100" align="left" valign="top"><strong>内容</strong></th>
            <td align="left" valign="top">
              <textarea name="cate_comm" cols="50" rows="15" id="cate_comm"><?php echo $linkcdata["cate_comm"];?></textarea>
            </td>
          </tr><?php
		  }
		  ?>
          <tr>
            ...
            <td align="left" valign="top">
              <select name="view_chk" id="view_chk">
                <option value="1"<?php if($linkcdata["view_chk"]==1){echo " selected";}?>>公開する</option>
                <option value="0"<?php if($linkcdata["view_chk"]==0){echo " selected";}?> >公開しない</option>
              </select>
            </td>
          </tr>
          <tr>
