...
<TABLE width="700"  border="0" align="left" cellpadding="0" cellspacing="0" class="realestate_bgcolor1">
                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p><font color="#000000">売買事業用物件登録 </font> </p>
                              </td>
                          </tr>
                      </table>
                  </td>
		...
		<TR class="realestate_bgcolor2">
		    <TD valign="top"><div class="helper">売買事業用物件に表示する項目を設定するには<a href="?PID=re_b3_set">こちらをクリック</a>してください。
		            <br>
					...
					?>
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
														<div align="right"><?php echo $bsetdata["bukken_id_name"] ?>
																		<!--物件番号 -->
														</div>
												</td>
												<td bgcolor="#FFFFFF" class="font12">
														<input name="bukkenn_id" type="text" class="noime" id="bukkenn_id" value="<?php echo $_REQUEST["bukkenn_id"];?>">
												</td>
										</tr>
										<?php
					}
										...
										<tr>
												...
												<td bgcolor="#FFFFFF" class="font12">
														<select name="syumoku" id="syumoku">
																<option<?php if($re1data["syumoku"]=="店舗"){echo " selected";}?>>店舗</option>
																<option<?php if($re1data["syumoku"]=="店舗付住宅"){echo " selected";}?>>店舗付住宅</option>
																<option<?php if($re1data["syumoku"]=="住宅付店舗"){echo " selected";}?>>住宅付店舗</option>
																<option<?php if($re1data["syumoku"]=="事務所"){echo " selected";}?>>事務所</option>
																<option<?php if($re1data["syumoku"]=="店舗事務所"){echo " selected";}?>>店舗事務所</option>
																...
																<option<?php if($re1data["syumoku"]=="ホテル"){echo " selected";}?>>ホテル</option>
