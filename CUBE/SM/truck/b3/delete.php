				...
				<TD valign="top">
						<form action="" method="post" enctype="multipart/form-data" name="lease_apaman_form">
												...
												<td>
														<table width="100%"  border="0" cellspacing="0" cellpadding="5">
																<tr>
																  ...
																  <p><font color="#000000">事業用物件</font> </p>																  </td>
																</tr>
														</table>
												</td>
										</tr>
								...
								<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
										...
										<tr>
												<td width="200" rowspan="2" bgcolor="#EBEBEB" class="font14">
														<div align="right" class="font14">物件所在地 </div>
												</td>
												<td width="740" bgcolor="#FFFFFF" class="font12"> <?php echo $re1data["yubinbangou"];?> </td>
										</tr>
										<tr>
										...
										<tr>
												<td height="31" bgcolor="#EBEBEB" class="font14">
										...
										<tr>
												<td width="200" bgcolor="#EBEBEB" class="font14">&nbsp; </td>
												<td bgcolor="#FFFFFF" class="font12">
