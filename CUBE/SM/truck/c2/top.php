	...
	<TR>
		<TD><br>
					...
					<TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
									<TR class="realestate_bgcolor2">
											<th width="3%" rowspan="3" nowrap><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&adc2sort=osusume<?php if($_SESSION["adc2sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
													スメ</strong></a></th>
											<th width="8%" rowspan="3" valign="middle">
											...
											<th width="13%" rowspan="3" class="font12">
											...
											<th width="12%" rowspan="3" align="center" class="font12"><span class="st"><a href="?PID=re_c2&cid=<?php echo $_SESSION["cid"];?>&amp;adc2sort=madori<?php if($_SESSION["adc2sort"]=="madori,mnum") { echo " desc";}?>,mnum<?php if($_SESSION["adc2sort"]=="madori,mnum") { echo " desc";}?>"><?php echo $bsetdata["madori_name"] ?></a><br />
											...
											<th width="5%" rowspan="3" align="center" class="font12">
               <div align="center">POP</div>
									...
									<TR class="realestate_bgcolor2">
											<th width="9%" align="center" class="font12"><?php echo $bsetdata["reikin_name"] ?><br />
															<?php echo $bsetdata["shikikin_name"] ?></th>
											<th width="8%" class="font12">
													<div align="center">
									...
									<TR <?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
											...
											<TD width="8%" rowspan="3" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?> class="font12">
...
?>
               ...
               <div align="center">
                   <input type="button" name="Submit" value="設定" onClick="location.href='?PID=re_osetting'">
											...
											<TD width="5%" rowspan="2" valign="middle" bgcolor="#FFECEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
                     ...
                     <tr>
                         <td>
                             <input type="button" name="Submit" value="修正" onClick="goreplace('<?php echo $re1data[$re1rows]["id"];?>')">
											...
											<TD width="3%" rowspan="3" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
											...
											<TD width="5%" rowspan="2" valign="middle" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
									...
									<TR>
											...
											<TD width="5%" valign="middle" bgcolor="#FFECEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center">
															<input type="button" name="Submit" value="複製" onClick="gocopy('<?php echo $re1data[$re1rows]["id"];?>')">
													</div>
											</TD>
											<TD width="5%" valign="middle" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center"><span class="font12">
