                      ...
                      <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                              <td bgcolor="#FFFFFF" class="font10">
                                  <p><font color="#000000">賃貸アパート・</font><font color="#000000">マンション物件複製登録 </font> </p>
                              </td>
                          </tr>
                      </table>
                  </td>
...
駅                </td>
            ...
            <tr>
                <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                    <div align="right" class="font14"><?php echo $bsetdata["madori_name"] ?>
                            <!--間取り -->
                    </div>
                </td>
                <td bgcolor="#FFFFFF" class="font12">
            ...
            <tr>
                <td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
                    <div align="right" class="font14"><?php echo $bsetdata["madori_syousai_name"] ?>
                            <!--間取り詳細 -->
                    </div>
                </td>
                <td bgcolor="#FFFFFF" class="font12">
