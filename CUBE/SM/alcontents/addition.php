...
if($_REQUEST["pmode"]=="regist") {
	$newid=$ad_contents1->AdditionCate($_POST);
	$contents1cdata=$ad_contents1->GetDetailsCate($newid);
...
<?php
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onClick="location.replace('?PID=alcontents_add')">
