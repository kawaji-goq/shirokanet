...
if($_REQUEST["pmode"]=="regist") {
	$new_id=$ad_contents1->AdditionData($_POST);
	$contents1data=$ad_contents1->GetDetailsData($new_id);
        ...
        <table width="700" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
		 ...
		 ?>
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onClick="location.replace('?PID=alcontents_d_add&cate_id=<?php echo $_REQUEST["cate_id"];?>')">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onclick="location.replace('?PID=alcontents_details&cate_id=<?php echo $_GET["cate_id"];?>')" />
            </td>
          </tr>
        </table>
		<?php
		...
		<table width="700" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
		 ...
		 ?>
          ...
          <tr>
          				...
          				<td align="left" valign="top" bgcolor="#FFFFFF">
          								<input name="osusume_chk" type="checkbox" id="data_osusume_chk" value="1" checked>
          				</td>
          				</tr>
          <tr>
            <th width="100" align="left" valign="top" bgcolor="#ECECEC">公開</th>
