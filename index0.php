                                            ...
                                            <tr>
                                                <td>
                                                    <table width="353" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td valign="top">&nbsp;</td>
                                                            <td height="50" align="left" valign="top" class="topicstext"><?php echo mb_strimwidth(mb_convert_kana(strip_tags($newblogdata[$bi]["comm"]),"NRKHVS","EUC-JP"),0,60,"Ž¥Ž¥Ž¥"); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td valign="top">&nbsp;</td>
                                                            <td height="50" valign="top" class="topicstext"><?php echo mb_strimwidth(mb_convert_kana(strip_tags($newblogdata[$bi+1]["comm"]),"NRKHVS","EUC-JP"),0,60,"¡¦¡¦¡¦"); ?></td>
                                                        </tr>
                                                        <?php
														?>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="520" border="0" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top">&nbsp;</td>
                                                                        <td height="48" align="left" valign="top" class="topicstext"><?php echo mb_strimwidth(mb_convert_kana(strip_tags($newblogdata[$bi]["comm"]),"NRKHVS","EUC-JP"),0,180,"Ž¥Ž¥Ž¥"); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="520" border="0" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top">&nbsp;</td>
                                                                        <td height="50" align="left" valign="top" class="topicstext"><?php echo mb_strimwidth(mb_convert_kana(strip_tags($newblogdata[$bi]["comm"]),"NRKHVS","EUC-JP"),0,180,"Ž¥Ž¥Ž¥"); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
    ...
    <tr>
        <td>
            <?php
										...
										if($topnewsrandom==1) {
											$newbsql="select * from bukken where tourokubi >= '".$oldday."' and bunrui=1 and del_chk <>1 order by random() limit 8";
										}
										else {
											$newbsql="select * from bukken where tourokubi >= '".$oldday."' and bunrui=1 and del_chk <>1 order by tourokubi desc,id desc limit 8";
										}
                                    ...
                                    <td width="180" valign="top">
                                        <?php
																		if($newbdata[$i]["id"]!=NULL) {
																		 ?>
                                        <table width="180" border="0" align="center" cellpadding="0" cellspacing="0" summary="¥ì¥¤¥¢¥¦¥ÈÍÑ¥Æ¡¼¥Ö¥ë">
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="170" height="102" align="center"> <a href="<?php if($newbdata[$i]["bunrui"]==1) {?>chintai_d<?php echo syubetsuchk($newbdata[$i]["bunrui"],$newbdata[$i]["syumoku"]); ?>.php<?php echo "?bid=".$newbdata[$i]["id"]; ?><?php }else if($newbdata[$i]["bunrui"]==2){?>baibai_d.php<?php echo "?bid=".$newbdata[$i]["id"]; }?>">
                                                    <?php
...
?><img src="/img/noimage_120_120.gif" border="0" /></a><a href="<?php if($newbdata[$i]["bunrui"]==1) {?>chintai_d<?php echo syubetsuchk($newbdata[$i]["bunrui"],$newbdata[$i]["syumoku"]); ?>.php<?php echo "?bid=".$newbdata[$i]["id"]; ?><?php }else if($newbdata[$i]["bunrui"]==2){?>baibai_d.php<?php echo "?bid=".$newbdata[$i]["id"]; }?>">
                                                    <?php
}
?>
                                                </a></td>
                                            ...
                                            <tr>
                                                <td height="25">
                                                    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="bg_norepeat" summary="¥ì¥¤¥¢¥¦¥ÈÍÑ¥Æ¡¼¥Ö¥ë">
                                                        <tr>
                                                            <td height="25" align="right" class="newbukkenprice"><strong><font color="#FFFFFF">
                                                                <?php 
                                            ...
                                            <tr>
                                                <td height="25">
                                                    <?php if($newbdata[$i]["eki"]!=NULL) {echo $newbdata[$i]["eki"]."±Ø";} ?>[<?php echo $newbdata[$i]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25">
                                                    <?php 
																																															if($newbdata[$i]["banchichk"]){
																																																...
																																																echo chunk_split($jyusyo[$i],23,"<br>");
																																																?>
                                                </td>
                                            </tr><?php 	
...
<img src="img/index/cbukken.jpg" alt="ÄÂÂßÊª·ï" width="55" height="13" />
                                            ...
                                            <tr>
                                                <td height="25">
                                                    <?php if($newbdata[$i+1]["eki"]!=NULL) {echo $newbdata[$i+1]["eki"]."±Ø";}?>[<?php echo $newbdata[$i+1]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[$i+1],23,"<br>");;
...
?>
                                            ...
                                            <tr>
                                                <td height="25">
                                                    <?php if($newbdata[$i+2]["eki"]!=NULL) {echo $newbdata[$i+2]["eki"]."±Ø";}?>[<?php echo $newbdata[$i+2]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
...
?>
                                            ...
                                            <tr>
                                                <td height="25">
                                                    <?php if($newbdata[$i+3]["eki"]!=NULL) {echo $newbdata[$i+3]["eki"]."±Ø";}?>[<?php echo $newbdata[$i+3]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
                                ...
                                <tr>
                                    <td width="180" valign="top">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" summary="¡¡">
                                            ...
                                            <tr>
                                                <td width="5" rowspan="6" background="img/index/bukken_border2.jpg"><img src="img/index/bukken_border2.jpg" alt="border" width="5" height="15" /></td>
                                                <td width="160" height="102" align="center"> <a href="<?php if($osusumedata[0]["bunrui"]==1) {?>chintai_d<?php echo syubetsuchk($osusumedata[0]["bunrui"],$osusumedata[0]["syumoku"]); ?>.php<?php echo "?bid=".$osusumedata[0]["id"]; ?><?php }else if($osusumedata[0]["bunrui"]==2){?>baibai_d.php<?php echo "?bid=".$osusumedata[0]["id"]; }?>">
                                                    <?php
...
?>
                                            ...
                                            <tr>
                                                <td height="25">
                                                    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="osusumebukkenprice" summary="¡¡">
                                                        <tr>
                                                            <td height="25" align="right" class="osusumebukkenprice<?php echo $osusumedata[0]["bunrui"];?>"><strong><font color="#FFFFFF"><?php 
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[0]["eki"]!=NULL) {echo $osusumedata[0]["eki"]."±Ø";} ?>[<?php echo $osusumedata[0]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[0],23,"<br>");
                                    ...
                                    <td width="180">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" summary="¥ì¥¤¥¢¥¦¥ÈÍÑ¥Æ¡¼¥Ö¥ë">
                                            ...
                                            <tr>
                                                <td width="5" rowspan="6" background="img/index/bukken_border2.jpg"><img src="img/index/bukken_border2.jpg" alt="border" width="5" height="15" /></td>
                                                <td width="160" height="102" align="center"><a href="<?php if($osusumedata[1]["bunrui"]==1) {?>chintai_d<?php echo syubetsuchk($osusumedata[1]["bunrui"],$osusumedata[1]["syumoku"]); ?>.php<?php echo "?bid=".$osusumedata[1]["id"]; ?><?php }else if($osusumedata[1]["bunrui"]==2){?>baibai_d.php<?php echo "?bid=".$osusumedata[1]["id"]; }?>">
                                                    <?php
...
?>
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[1]["eki"]!=NULL) {echo $osusumedata[1]["eki"]."±Ø";} ?>[<?php echo $osusumedata[1]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[1],23,"<br>");
...
?>
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[2]["eki"]!=NULL) {echo $osusumedata[2]["eki"]."±Ø";} ?>[<?php echo $osusumedata[2]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[2],23,"<br>");
...
?>
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[3]["eki"]!=NULL) {echo $osusumedata[3]["eki"]."±Ø";} ?>[<?php echo $osusumedata[3]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[3],23,"<br>");
...
?>
                                            ...
                                            <tr>
                                                ...
                                                [<?php echo $osusumedata[4]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[4],23,"<br>");
...
?>
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[5]["eki"]!=NULL) {echo $osusumedata[5]["eki"]."±Ø";} ?>[<?php echo $osusumedata[5]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[5],23,"<br>");
...
?>
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[6]["eki"]!=NULL) {echo $osusumedata[6]["eki"]."±Ø";} ?>[<?php echo $osusumedata[6]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[6],23,"<br>");
...
?>
                                            ...
                                            <tr>
                                                <td height="25"><?php if($osusumedata[7]["eki"]!=NULL) {echo $osusumedata[7]["eki"]."±Ø";} ?>[<?php echo $osusumedata[7]["ensen"];?>]</td>
                                            </tr>
                                            <tr>
                                                <td height="25"><?php 
																																																...
																																																echo chunk_split($jyusyo[7],23,"<br>");
