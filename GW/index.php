<?php 
//header('location:/SM/index.php?PID=topics');
session_start(); 
...
<title><?php if(	$tenpodata["sm_title"]!=NULL) {echo $tenpodata["gwpc_title"]; }else { echo "���롼�ץ�����"; } ?></title>
