...
<?php
			...
			$dbobj->Query("delete from news_data where news_id=".$_REQUEST["news_id"]);
	?><script language="javascript">
location.replace('?PID=');
</script>
<?php
...
//-->
	...
	?>
			...
			?>
                                        <tr>
                                            <th width="17%" align="left" valign="top" bgcolor="#ECECEC"><strong>タイトル</strong></th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" valign="top" bgcolor="#FFFFFF">
                                                <select name="view_chk" id="view_chk">
                                                    <option value="1"<?php if($newsdata["view_chk"]==1||$newsdata["view_chk"]==NULL){echo " selected";}?>>公開する</option>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" valign="top" bgcolor="#FFFFFF">
                                                ...
                                                <input name="bbtm_regist" type="button" id="bbtm_regist" value="削除する" onclick="delchk()" />
                                                ...
                                                <input name="bbtm_regist" type="button" id="bbtm_regist" value="topへもどる" onclick="location.href='?PID='" />
