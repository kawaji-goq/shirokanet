...
<form action="" method="post" enctype="multipart/form-data" name="update_form">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td align="left" valign="top" class="text2" ><span class="textmenu">活動報告・トピックスs</span>&gt;<a href="mf_topics_lineup.php?cate_id=<?php echo $_REQUEST["cate_id"];?>&year=<?php echo $blogdata["ryear"]; ?>&month=<?php echo $blogdata["rmonth"]; ?>"><?php echo $blogdata["ryear"]; ?>年<?php echo $blogdata["rmonth"]; ?>月</a>&gt;カテゴリ：
                    <?php 
