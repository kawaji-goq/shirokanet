		...
		<tr>
				<td>
						<TABLE width="700"  border="0" align="left" cellpadding="5" cellspacing="0" class="realestate_bgcolor1">
								<TR class="realestate_bgcolor2">
										<TD colspan="2" valign="top" bgcolor="#ECECFF"><font color="#000000"><a href="?PID=re_c1_set">賃貸アパート・マンション</a>　<font color="#333333"><a href="?PID=re_c2_set">賃貸戸建て</a></font>　<font color="#333333"><strong>賃貸事業用</strong></font>　<a href="?PID=re_b1_set">売買マンション・戸建て</a>　<a href="?PID=re_b2_set">売買土地</a>　<a href="?PID=re_b3_set">売買事業用</a></font></TD>
								</TR>
								<form action="" method="post" enctype="multipart/form-data" name="bukken_form">
										<TR class="realestate_bgcolor2">
												<TD align="center" valign="top">
														<table cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="syumoku_view" type="checkbox" id="syumoku_view" value="1"<?php if($bsetdata["syumoku_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center"><input name="chiku_nen_view" type="hidden" id="chiku_nen_view" value="1">
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="shikikin_admin" type="checkbox" id="shikikin_admin" value="1"<?php if($bsetdata["shikikin_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="shikikin_view" type="checkbox" id="shikikin_view" value="1"<?php if($bsetdata["shikikin_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																		<td height="20" bgcolor="#FFFFFF">
																				<div align="left">礼金</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="reikin_admin" type="checkbox" id="reikin_admin" value="1"<?php if($bsetdata["reikin_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="reikin_view" type="checkbox" id="reikin_view" value="1"<?php if($bsetdata["reikin_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																		<td height="20" bgcolor="#FFFFFF">
																				<div align="left">管理費</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="kanrihi_admin" type="checkbox" id="kanrihi_admin" value="1"<?php if($bsetdata["kanrihi_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="kanrihi_view" type="checkbox" id="kanrihi_view" value="1"<?php if($bsetdata["kanrihi_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																		<td height="20" bgcolor="#FFFFFF">
																				<div align="left">共益費</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
												...
												<TD align="center" valign="top">
														<table cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
																...
																<tr>
																		<td height="20" bgcolor="#FFFFFF">賃貸借区分</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<input name="tatemono_chintaisyaku_kubun_name" type="text" value="<?php echo $bsetdata["tatemono_chintaisyaku_kubun_name"] ?>">
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="tatemono_chintaisyaku_kubun_admin" type="checkbox" id="tatemono_chintaisyaku_kubun_admin" value="1"<?php if($bsetdata["tatemono_chintaisyaku_kubun_admin"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="tatemono_chintaisyaku_kubun_view" type="checkbox" id="tatemono_chintaisyaku_kubun_view" value="1"<?php if($bsetdata["tatemono_chintaisyaku_kubun_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
																<tr>
																...
																<tr>
																		...
																		<td bgcolor="#FFFFFF" class="font12">
																				<div align="center">
																						<input name="torihikitaiyou_view" type="checkbox" id="torihikitaiyou_view" value="1"<?php if($bsetdata["torihikitaiyou_view"]==1){ echo " checked";} ?>>
																				</div>
																		</td>
																</tr>
														</table>
