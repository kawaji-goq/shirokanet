...
$nowdata=$ad_company->GetDataIdList(3,$orderby);
    				...
    				<table width="700" border="0" align="center">
								<tr>
										...
										<td width="412" align="left">
												<p><strong>　<?php echo $menudata[4]["data_name"]; ?>　&gt;&gt;　データ更新</strong></p>
										</td>
								</tr>
						</table>
    		</td>
      ...
      <td height="15">
        <table width="700" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td width="151" align="left" valign="top" bgcolor="#FFFFFF">
              <input name="data_name[<?php echo $datanum ?>]" type="text" id="data_name[<?php echo $datanum ?>]" value="<?php echo $nowdata[$datanum]["data_name"] ?>" size="30" />
            ...
            <td width="419" align="left" valign="top" bgcolor="#FFFFFF">
              <textarea name="data_comm[<?php echo $datanum ?>]" cols="60" rows="5" id="data_comm[<?php echo $datanum ?>]"><?php echo $nowdata[$datanum]["data_comm"] ?></textarea>
            </td>
  ...
  <tr>
      		...
      		<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
							<tr>
									...
									<td width="150" align="left" valign="top" bgcolor="#FFFFFF">
											<input name="new_data_name" type="text" id="new_data_name" size="30" />
									</td>
									<td width="494" align="left" valign="top" bgcolor="#FFFFFF">
											<textarea name="new_data_comm" cols="60" rows="5" id="new_data_comm"></textarea>
    ...
    <tr>
      <td height="15" align="left">
        ...
        <input name="cate_id" type="hidden" value="3" />
      </td>
    </tr>
</form>
</table>
