...
&nbsp;</strong></TD>
        ...
        <TABLE width="100%"  border="0" align="center" cellpadding="3" cellspacing="1" class="bukkentable"> 
          <TR class="realestate_bgcolor2">
          		<th width="4%" rowspan="2" align="center" valign="middle"><a href="?PID=re_b2&cid=<?php echo $_SESSION["cid"];?>&adb2sort=osusume<?php if($_SESSION["adb2sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
スメ </strong></a></th>
          ...
          <TR class="realestate_bgcolor3">
          		<TD width="4%" rowspan="2" align="center" valign="middle" class="font14"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
...
?>
          		...
          		<TD bgcolor="#ECFFEC" nowrap<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
