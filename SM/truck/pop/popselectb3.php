...
if(substr_count($_SERVER['HTTP_REFERER'],"popselectb3")==0) {
        ...
        <td align="left">
            <TABLE width="100%"  border="0" cellpadding="2" cellspacing="1" class="bukkentable">
                <TR class="realestate_bgcolor2">
                    ...
                    <th width="21%">
                        <div align="center"><strong><a href="?PID=popselectb3&cid=<?php echo $_SESSION["cid"];?>&sort=bukkenn_id<?php if($_SESSION["sort"]=="bukkenn_id") { echo " desc";}?>">物件番号</a>
                                    <?php if($_SESSION["sort"]=="bukkenn_id") { echo "▼";}elseif($_SESSION["sort"]=="bukkenn_id desc") { echo "▲";}?>
                        </strong></div>
                    </th>
                    <th width="14%" rowspan="2">
                        <div align="center"><strong><a href="?PID=popselectb3&cid=<?php echo $_SESSION["cid"];?>&sort=kakaku<?php if($_SESSION["sort"]=="kakaku") { echo " desc";}?>">価格
                                        <?php if($_SESSION["sort"]=="kakaku") { echo "▼";}elseif($_SESSION["sort"]=="kakaku desc") { echo "▲";}?>
                        </a></strong></div>
                    </th>
                    <th width="11%" rowspan="2">
                        <div align="center"><strong><a href="?PID=popselectb3&cid=<?php echo $_SESSION["cid"];?>&sort=menseki<?php if($_SESSION["sort"]=="menseki") { echo " desc";}?>">建物面積
                                        <?php if($_SESSION["sort"]=="menseki") { echo "▼";}elseif($_SESSION["sort"]=="menseki desc") { echo "▲";}?>
                        </a></strong></div>
                    </th>
                    ...
                    <th>
                        <div class="font14">
                            <div align="center"><strong>物件名<br>
                                    <a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"><?php echo $bsetdata["jyusyo_name"] ?></a></strong></div>
                        </div>
                    </th>
	...
	?>
                <TR class="realestate_bgcolor3"<?php if(SelChk($re1data[$re1rows]["id"])==1){ echo ' bgcolor="#FFECEC"';}else { echo ' bgcolor="#FFFFFF"';}?>>
                    <TD width="8%" rowspan="2" valign="top" class="font12" >
                        <div align="center"><a href="?PID=popselectb3_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>">
                            <?php
...
?>
                ...
                <TR class="realestate_bgcolor3"<?php if(SelChk($re1data[$re1rows]["id"])==1){ echo ' bgcolor="#FFECEC"';}else { echo ' bgcolor="#FFFFFF"';}?>>
                    ...
                    <td align="center" nowrap class="font12"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><?php echo $re1data[$re1rows]["syumoku"]; ?><br />
