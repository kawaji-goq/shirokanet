...
m </td>
       ...
       <?php 
            ...
            <td bgcolor="#FFFFFF" class="font12">地上
              			<input name="chijoukaisou" type="text" class="noime" id="chijoukaisou" value="0" size="6" />
              			階<br />
																	地下
              			<input name="chikakaisou" type="text" class="noime" id="chikakaisou" value="0" size="6" />
階<br /> 
              所在
              <input name="kaisou" type="text" class="noime" id="kaisou" value="0" size="6" />
階 </td> 
          </tr> 
       <?php 
					}
