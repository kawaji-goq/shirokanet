				...
				<TD valign="top">
						<form action="" method="post" enctype="multipart/form-data" name="lease_apaman_form">
						    <table width="100%" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
										...
										<tr>
												<td width="150" rowspan="2" bgcolor="#EBEBEB" class="font14">
										...
										<tr>
												<td bgcolor="#FFFFFF" class="font12">  <?php echo $re1data["todouhuken"];?> <?php echo $re1data["jyusyo1"];?> <br />
																		<?php echo $re1data["jyusyo2"];?> <?php echo $re1data["jyusyo3"];?>											  </td>
										</tr>
										<tr>
												<td width="150" bgcolor="#EBEBEB" class="font14">
										...
										<tr>
												<td width="150" height="31" bgcolor="#EBEBEB" class="font14">
										...
										<tr>
												<td width="150" bgcolor="#EBEBEB" class="font14">
														<div align="right">室外・その他設備 </div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" bgcolor="#EBEBEB" class="font14">&nbsp; </td>
												<td bgcolor="#FFFFFF" class="font12">
