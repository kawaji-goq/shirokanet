...
<TABLE width="700"  border="0" align="left" cellpadding="0" cellspacing="0" class="realestate_bgcolor1">
		...
		<TR class="realestate_bgcolor2">
		    <TD valign="top"><div class="helper">賃貸戸建て物件に表示する項目を設定するには<a href="?PID=re_c2_set">こちらをクリック</a>してください。
		            <br>
		...
		<TR class="realestate_bgcolor2">
				<TD valign="top">
					...
					?><tr>
										  ...
										  <td width="562" bgcolor="#FFFFFF" class="font12"><input name="bukkenn_id" type="text" class="noime" id="bukkenn_id" value="<?php echo $re1data["bukkenn_id"];?>">
										  </td>
								  </tr>
															<?php
					}
...
<?php 
          ...
          <tr>
          		...
          		<td bgcolor="#FFFFFF" class="font12">
					...
					?><input type="hidden" name="torihikitaiyou" id="torihikitaiyou" value="<?php echo $re1data["torihikitaiyou"];?>">
<?php 
					}
					?> 
<tr>
