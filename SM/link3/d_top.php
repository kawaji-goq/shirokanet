...
function delchk(name,id) {
	...
	if(res) {
		location.href="?PID=link&pmode=delete&cate_id=<?php echo $_GET["cate_id"];?>&delid="+id;
	}
...
<table height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="600" height="35" align="left" valign="middle" background="/img/main/title_bg.jpg">
                            ...
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <input type="button" name="Submit" value="¿·µ¬ÅÐÏ¿" onClick="location.href='?PID=link_d_add&cate_id=<?php echo $_GET["cate"];?>'" />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            </table>
