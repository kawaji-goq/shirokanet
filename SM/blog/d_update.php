...
<label for="day_view">日付を表示しない</label></td>
  ...
  <tr>
  		...
  		<td align="left">
			...
			?>
          <tr>
            <th width="100" align="left" valign="top"><strong>タイトル</strong></th>
...
<?php if($blogsetting["image_chk"]==1) {?>
		 ...
		 <table width="510" border="0" align="center">
					<tr>
							<th width="100" align="left" valign="top"><strong>テキスト１</strong></th>
							<td align="left" valign="top">
									<textarea name="text1" cols="50" rows="10" id="text1"><?php echo $blogdata["text1"];?></textarea>
							</td>
					</tr>
			</table>
		 <?php if($blogsetting["comm_chk"]==1) {?>
		 <div id="type_text" style="display:<?php if($blogdata["view_type"]==0) { ?>block<?php }else {echo "none";} ?>;">
		 		<table width="510" border="0" align="center">
						<?php
		if($blogdata["rdate"]!=NULL) {
			$exday=explode("-",$blogdata["rdate"]);
	...
	?>
			...
			?>
						<?php if($blogsetting["image_chk"]==1) {?>
						<tr>
								<th width="100" rowspan="2" align="left" valign="top">イメージ画像</th>
								<td align="left" valign="top">
	...
	?>
		...
		<div id="type_link" style="display:<?php if($blogdata["view_type"]==1) { ?>block<?php }else {echo "none";} ?>;"> </div>
		<?php
				}
				?>
        <table width="510" border="0" align="center">
