...
if($_REQUEST["mode"]=="addition") {
	...
	?>
	<script language="javascript">location.replace("?PID=bbs_sled&sled_id=<?php echo $_REQUEST["sled_id"];?>");</script>
	<?php
}
							...
							<tr bgcolor="#DCDCFF">
									<td>
											<table width="100%"  border="0" align="center" cellpadding="3" cellspacing="1">
													<tr>
															<td height="40" bgcolor="#EFF6FF"><font color="#333333" class="sledtitle"><?php echo $sleddata["sled_name"];?></span>															</td>
													</tr>
													<?php
													 $resdata=$bbsobj->Get_ResData($_REQUEST["sled_id"],$_REQUEST["res_id"]);
													 
													?>
													<tr>
															<td><strong>返信元</strong></td>
													</tr>
													<tr>
															<td><span class="nickname"><?php echo $resdata["writer"]?></span><?php echo str_replace("-",".",$resdata["writetime"]);?></td>
													</tr>
													<tr>
															<td bgcolor="#FFFFFF" class="comment">
																	<table width="100%" border="0" cellspacing="3" cellpadding="3">
																			<tr>
																					<td><?php echo $resdata["comment"]?></td>
																			</tr>
																	</table>
															</td>
													</tr>
																			...
																			<form action="" method="post" enctype="multipart/form-data" name="form1">
																					...
																					<tr>
																							<td><?php echo $logindata["member_name"] ?>　
																									...
																									<input name="res_id" type="hidden" id="res_id" value="<?php echo $_REQUEST["res_id"] ?>">
																									<br>
