												...
												<tr>
														<td bgcolor="#EFF6FF">
																<table width="100%"  border="0" cellpadding="2" cellspacing="2">
																				...
																				<tr>
																						<td><strong>テーマ名</strong></td>
																				</tr>
																				<tr>
																						<td>
																								<input name="sled_name" type="text" id="sled_name" style="width:50%;" value="">
																								<input name="master_comment" type="hidden" id="master_comment" style="width:90%;" value=" ">
												...
												<tr>
														<td>
																<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
																				<tr>
																						<td>
																								<input name="btm_post" type="button" id="btm_post" value="作成する" onClick="datachk(this.form)">
