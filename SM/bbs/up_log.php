...
function delchk(frm) {
	...
	alertchk=0;
	if(alertchk==0) {
		res=confirm("この内容で修正を送信してよろしいですか？");
		if(res) {
			...
			<td colspan="2">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FCFCFC">
							<tr>
									...
									<td width="96%" class="title"><font color="#333333">BBS書き込み更新</font></td>
							</tr>
					</table>
			</td>
		</tr>
												...
												<tr>
														<form name="delform" method="post" action=""><td bgcolor="#FFFFFF">
																<table width="100%" border="0" cellspacing="3" cellpadding="3">
																		<tr>
																				<td>
																				    <textarea name="comment" rows="10" style="width:98%;"><?php echo ($logdata["comment"]);?></textarea>
																			    </td>
																		</tr>
