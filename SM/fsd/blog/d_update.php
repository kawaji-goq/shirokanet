...
<table width="700" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
      <td><?php echo $_GET["syear"];?>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=1"> <font color="#FF6600">
          <?php }?>
1月
<?php if($jandata["countnum"]!=0){?>
          </font></a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=2"> <font color="#FF6600">
          <?php }?>
2月
<?php if($febdata["countnum"]!=0){?>
          </font></a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=3"> <font color="#FF6600">
          <?php }?>
3月
<?php if($mardata["countnum"]!=0){?>
          </font> </a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=4"> <font color="#FF6600">
          <?php }?>
4月
<?php if($aprdata["countnum"]!=0){?>
          </font></a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=5"> <font color="#FF6600">
          <?php }?>
5月
<?php if($maydata["countnum"]!=0){?>
          </font> </a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=6"> <font color="#FF6600">
          <?php }?>
6月
<?php if($jundata["countnum"]!=0){?>
          </font></a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=7"> <font color="#FF6600">
          <?php }?>
7月
<?php if($juldata["countnum"]!=0){?>
          </font> </a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=8"> <font color="#FF6600">
          <?php }?>
8月
<?php if($augdata["countnum"]!=0){?>
          </font> </a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=9"> <font color="#FF6600">
          <?php }?>
9月
<?php if($sepdata["countnum"]!=0){?>
          </font> </a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=10"> <font color="#FF6600">
          <?php }?>
10月
<?php if($octdata["countnum"]!=0){?>
          </font></a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=11"> <font color="#FF6600">
          <?php }?>
11月
<?php if($novdata["countnum"]!=0){?>
          </font> </a>
          ...
          <a href="?PID=blog&syear=<?php echo $_GET["syear"];?>&smonth=12"> <font color="#FF6600">
          <?php }?>
12月
<?php if($decdata["countnum"]!=0){?>
          </font></a>
...
<label for="day_view"></label>
	...
	?>
			...
			?>
          <tr>
            <th width="118" align="left" valign="top" bgcolor="#ECECEC"><strong>タイトル</strong></th>
