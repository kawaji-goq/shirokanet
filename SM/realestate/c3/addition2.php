...
$_REQUEST["banchichk"]=0;
	...
	$fary[]="chuugakouku";
	$dary[]="'".$_REQUEST["chuugakouku"].$_REQUEST["chuugakou"]."中学校'";
	$fary[]="ensen";
	$dary[]="'".$_REQUEST["ensen"]."'";
	$fary[]="eki";
	$dary[]="'".$_REQUEST["eki"]."'";
            ...
            <TD valign="top">
                <div class="helper">
                    <table width="100%" border="0" cellspacing="1" cellpadding="3">
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF">賃貸事業用物件に表示する項目を設定するには<a href="?PID=re_c3_set">こちらをクリック</a>してください。 <br>
	...
	<?php 
					...
					?>							
								<tr>
										...
										<td class="font12">
										    <input name="toshikeikaku" type="text" id="toshikeikaku" value="<?php echo $re1data["toshikeikaku"];?>" />&nbsp;</td>
								</tr>
							<?php 
					}
              ...
              円</td> 
														...
														?>
																				<tr bgcolor="#ffffff">
																						...
																						<td>
																								<input name="kenrikin" type="text" id="kenrikin" value="<?php echo $re1data["kenrikin"] ?>">円																						</td>
																				</tr>
															<?php
															}
