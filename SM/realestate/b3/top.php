...
if($_GET["adb3sort"]!=NULL) {

	$_SESSION["adb3sort"]=$_GET["adb3sort"];
...
if(substr_count($_SERVER['HTTP_REFERER'],"re_b3")==0) {
	$_SESSION["madori"]="";
	$_SESSION["lowcost"]="";
	$_SESSION["hicost"]="";
	$_SESSION["keyword"]="";
...
$re1obj->type=6;
$re1data=$re1obj->GetReList(2,$_SESSION["adb3sort"]);
...
<!--
function goreplace1(bid) {
	location.href="index.php?PID=re_b3_rep&bid="+bid;
}
function gocopy(bid) {
	location.href="index.php?PID=re_b3_copy&bid="+bid;
}
function godelete(bid) {
	location.href="index.php?PID=re_b3_del&bid="+bid;
}
							...
							<tr>
									...
									<td>
											<table width="100%"  border="0" cellspacing="0" cellpadding="5">
													<tr>
															<td class="font14"> <strong>売買事業用物件　管理</strong></td>
													</tr>
											</table>
									</td>
							</tr>
	...
	<TR>
	    <TD>
	        <div class="helper"><table width="100%" border="0" cellpadding="3" cellspacing="1" id="helper">
              ...
              <tr>
                  <td bgcolor="#FFFFFF">売買事業用物件に表示する項目を設定するには<a href="?PID=re_b3_set">こちらをクリック</a>してください。
		            <br>
		...
		<TD>
				<form name="form1" method="post" action="">
					<TABLE width="100%"  border="0" cellspacing="0" cellpadding="5">
                      ...
                      <TR bgcolor="#CCCCFF">
                        <TD bgcolor="#DDDDFF">
                          <input type="button" name="Submit" value="新規物件登録" onClick="location.href='index.php?PID=re_b3_add'"></TD>
                        <TD bgcolor="#DDDDFF">
...
&nbsp;</strong></TD>
                        <TD><div align="right"><strong>表示件数</strong>
                          <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                            <option value="?PID=re_b3&lim=10&page=1"<?php if($_SESSION["lim"]==10||$_SESSION["lim"]==NULL) { echo " selected";}?>>10件</option>
                            <option value="?PID=re_b3&lim=20&page=1"<?php if($_SESSION["lim"]==20) { echo " selected";}?>>20件</option>
                            <option value="?PID=re_b3&lim=30&page=1"<?php if($_SESSION["lim"]==30) { echo " selected";}?>>30件</option>
                            <option value="?PID=re_b3&lim=40&page=1"<?php if($_SESSION["lim"]==40) { echo " selected";}?>>40件</option>
                            <option value="?PID=re_b3&lim=50&page=1"<?php if($_SESSION["lim"]==50) { echo " selected";}?>>50件</option>
                            <option value="?PID=re_b3&lim=100&page=1"<?php if($_SESSION["lim"]==100) { echo " selected";}?>>100件</option>
                          </select>
                        </div></TD>
                      </TR>
                </TABLE>
                	...
                	<TR class="realestate_bgcolor2">
                			<th width="3%" rowspan="2" nowrap>
                					<div align="center"><a href="?PID=re_b3&cid=<?php echo $_SESSION["cid"];?>&adb3sort=osusume<?php if($_SESSION["adb3sort"]=="osusume") { echo " desc";}?>"><strong>オス<br>
                							スメ</strong></a></div>
                			</th>
                			<th width="7%" rowspan="2" align="center" valign="middle" class="font12">
                					<div align="center"><strong><?php echo $bsetdata["photo_name"] ?></strong></div>
                			</th>
                			<th width="18%">
                					<div align="center"><strong><a href="?PID=re_b3&cid=<?php echo $_SESSION["cid"];?>&adb3sort=bukkenn_id<?php if($_SESSION["adb3sort"]=="bukkenn_id") { echo " desc";}?>">物件番号</a>
                							<?php if($_SESSION["adb3sort"]=="bukkenn_id") { echo "▼";}elseif($_SESSION["adb3sort"]=="bukkenn_id desc") { echo "▲";}?>
                							</strong></div>
                			</th>
                			<th width="12%" rowspan="2">
													<div align="center"><strong><a href="?PID=re_b3&cid=<?php echo $_SESSION["cid"];?>&adb3sort=kakaku<?php if($_SESSION["adb3sort"]=="kakaku") { echo " desc";}?>">価格<?php if($_SESSION["adb3sort"]=="kakaku") { echo "▼";}elseif($_SESSION["adb3sort"]=="kakaku desc") { echo "▲";}?></a></strong></div>
                			</th>
                			<th width="9%" rowspan="2">
													<div align="center"><strong><a href="?PID=re_b3&cid=<?php echo $_SESSION["cid"];?>&adb3sort=menseki<?php if($_SESSION["adb3sort"]=="menseki") { echo " desc";}?>">建物面積<?php if($_SESSION["adb3sort"]=="menseki") { echo "▼";}elseif($_SESSION["adb3sort"]=="menseki desc") { echo "▲";}?></a></strong></div>
                			</th>
                			<th colspan="2" class="font12">
													<div align="center"><?php echo $bsetdata["ensen_name"] ?></div>
   					  </th>
                			<th width="5%" rowspan="2" class="font12">
                			...
                			<th width="6%" rowspan="2" align="center"><div align="center" class="font14"><strong>選択削除</strong></div></th>
           			  </TR>
                	<TR class="realestate_bgcolor2">
                			<th>
                			<div class="font14">
                					<div align="center"><strong>物件名<br>
                							<a href="?PID=<?php echo $_REQUEST["PID"];?>&cid=<?php echo $_SESSION["cid"];?><?php if($_SESSION["adb3sort"]=="todouhuken,jyusyo1,jyusyo2,jyusyo3") { echo "&adb3sort=todouhuken desc,jyusyo1 desc,jyusyo2 desc,jyusyo3 desc";}else {?>&adb3sort=todouhuken,jyusyo1,jyusyo2,jyusyo3<?php }?>"><?php echo $bsetdata["jyusyo_name"] ?></a></strong></div>
                			</div>
               			</th>
                			<th width="14%" class="font12">
               		...
               		<TR class="realestate_bgcolor3">
               				<TD width="3%" rowspan="2" class="font14"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
               				...
               				<td width="7%" rowspan="2" align="center" valign="middle"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
               						<div align="center"><a href="?PID=re_b3_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>">
               						    <?php
...
?>
                     </a><a href="?PID=re_b3_rep&bid=<?php echo $re1data[$re1rows]["id"]; ?>"></a></div>
               				</td>
               				<TD height="39" nowrap class="font14"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
               				...
               				<TD rowspan="2" nowrap class="font12"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
													<div align="center"><?php if($re1data[$re1rows]["senyumenseki"]!=NULL){echo $re1data[$re1rows]["senyumenseki"]."m<sup>2</sup>";}?></div>
               				</TD>
               				...
               				<td nowrap class="font12"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
               				    <div align="center">
               				        <input type="button" name="Submit" value="設定" onClick="location.href='?PID=re_osetting'">
           				        </div>
               				</td>
               				<TD align="center" valign="middle" bgcolor="#FFECEC" nowrap<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
               						<div align="center">
               						    <table border="0" align="center" cellpadding="0" cellspacing="3"<?php if($tenpodata["b3lastupid"]==$re1data[$re1rows]["id"]) {?> style="background-color:#666666;"<?php }?>>
                             <tr>
                                 <td>
                                     <input name="btm" type="button" id="btm" onClick="location.href='index.php?PID=re_b3_rep&bid=<?php echo $re1data[$re1rows]["id"];?>'" value="修正" />
                                 </td>
                             </tr>
                         </table>
               						</div>
               				</TD>
               				<TD width="5%" rowspan="2"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
                					<div align="center">
               				...
               				<TD width="5%" rowspan="2" align="center" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
                				<div align="center">
                						<input type="button" name="Submit" value="削除" onClick="location.href='index.php?PID=re_b3_del&bid=<?php echo $re1data[$re1rows]["id"];?>'">
                						</div>                				</TD>
               				<TD width="6%" rowspan="2" align="center" bgcolor="#ECFFEC"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><div align="center"><span class="font14"><span class="font12">
               		...
               		<TR class="realestate_bgcolor3">
               				<TD nowrap class="font14"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
               						<div align="center"><span class="font12"<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>><?php echo $re1data[$re1rows]["bukken_mei"];?><br>
                			...
                			<TD width="5%" nowrap<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
                			
                					  <div align="center">
                					      <input type="button" name="Submit" value="POP" onClick="window.open('http://siteadmin.itcube.ne.jp/sm/realestate/b3/print<?php echo $tenpodata["poptype"];?>.php?bid=<?php echo $re1data[$re1rows]["id"];?>&did=<?php echo urlencode($_SESSION["DomainData"]["dbname"]);?>&domain=<?php echo $_SESSION["DomainData"]["domain_name"];if($_SESSION["DomainData"]["dbtype"]=="mysql") { echo "&dtype=mysql";}?>')" />
   					          </div>
                			</TD>
                		<TD align="center" valign="middle" bgcolor="#FFECEC" nowrap<?php if($re1data[$re1rows]["del_chk"]==1) {echo " bgcolor=\"#EEEEEE\"";}else {echo " bgcolor=\"#ffffff\"";}?>>
