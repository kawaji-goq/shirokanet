...
$re1obj->type=1;
$dbobj->Query("update tenpo_data set b3lastupid =".$_REQUEST["bid"]);
                            ...
                            <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td bgcolor="#FFFFFF" class="font10">
                                        <p><font color="#000000">»ö¶ÈÍÑÊª·ï½¤Àµ </font></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
if(str_replace("www.","",$_SERVER['HTTP_HOST'])=="hayashi-housing.co.jp"){ echo $bsetdata["photo_name"]="º¸¤Î²èÁü"; }else {echo $bsetdata["photo_name"];} ?>
            						</div>
            						</th>
            				</tr>
            		<tr>
					...
					?>
            						<tr>
            								<td width="150" rowspan="2" valign="top" class="font14"><div align="right" class="font14"><?php echo $bsetdata["photo_name"] ?>£± </div></td>
            						...
            						<tr>
            								<td width="150" rowspan="2" valign="top" class="font14"><div align="right" class="font14"><?php echo $bsetdata["photo_name"] ?>£µ </div></td>
...
if(str_replace("www.","",$_SERVER['HTTP_HOST'])=="hayashi-housing.co.jp"){ echo $bsetdata["madorizu_name"]="±¦¤Î²èÁü"; }else {echo $bsetdata["madorizu_name"];} ?>
            						</div>
            						</th>
            				</tr>
            		<tr>
