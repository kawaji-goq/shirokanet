...
$_REQUEST["banchichk"]=0;
	...
	$mimagefile3=$mimgobj3->UpImgAndResize("madorizu2",$imagesize["big"]["w"],$imagesize["big"]["h"]);
	...
	$mimagefile2=$mimgobj4->UpImgAndResize("madorizu2",$imagesize["big"]["w"],$imagesize["big"]["h"]);
	...
	$mimagefile2=$mimgobj5->UpImgAndResize("madorizu2",$imagesize["big"]["w"],$imagesize["big"]["h"]);
...
駅                                    </td>
					...
					?>
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF" class="font12"> 最寄駅から乗車
