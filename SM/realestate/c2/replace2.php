...
$dbobj->Query("update tenpo_data set c2lastupid =".$_REQUEST["bid"]);
        ...
        <TR class="realestate_bgcolor2">
            <TD valign="top">
                <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <span class="font14"><?php echo $bsetdata["bukken_mei_name"] ?></span>
...
if(str_replace("www.","",$_SERVER['HTTP_HOST'])=="hayashi-housing.co.jp"){ echo "左の画像"; }else {echo $bsetdata["photo_name"];} ?>
            						</div>
            						</th>
            				</tr>
            		<tr>
