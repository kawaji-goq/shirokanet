						...
						<form action="" method="post" enctype="multipart/form-data" name="lease_apaman_form">
														...
														<table width="100%"  border="0" cellspacing="0" cellpadding="5">
																<tr>
																		<td bgcolor="#FFFFFF" class="font10">
																				<p><font color="#000000"><strong class="font14">賃貸アパート・</font><font color="#000000"><strong class="font14">マンション物件削除 </font> </p>
																		</td>
																</tr>
														</table>
												</td>
								...
								<table width="692" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
										...
										<tr>
										  ...
										  <div align="right" class="font14">物件所在地 </div>										  </td>
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">築年月</div>										  </td>
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right"><font color="#000000">償却金 </font></div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">  <?php echo $re1data["hosyoukin_syoukyaku"];?> 円  </td>
										</tr>
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">専有面積 </div>										  </td>
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">写真２ </div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">写真３ </div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">写真４</div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">写真５ </div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">間取図1 </div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">間取図2</div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right" class="font14">現況</div>										  </td>
												<td bgcolor="#FFFFFF" class="font12"> 
														<?php echo $re1data["genkyou"];?>
											  </td>
										</tr>
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right">入居可能日 </div>										  </td>
											<td bgcolor="#FFFFFF" class="font12"> 
													
															<?php echo $re1data["hikiwatashi"];?>
																											
														<?php echo $re1data["hikiwatashi_nen"];?>														 年
													<?php echo $re1data["hikiwatashi_tsuki"];?>
														月 
																<?php echo $re1data["hikiwatashi_syun"];?>												</td>
										</tr>
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right"><strong class="font14">室内設備</div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right"><strong class="font14">室外・その他設備 </div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
										...
										<tr>
												<td width="150" valign="top" bgcolor="#EBEBEB" class="font14">
										  <div align="right"><strong class="font14">条件</div>										  </td>
												<td bgcolor="#FFFFFF" class="font12">
