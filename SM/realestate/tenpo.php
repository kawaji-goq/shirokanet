...
//$_SESSION["DomainData"]["domain_name"]=="hayashi.itcube.ne.jp ";
if($_REQUEST["up_tenpo"]=="更新する") {
	...
	if($_SERVER['SERVER_NAME']=="f-ourhouse.com"){
		$imagefile2=$imgobj->UpImgAndResize("topimage",550,275);
	}
	else {
          ...
          <tr>
              ...
              <td bgcolor="#FFFFFF" class="font12">
                  <input name="pagetitle" type="text" id="pagetitle" value="<?php echo $tenpodata["pagetitle"];?>" size="40" style="width:98%;">
					...
					if($_SESSION["DomainData"]["domain_name"]!="hayashi.itcube.ne.jp"){
					?>
          <tr>
            <td width="150" bgcolor="#EBEBEB" class="font14">
            		<div align="right"><strong>ヘッダーテキスト</strong></div>
            </td>
            <td bgcolor="#FFFFFF" class="font12"><input name="headertext" type="text" id="headertext" value="<?php echo $tenpodata["headertext"];?>" size="40" style="width:98%;" /></td>
          </tr>
					<?php
...
<?php
          ...
          <tr>
              <td valign="middle" bgcolor="#EBEBEB" class="font14">
                  <div align="right"><strong>ブログサイト</strong></div>
              </td>
              <td valign="middle" bgcolor="#FFFFFF" class="font12">
                  <input name="blog_url" type="text" size="70" value="<?php echo $tenpodata["blog_url"];?>">
              </td>
          </tr>
          
          <tr>
              <td valign="top" bgcolor="#EBEBEB" class="font14">
                  <div align="right"><strong>ローンシュミレーション</strong></div>
              </td>
              <td bgcolor="#FFFFFF" class="font12">
                  <input name="loanurl" type="text" id="loanurl" size="70" value="<?php echo $tenpodata["loanurl"];?>">
              </td>
          </tr>
					<?php
					}
