...
if($_REQUEST["pmode"]=="regist") {
	$newid=$ad_contents2->AdditionCate($_POST);
	$contents2cdata=$ad_contents2->GetDetailsCate($newid);
...
<?php
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="続けて登録する" onClick="location.replace('?PID=contents2_add')">
