...
<table width="700" border="0" align="left" cellpadding="3" cellspacing="1">
  <tr>
  		<td>
...
if($_REQUEST["pmode"]=="update") {
	$ad_contents2->UpdateOneCate($_POST);
	$contents2cdata=$ad_contents2->GetDetailsCate($_GET["cate_id"]);
?>
   ...
   <?php
		 if($contents2setting["cate_image_chk"]==1) {
		 ?><?php
		  }
		  ?><?php
		 if($contents2setting["cate_comm_chk"]==1) {
		 ?><?php
		  }
		  ?>
          <tr>
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF">
              <input name="bbtm_regist" type="button" id="bbtm_regist" value="一覧へもどる" onClick="location.replace('?PID=contents2_category')">
            </td>
          </tr>
        </table>
		<?php
		...
		<table width="700" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          <tr>
            <th width="138" align="left" bgcolor="#ECECEC"><strong>カテゴリ名</strong></th>
            <td width="547" align="left" bgcolor="#FFFFFFF">
              <textarea name="cate_name" cols="50" id="cate_name"><?php echo $contents2cdata["cate_name"];?></textarea>
            </td>
          </tr>
           <?php
		 if($contents2setting["cate_image_chk"]==1) {
		 ...
		 ?><?php
          ...
          <tr>
            <th width="138" align="left" valign="top" bgcolor="#ECECEC">公開</th>
            <td align="left" valign="top" bgcolor="#FFFFFFF">
              <select name="view_chk" id="view_chk">
                <option value="1"<?php if($contents2cdata["view_chk"]==1){echo " selected";}?>>公開する</option>
                <option value="0"<?php if($contents2cdata["view_chk"]==0){echo " selected";}?> >公開しない</option>
              </select>
            </td>
          </tr>
          <tr>
